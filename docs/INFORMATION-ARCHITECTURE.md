...
Measured after the pass (markup inside the layout, `src/lib/record-sections.test.ts`): gallbladder hub 232 KB, TNBC 213 KB, NSCLC 203 KB, pancreatic 188 KB; no hub over 240 KB; the largest section page is NSCLC's What is coming at 309 KB. A small rare cancer (gallbladder papillary carcinoma, 124 KB) keeps all ten sections inline.
