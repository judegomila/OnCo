...
sources 6,297; backlinks 5,975 of 6,670; orphans 6,022 of 6,670 (648 new orphans from tonight's journals, pathways, leaders and KOLs, linking agent rerunning); summary 6,214 (last 475 running); schematics 304 of 411 (wave 8 running); target prevalence 91 of 99 (the eight left carry notes explaining why no positivity rate exists); trial outcomes 418 of 451 (the 33 left are unreported); people with papers 946 of 1,309; term Wikipedia 525 of 605 (rest documented); translations 2,464; provenance 6,258 (weekly job); logos 882 of 1,347 (fetch rerunning); reviewed 0 (needs named humans); kind-size 17 of 18 (fronts kept at 19 on purpose).
