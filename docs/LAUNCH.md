...
- Plain-language sentences 5,519 of 6,303 (88%); translations in all eight languages 2,464 after three waves (records ranked by connections; the long tail is people and ideas); people with papers 946 of 1,152; technology schematics 224 of 411 specific (wave 6 running); trial outcomes: 5 more filled, 33 left are genuinely unreported; glossary terms 80 without Wikipedia, 61 documented as having no certain source; molecules gauge clear (409 of 530 products have a structure, the rest are explained placeholders: cells, vaccines, tests, devices); regional approvals gauge clear; NCI cancer types and NCI drug list 100% matched.
