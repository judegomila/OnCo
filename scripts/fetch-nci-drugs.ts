 ...
 *
 * Writes src/data/universe-lists/nci-cancer-drugs.json. A test (src/lib/universe-nci.test.ts) asserts every
...
const OUT = join(process.cwd(), "src", "data", "universe-lists", "nci-cancer-drugs.json");
