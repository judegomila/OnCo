...
import {
  ...
  KINDS, PairingSchema, PaperSchema, PathwaySchema, PersonSchema, RoadmapSchema, SectionSchema, TargetSchema, TechnologySchema, TermSchema, TrialSchema, YearSchema,
  type Kind,
} from "../src/lib/schema";
...
const SCHEMAS: Record<Kind, ZodType> = {
  ...
  person: PersonSchema, bottleneck: BottleneckSchema, paper: PaperSchema, journal: JournalSchema, biomarker: BiomarkerSchema, year: YearSchema,
};
...
const FILE_HINT: Record<Kind, string> = {
  ...
  year: "generated by src/data/years.ts from every other record; do not write one by hand",
};
