...
export const SPIKE_FILES: Record<string, Spike> = {
  nsclc, prostate, pancreatic, "pancreatic-uk": pancreaticUk, glioblastoma, "breast-hr-positive": breastHr, "breast-her2-positive": breastHer2, hcc, cholangiocarcinoma, neuroendocrine, melanoma,
  ...
  "gallbladder-geography": gallbladderGeography, "tnbc-core": tnbcCore, "tnbc-evidence": tnbcEvidence, "tnbc-uk": tnbcUk, "tnbc-living": tnbcLiving, "tnbc-molecular": tnbcMolecular, "tnbc-treatment": tnbcTreatment, "pancreatic-living": pancreaticLiving, "pancreatic-evidence": pancreaticEvidence,
};
...
export const NON_SPIKE_FILES = ["index", "gap-cancers", "nci-paediatric", "nci-rare-solid", "nci-rare-other", "gallbladder-evidence-shared", "gallbladder-evidence-papers-surgery", "gallbladder-evidence-papers-epidemiology", "gallbladder-evidence-roadmap", "gallbladder-registry-trials", "tnbc-registry-trials", "tnbc-evidence-shared", "tnbc-evidence-papers-foundations", "tnbc-evidence-papers-treatment", "tnbc-evidence-roadmap", "pancreatic-evidence-shared", "pancreatic-evidence-papers-foundations", "pancreatic-evidence-papers-treatment", "pancreatic-evidence-roadmap"];
