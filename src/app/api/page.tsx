  ...
  return (
    <>
      ...
      <Container className="pb-16 max-w-3xl">
        ...
        <pre className="card p-4 text-xs overflow-auto"><code>{`curl -s https://onco.vercel.app/api/v1/entities/trop2.json | jq '.entity.name, .neighbours.drug[].name'`}</code></pre>
      </Container>
    </>
  );
}
