    ...
    <>
      ...
      <Container className="pb-16">
        ...
        <section className="mt-12">
          ...
          <p className="text-xs text-muted mb-4 max-w-3xl">Data gap: {missing} of the {approved.length} approved products in OnCo have no US coverage record yet. Most are newly approved (2025 to 2026) products whose Medicare coding and plan policies are still settling, or products approved outside the US. If you know how one of them is covered, <a className="underline" href="https://github.com/judegomila/OnCo/issues/new?template=suggest-edit.yml&title=coverage%3A%20US%20insurance%20record" rel="noopener">tell us through the issue form</a> with a source, and we will add it after checking.</p>
