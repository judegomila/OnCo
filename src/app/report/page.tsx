...
export default function Reports() {
  return (
    <>
      <PageHeader kicker={<span className="kicker">Annual report</span>} title="The state of the war on cancer" lede="One report per year, generated from the corpus: approvals, trial results, roadmap progress, open problems, and a short narrative. Earlier years are added as the corpus grows backwards." />
