...
export const metadata: Metadata = pageMeta({ title: "Trial sponsor leaderboard", description: "Who runs the trials: companies, cooperative groups and institutions ranked by phase 2 and 3 studies on ClinicalTrials.gov and landmark trials in the corpus, by phase, status and cancer.", path: "/sponsors/" });
...
export default function SponsorsPage() {
  ...
  return (
    <>
      <PageHeader kicker={<GroupKicker id="who" />} title="Trial sponsor leaderboard"
      ...
      <Container className="pb-16">
        ...
        <section className="grid md:grid-cols-2 gap-6 text-sm mt-10">
          <div className="card p-5 space-y-2">
            <h2 className="font-semibold text-base">Two sources, one table</h2>
