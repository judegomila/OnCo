...
const HUE: Record<Kind, string> = {
  ...
  pathway: "#c026d3", term: "#71717a", trial: "#4f46e5", pairing: "#ea580c", roadmap: "#0891b2", idea: "#65a30d", collection: "#78716c", person: "#db2777",
};
const ORDER: Kind[] = ["cancer", "section", "technology", "target", "drug", "trial", "pairing", "pathway", "company", "institution", "person", "idea", "roadmap", "term", "collection"];
