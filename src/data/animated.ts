...
export const MODALITY_SCHEMATICS: Array<[RegExp, string]> = [
  ...
  [/chemoprotectant|hepcidin|erythroid|maturation agent|antiemetic|scalp cooling|growth factor support|bone-protecting|bisphosphonate/, "front:supportive-care"],
