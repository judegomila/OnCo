...
export const benchmark: Question[] = [
  ...
  Q("gi-30", "What is daraxonrasib and where does it stand?", "factual", 2, "analyst",
    "Revolution Medicines' pan-RAS(ON) tri-complex inhibitor; phase 3 RASolute 302 in second-line pancreatic cancer (reported OS benefit, HR 0.40 per the pancreatic cancer deep dive), with first-line and NSCLC phase 3 trials ongoing.",
  ...
  Q("who-72", "How many NCI-designated cancer centers are there and what types?", "factual", 1, "analyst",
    "74 in 2026: 58 Comprehensive, 8 Clinical, 8 Basic Laboratory.",
