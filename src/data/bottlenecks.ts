...
export const bottlenecks: BottleneckInput[] = [
  ...
  b({
    ...
    stage: "biology",
    severity: "critical",
    tldr: "A tumour is many tumours. Treatments that kill most cells leave the rest to grow back, changed.",
