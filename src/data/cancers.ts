...
export const cancers: CancerInput[] = [
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Stage I (T1a-b N0)", approach: "Surgery ± radiation; chemotherapy for ≥T1c; TIL-high tumours have >90% 5-year RFS even without chemotherapy (OPTimal, ETNA, TIL-CHOICE cohorts). De-escalation trials ongoing.", refs: ["sentinel-node", "histopathology-ihc"] },
      { setting: "Stage II-III", approach: "Neoadjuvant pembrolizumab + carboplatin/paclitaxel → AC/EC, surgery, adjuvant pembrolizumab (KEYNOTE-522). Germline BRCA + residual disease: olaparib 1 year (OlympiA). Residual disease without BRCA: capecitabine (CREATE-X). Radiation per stage.", refs: ["keynote-522", "pembrolizumab", "carboplatin", "olaparib", "olympia"] },
      { setting: "Metastatic, first line, PD-L1 CPS ≥10", approach: "Pembrolizumab + chemotherapy (KEYNOTE-355) or sacituzumab govitecan + pembrolizumab (ASCENT-04, approved 2026).", refs: ["keynote-355", "ascent-04", "sacituzumab-govitecan", "pembrolizumab"] },
      { setting: "Metastatic, first line, PD-L1 negative or PD-1 ineligible", approach: "Datopotamab deruxtecan (TROPION-Breast02, OS benefit) or sacituzumab govitecan (ASCENT-03), both approved 2026; PARP inhibitor if germline BRCA; chemotherapy.", refs: ["tropion-breast02", "ascent-03", "datopotamab-deruxtecan", "olaparib"] },
      { setting: "Metastatic, later lines", approach: "Whichever TROP2 ADC was not used first (cross-resistance uncertain); T-DXd if HER2-low (DESTINY-Breast04); iza-bren where available; chemotherapy (eribulin, capecitabine); clinical trials.", refs: ["trastuzumab-deruxtecan", "izalontamab-brengitecan", "destiny-breast04"] },
    ],
    stateOfArt: [
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Early stage", approach: "Surgery, radiation, endocrine therapy 5-10 years; chemotherapy if genomic risk high; abemaciclib or ribociclib adjuvant for high-risk.", refs: ["oncotype-dx", "abemaciclib", "ribociclib", "monarche", "natalee"] },
      { setting: "Metastatic first line", approach: "CDK4/6 inhibitor + aromatase inhibitor or fulvestrant.", refs: ["palbociclib", "ribociclib", "abemaciclib"] },
      { setting: "Metastatic second line", approach: "Genotype-directed: capivasertib, inavolisib, alpelisib, everolimus; elacestrant/vepdegestrant if ESR1-mutant; gedatolisib.", refs: ["capivasertib", "inavolisib", "elacestrant", "vepdegestrant", "gedatolisib"] },
      { setting: "Endocrine-resistant", approach: "T-DXd (HER2-low/ultralow) before chemotherapy; sacituzumab govitecan or Dato-DXd after chemotherapy.", refs: ["destiny-breast06", "trastuzumab-deruxtecan", "sacituzumab-govitecan", "datopotamab-deruxtecan"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Early stage", approach: "Neoadjuvant THP or T-DXd → surgery → trastuzumab/pertuzumab (pCR) or T-DXd/T-DM1 (residual).", refs: ["trastuzumab", "trastuzumab-deruxtecan", "trastuzumab-emtansine", "destiny-breast11"] },
      { setting: "Metastatic", approach: "T-DXd + pertuzumab first line (DESTINY-Breast09); tucatinib + trastuzumab + capecitabine for brain metastases; palbociclib maintenance if HR+.", refs: ["destiny-breast09", "tucatinib", "palbociclib"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Screening", approach: "Annual low-dose CT for high-risk smokers (NLST, NELSON); AI nodule scoring emerging.", refs: ["ct", "radiology-ai-screening"] },
      { setting: "Early stage", approach: "Surgery or SBRT; perioperative chemo-immunotherapy; adjuvant osimertinib (EGFR) or alectinib (ALK).", refs: ["sbrt", "adaura", "osimertinib"] },
      { setting: "Stage III unresectable", approach: "Chemoradiation → durvalumab (PACIFIC) or osimertinib (LAURA, EGFR).", refs: ["durvalumab", "imrt-igrt"] },
      { setting: "Metastatic, driver-positive", approach: "Matched TKI or bispecific; ADCs after progression.", refs: ["osimertinib", "amivantamab", "lorlatinib", "selpercatinib", "zongertinib", "sotorasib", "datopotamab-deruxtecan"] },
      { setting: "Metastatic, driver-negative", approach: "PD-(L)1 ± chemotherapy; docetaxel or ADC/TTFields second line.", refs: ["pembrolizumab", "nivolumab", "optune"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Limited stage", approach: "Chemoradiation → durvalumab; prophylactic cranial irradiation or MRI surveillance.", refs: ["durvalumab", "imrt-igrt"] },
      { setting: "Extensive stage", approach: "Platinum-etoposide + atezolizumab/durvalumab; lurbinectedin + atezolizumab maintenance.", refs: ["atezolizumab", "durvalumab"] },
      { setting: "Relapsed", approach: "Tarlatamab (preferred), lurbinectedin, topotecan; I-DXd in trials.", refs: ["tarlatamab", "dellphi-304", "ifinatamab-deruxtecan"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Screening", approach: "Colonoscopy, FIT, Cologuard, Shield blood test from age 45.", refs: ["shield"] },
      { setting: "Stage II-III", approach: "Surgery; adjuvant chemotherapy guided by risk and (in trials) ctDNA; exercise programme.", refs: ["dynamic", "signatera", "exercise-oncology"] },
      { setting: "Metastatic, MSS", approach: "Doublet/triplet chemotherapy + biologic by genotype; targeted combinations for BRAF, KRAS G12C, HER2.", refs: ["encorafenib", "sotorasib", "adagrasib", "tucatinib"] },
      { setting: "Metastatic, dMMR", approach: "Checkpoint inhibitors; organ preservation in rectal cancer.", refs: ["pembrolizumab", "nivolumab", "dostarlimab"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Resectable/borderline", approach: "Neoadjuvant FOLFIRINOX → surgery → adjuvant chemotherapy.", refs: ["cytotoxic-chemotherapy", "robotic-surgery"] },
      { setting: "Locally advanced", approach: "Chemotherapy ± TTFields (Optune Pax, 2026); SBRT or MR-guided RT; IRE in selected cases.", refs: ["optune", "mr-linac", "irreversible-electroporation"] },
      { setting: "Metastatic", approach: "FOLFIRINOX or gem/nab-pac; olaparib maintenance if gBRCA; zenocutuzumab if NRG1; trials of RAS inhibitors.", refs: ["olaparib", "zenocutuzumab", "daraxonrasib"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Localised", approach: "Perioperative FLOT ± durvalumab; D2 gastrectomy.", refs: ["durvalumab", "robotic-surgery"] },
      { setting: "Advanced first line", approach: "Chemotherapy + PD-1 ± trastuzumab ± zolbetuximab by biomarker.", refs: ["nivolumab", "pembrolizumab", "trastuzumab"] },
      { setting: "Later lines", approach: "T-DXd (HER2+), zanidatamab, CLDN18.2 CAR-T/ADC in trials.", refs: ["trastuzumab-deruxtecan", "zanidatamab", "satricabtagene-autoleucel", "cmg901"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Localised", approach: "Neoadjuvant chemoradiation (CROSS) or perioperative FLOT → surgery → nivolumab if residual disease.", refs: ["nivolumab", "imrt-igrt"] },
      { setting: "Advanced", approach: "Chemotherapy + pembrolizumab/nivolumab; iza-bren in trials.", refs: ["pembrolizumab", "izalontamab-brengitecan"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Early", approach: "Resection, ablation, transplant.", refs: ["thermal-ablation", "hifu-histotripsy"] },
      { setting: "Intermediate", approach: "TACE/TARE ± systemic therapy.", refs: ["radioligand-therapy"] },
      { setting: "Advanced", approach: "Atezolizumab-bevacizumab, durvalumab-tremelimumab, or nivolumab-ipilimumab.", refs: ["atezolizumab", "durvalumab", "nivolumab", "ipilimumab"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Resectable", approach: "Surgery + adjuvant capecitabine." },
      { setting: "Advanced", approach: "Gem-cis + PD-(L)1; targeted therapy by genotype second line.", refs: ["durvalumab", "pembrolizumab", "zanidatamab", "zenocutuzumab", "trastuzumab-deruxtecan"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Localised", approach: "Active surveillance, prostatectomy, or radiation ± ADT (duration guided by risk/ArteraAI).", refs: ["robotic-surgery", "sbrt", "brachytherapy", "artera-ai-prostate", "mri"] },
      { setting: "Metastatic hormone-sensitive", approach: "ADT + ARPI ± docetaxel; PSMA PET staging; capivasertib if PTEN-deficient.", refs: ["androgen-deprivation", "psma-pet", "capivasertib"] },
      { setting: "Castration-resistant", approach: "ARPI switch, PARP inhibitor combinations (HRR+), 177Lu-PSMA-617, docetaxel/cabazitaxel, radium-223.", refs: ["pluvicto", "olaparib", "niraparib", "talazoparib", "vision", "psmafore"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "NMIBC", approach: "TURBT + intravesical BCG; novel intravesical agents for BCG-unresponsive; durvalumab + BCG for high-risk (2026).", refs: ["durvalumab", "oncolytic-virus", "cytokine-therapy"] },
      { setting: "MIBC", approach: "Neoadjuvant chemo ± durvalumab → cystectomy → ctDNA-guided atezolizumab or nivolumab.", refs: ["imvigor011", "atezolizumab", "signatera"] },
      { setting: "Metastatic", approach: "Enfortumab vedotin + pembrolizumab; erdafitinib (FGFR3); platinum + nivolumab.", refs: ["ev-302", "enfortumab-vedotin", "pembrolizumab"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Localised", approach: "Partial/radical nephrectomy or ablation; adjuvant pembrolizumab ± belzutifan for high risk.", refs: ["robotic-surgery", "thermal-ablation", "pembrolizumab", "belzutifan"] },
      { setting: "Metastatic", approach: "IO-TKI or IO-IO doublet; belzutifan, cabozantinib, lenvatinib-everolimus later.", refs: ["nivolumab", "ipilimumab", "pembrolizumab", "belzutifan"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Newly diagnosed", approach: "Surgery + platinum-taxane ± bevacizumab ± HIPEC; PARP maintenance by HRD status.", refs: ["carboplatin", "paclitaxel", "hipec", "olaparib", "niraparib"] },
      { setting: "Platinum-sensitive relapse", approach: "Platinum doublet + PARP maintenance; secondary cytoreduction in selected cases." },
      { setting: "Platinum-resistant", approach: "Mirvetuximab (FRα-high), relacorilant + nab-paclitaxel, pembrolizumab (PD-L1+), single-agent chemotherapy.", refs: ["mirvetuximab-soravtansine", "relacorilant", "pembrolizumab"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Early", approach: "Hysterectomy; adjuvant therapy by molecular class." },
      { setting: "Advanced/recurrent", approach: "Chemotherapy + dostarlimab or pembrolizumab; lenvatinib-pembrolizumab; T-DXd if HER2+.", refs: ["dostarlimab", "pembrolizumab", "trastuzumab-deruxtecan"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Prevention", approach: "HPV vaccination age 9-14; HPV primary screening.", refs: ["hpv-vaccine"] },
      { setting: "Locally advanced", approach: "Cisplatin chemoradiation + brachytherapy + pembrolizumab.", refs: ["brachytherapy", "imrt-igrt", "pembrolizumab"] },
      { setting: "Recurrent/metastatic", approach: "Pembrolizumab-chemotherapy-bevacizumab; tisotumab vedotin.", refs: ["pembrolizumab", "tisotumab-vedotin"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Stage II-III", approach: "Adjuvant pembrolizumab/nivolumab; neoadjuvant IO for resectable stage III.", refs: ["pembrolizumab", "nivolumab", "sentinel-node"] },
      { setting: "Metastatic first line", approach: "Nivolumab-ipilimumab or nivolumab-relatlimab; BRAF/MEK if rapid control needed.", refs: ["checkmate-067", "relatlimab-nivolumab", "encorafenib"] },
      { setting: "After PD-1", approach: "Lifileucel, RP1 + nivolumab, ipilimumab-based, trials; tebentafusp (uveal).", refs: ["lifileucel", "vusolimogene-oderparepvec", "tebentafusp"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      ...
      { setting: "IDH-mutant grade 2", approach: "Resection → vorasidenib or observation; RT/PCV for high-risk.", refs: ["vorasidenib"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Resectable", approach: "Neoadjuvant + adjuvant pembrolizumab with surgery; or chemoradiation.", refs: ["pembrolizumab", "imrt-igrt", "robotic-surgery"] },
      { setting: "Recurrent/metastatic", approach: "Pembrolizumab ± platinum/5-FU; cetuximab-based; photoimmunotherapy (Japan).", refs: ["pembrolizumab", "photoimmunotherapy"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Differentiated", approach: "Thyroidectomy ± radioactive iodine; TSH suppression.", refs: ["radioligand-therapy"] },
      { setting: "Advanced/refractory", approach: "Lenvatinib; selpercatinib (RET); BRAF/MEK (anaplastic).", refs: ["selpercatinib"] },
    ],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Localised", approach: "Resection." },
      { setting: "Advanced", approach: "SSA → 177Lu-DOTATATE → everolimus/cabozantinib/chemotherapy; alpha therapy in trials.", refs: ["lutathera", "ryz101"] },
    ],
  ...
  c({
    ...
    standardOfCare: [{ setting: "Unresectable", approach: "Nivolumab-ipilimumab or chemo-IO; TTFields.", refs: ["nivolumab", "ipilimumab", "pembrolizumab", "optune"] }],
  ...
  c({
    ...
    standardOfCare: [{ setting: "High-risk", approach: "Induction chemo → surgery → tandem transplant → RT → anti-GD2 + isotretinoin; lorlatinib if ALK-mutant.", refs: ["lorlatinib", "monoclonal-antibody"] }],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Fit", approach: "7+3 ± targeted agent; consolidation; allogeneic transplant by risk.", refs: ["gemtuzumab-ozogamicin", "cytotoxic-chemotherapy"] },
      { setting: "Unfit", approach: "Azacitidine + venetoclax.", refs: ["venetoclax"] },
      { setting: "Relapsed", approach: "Genotype-directed: gilteritinib, IDH inhibitors, menin inhibitors; transplant.", refs: ["revumenib"] },
    ],
  ...
  c({
    ...
    standardOfCare: [{ setting: "Frontline", approach: "Risk-adapted chemotherapy + blinatumomab consolidation; TKI if Ph+.", refs: ["blinatumomab"] }, { setting: "Relapsed", approach: "CAR-T (tisagenlecleucel, obe-cel), inotuzumab, transplant.", refs: ["car-t", "revumenib"] }],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Frontline", approach: "R-CHOP or Pola-R-CHP." },
      { setting: "Early relapse", approach: "CD19 CAR-T.", refs: ["axicabtagene-ciloleucel"] },
      { setting: "Later", approach: "CD20×CD3 bispecifics, loncastuximab, tafasitamab.", refs: ["glofitamab", "zynlonta"] },
    ],
  ...
  c({
    ...
    standardOfCare: [{ setting: "Frontline", approach: "BTK inhibitor continuous or venetoclax-based fixed duration.", refs: ["venetoclax"] }, { setting: "Relapsed", approach: "Alternate class; pirtobrutinib; CAR-T.", refs: ["car-t"] }],
  ...
  c({
    ...
    standardOfCare: [
      { setting: "Newly diagnosed", approach: "Dara-VRd ± ASCT → lenalidomide maintenance.", refs: ["whole-body-mri"] },
      { setting: "Relapsed", approach: "CAR-T or bispecific; belantamab combinations; sequencing by prior exposure.", refs: ["ciltacabtagene-autoleucel", "teclistamab", "belantamab-mafodotin"] },
    ],
  ...
  c({
    ...
    standardOfCare: [{ setting: "Advanced stage", approach: "Nivolumab-AVD (2026) or BV-AVD; PET-adapted.", refs: ["nivolumab", "brentuximab-vedotin", "fdg-pet"] }],
