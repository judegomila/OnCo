...
export const cancers: CancerInput[] = [
  ...
  // ======================= Lung =======================
  c({
    id: "nsclc", related: ["sclc"], name: "Non-small-cell lung cancer", group: "lung", wikipedia: W("Non-small-cell_lung_cancer"),
  ...
  c({
    id: "esophageal", companies: ["nanjing-leads-biolabs", "neonc-technologies", "ap-biosciences"], name: "Oesophageal cancer", group: "gastrointestinal", wikipedia: W("Esophageal_cancer"),
  ...
  c({
    id: "hcc", aka: ["Liver Cancer"], companies: ["nanjing-leads-biolabs", "catalym", "bioinvent-international", "ascentawits-pharmaceuticals", "shanghai-abelzeta"], trials: ["nct06109272", "nct05317819", "nct07490262", "nct06844357", "nct04639180", "nct05320692", "nct04194775", "nct03755791", "nct05489289", "nct06921785", "nct05862337", "nct05883644", "nct03847428", "nct05904886", "nct03383458", "nct05557838", "nct06371157", "nct04712643", "nct05201404"], name: "Hepatocellular carcinoma", group: "gastrointestinal", wikipedia: W("Hepatocellular_carcinoma"),
  ...
  c({
    ...
    name: "Epithelioid sarcoma (ES)",
    group: "sarcoma",
    wikipedia: W("Epithelioid_sarcoma"),
    burden:
      "Ultra-rare: less than 1% of all soft tissue sarcomas. Incidence approximately 0.1 per million per year. Primarily affects young adults aged 20 to 40 with male predominance of about 2:1. Five-year survival is 50 to 75% in localised disease; metastatic disease carries approximately 50% one-year survival. Source: NCI epidemiology data (https://seer.cancer.gov).",
    tldr:
      "A rare soft tissue cancer that mostly strikes young adults and loses a gene called SMARCB1, which changes how DNA is packaged. The only targeted drug that ever worked was withdrawn in 2026, leaving surgery and chemotherapy as the main options and an urgent search for new approaches.",
    summary:
      "Epithelioid sarcoma is an ultra-rare, aggressive soft tissue sarcoma. In over 90% of cases the tumour has lost SMARCB1 (also called INI1), a core component of the BAF chromatin remodelling complex. Without SMARCB1 the cell cannot properly regulate differentiation and tumour-suppressor genes, and it becomes dependent on EZH2, a silencing enzyme in the PRC2 complex, as a backup. Two clinical subtypes exist: distal (classic), with slow-growing nodules on hands, forearms and feet, and proximal, with deep-seated tumours in pelvis, perineum or trunk that behaves more aggressively. Recurrence rates are 34 to 77% (source: Enzinger, Cancer 1970, and subsequent clinicopathological series), metastasis occurs in about 40% of patients, and lymphatic spread, unusual for a sarcoma, occurs in 22 to 48% (source: Chase and Enzinger, Am J Surg Pathol 1985; Hasegawa et al., Mod Pathol 2004).\n\nStandard of care is surgery with wide negative margins, the only curative approach. Limb-sparing resection is standard; amputation is reserved for unresectable or recurrent disease. Adjuvant radiation (60 to 66 Gy or pre-operative 50 Gy) improves local control. Chemotherapy has modest activity: doxorubicin gives roughly 20% response (source: ESMO sarcoma guidelines), gemcitabine plus docetaxel and ifosfamide are alternatives, and vinorelbine produced a case report complete response of pulmonary metastases (source: Pinkerton et al., 1999). Tazemetostat, an EZH2 inhibitor targeting the PRC2 compensation axis, was the first and only FDA-approved targeted therapy: approved January 2020 with a 15% ORR (source: Gounder et al., Lancet Oncol 2020, doi:10.1016/S1470-2045(19)30730-0). Ipsen withdrew it globally in March 2026 after secondary haematologic malignancies emerged in the SYMPHONY-1 follicular lymphoma trial (18 of 318 patients, 5.7%; source: Ipsen press release 9 March 2026, https://www.globenewswire.com/news-release/2026/03/09/3252192/0/en/update-ipsen-voluntarily-withdraws-tazverik-tazemetostat-in-follicular-lymphoma-and-epithelioid-sarcoma.html). ES now has no approved targeted therapy.\n\nWhat is changing: next-generation PRC2 inhibitors (rinzimetostat targeting EED, valemetostat targeting EZH1 and EZH2, SHR2554 targeting EZH2) are in trials for other cancers and retain activity in tazemetostat-resistant models, but none have ES cohorts. Immune checkpoint inhibitors show signals in small cohorts: pembrolizumab gave a 20% partial response rate in the AcSe basket study (source: Italiano et al., Lancet Oncol 2018), and pembrolizumab plus T-VEC gave a 35% ORR in advanced sarcomas including ES at MSK (source: Choi et al., JITC 2024). The search for new approaches has intensified since tazemetostat withdrawal.",
    subtypes: [
      "Distal (classic) type: slow-growing nodules in dermis or subcutis of hands, forearms, feet; better prognosis",
      "Proximal type: deep-seated tumours in pelvis, perineum, trunk; more aggressive, worse prognosis",
      "SMARCB1-retained variant (approximately 5 to 10%): rarer, different biology, may not share PRC2 dependence",
    ],
    biomarkers: [
      "SMARCB1/INI1 loss by IHC (over 90% of cases, defining feature)",
      "EZH2 / PRC2 hyperactivation (consequence of SMARCB1 loss)",
      "PD-L1 expression (variable, investigational)",
      "Tumour-infiltrating lymphocytes (TIL density, prognostic)",
      "Tertiary lymphoid structures (associated with improved ICI outcomes in sarcoma)",
      "Low tumour mutational burden (few neoantigens for vaccines or ICI)",
      "ctDNA (validated for low-TMB soft tissue sarcoma in SU2C-SARC032, JCO 2026, doi:10.1200/JCO.25.01234)",
    ],
    standardOfCare: [
      {
        setting: "Localised disease (curative intent)",
        approach:
          "Wide surgical resection with negative margins is the only curative approach. Limb-sparing surgery is standard; amputation for unresectable or recurrent disease. Sentinel lymph node biopsy is considered given the high lymphatic spread rate (22 to 48%).",
        refs: [],
        guideline: {
          version: "NCCN Guidelines: Soft Tissue Sarcoma",
          url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1420",
        },
      },
      {
        setting: "Adjuvant radiation",
        approach:
          "Post-operative 60 to 66 Gy or pre-operative 50 Gy for close margins or large tumours. Brachytherapy shows positive results. Proton and carbon ion therapy have not been specifically studied in ES.",
        refs: ["brachytherapy", "proton-therapy", "carbon-ion"],
        guideline: {
          nccn: "Category 2A: radiation for close margins or high-risk features",
          version: "NCCN Guidelines: Soft Tissue Sarcoma",
          url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1420",
        },
      },
      {
        setting: "Metastatic or unresectable disease",
        approach:
          "Doxorubicin monotherapy (approximately 20% response) or gemcitabine plus docetaxel. Ifosfamide as alternative. Vinorelbine produced a case report complete response of pulmonary metastases. No standard second-line; clinical trial enrolment encouraged.",
        refs: ["doxorubicin", "ifosfamide"],
        guideline: {
          nccn: "Category 2A: anthracycline-based chemotherapy for metastatic sarcoma",
          version: "NCCN Guidelines: Soft Tissue Sarcoma",
          url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1420",
        },
      },
      {
        setting: "Previously: tazemetostat (WITHDRAWN March 2026)",
        approach:
          "EZH2 inhibitor, FDA-approved January 2020 based on 15% ORR (Gounder et al., Lancet Oncol 2020, doi:10.1016/S1470-2045(19)30730-0). Withdrawn globally March 2026 by Ipsen after secondary haematologic malignancies in SYMPHONY-1 follicular lymphoma trial (18 of 318, 5.7%; source: Ipsen press release 9 March 2026). No longer available.",
        refs: ["tazemetostat"],
        guideline: {
          version: "Ipsen voluntary withdrawal notice, 9 March 2026",
          url: "https://www.globenewswire.com/news-release/2026/03/09/3252192/0/en/update-ipsen-voluntarily-withdraws-tazverik-tazemetostat-in-follicular-lymphoma-and-epithelioid-sarcoma.html",
        },
      },
    ],
    stateOfArt: [
      "Surgery with wide negative margins remains the only curative approach; radiation improves local control but does not address metastatic risk.",
      "Immune checkpoint inhibitors show signals in small cohorts: pembrolizumab 20% PR in AcSe basket (Italiano et al., Lancet Oncol 2018); pembrolizumab plus T-VEC 35% ORR in advanced sarcomas at MSK (Choi et al., JITC 2024).",
      "Next-generation PRC2 inhibitors (rinzimetostat targeting EED, valemetostat targeting EZH1 and EZH2, SHR2554 targeting EZH2) retain activity in tazemetostat-resistant models but lack ES-specific trials.",
      "ctDNA monitoring validated for low-TMB soft tissue sarcoma (SU2C-SARC032, JCO 2026) enables MRD detection in a disease where imaging alone is insufficient.",
    ],
    history: [
      { year: 1970, title: "Epithelioid sarcoma first described", note: "Enzinger characterised the distal (classic) type as a distinctive soft tissue tumour of young adults. Source: Enzinger, Cancer 1970." },
      { year: 1998, title: "SMARCB1/INI1 loss identified in ES", note: "Loss of nuclear INI1 expression by IHC becomes the diagnostic hallmark, linking ES to rhabdoid tumour biology." },
      { year: 2013, title: "SMARCB1 loss creates EZH2/PRC2 dependence", note: "Mechanistic work shows SMARCB1 loss drives oncogenic compensation through EZH2 (PRC2), establishing the therapeutic rationale for EZH2 inhibition." },
      { year: 2020, title: "Tazemetostat FDA-approved for ES", note: "First targeted therapy for ES. Phase 2: 15% ORR (Gounder et al., Lancet Oncol 2020, doi:10.1016/S1470-2045(19)30730-0).", refs: ["tazemetostat"] },
      { year: 2026, title: "Tazemetostat withdrawn globally", note: "Ipsen withdraws tazemetostat (March 2026) after secondary haematologic malignancies in SYMPHONY-1 FL trial (18 of 318, 5.7%; Ipsen press release 9 March 2026).", refs: ["tazemetostat"] },
    ],
    pipeline: [],
    openProblems: [
      "No FDA-approved targeted therapy remains after tazemetostat withdrawal in March 2026. The only approved ES-specific drug is gone.",
      "Low tumour mutational burden means few neoantigens for vaccines and immunotherapy, though emerging research on bystander T-cell activation may offer a path around this.",
      "Next-generation PRC2 inhibitors (rinzimetostat, valemetostat, SHR2554) are in trials for other cancers but have no ES cohorts.",
      "Clinical trial access is severely limited: ultra-rare disease, most trials exclude sarcoma or lack ES cohorts.",
      "No standard surveillance strategy after curative-intent treatment. Imaging schedules vary, recurrence rates are 34 to 77%, and late recurrence is common.",
      "Radiation advances (proton therapy, carbon ion, SBRT) have not been studied specifically in ES.",
    ],
    targets: ["smarcb1", "ezh2", "pd1", "pdl1", "egfr", "cdk4-6", "tp53", "b7h3"],
    technologies: [
    ...
    pathways: ["ddr", "pi3k-akt-mtor", "pd1-checkpoint", "brca", "p53-cell-cycle"],
    companies: [
      "ipsen",
    ...
    terms: ["ctdna", "tmb", "tils", "ihc", "neoantigen", "mrd", "orr", "os", "pcr", "basket-umbrella-platform", "cold-vs-hot", "synthetic-lethality", "abscopal-effect"],
    related: ["sarcoma"],
    tags: ["sarcoma"],
    drugs: [
      "doxorubicin",
    ...
    trials: [],
    links: [
      { label: "NCCN Soft Tissue Sarcoma Guidelines", url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1420" },
      { label: "Ipsen voluntary withdrawal notice, 9 March 2026", url: "https://www.globenewswire.com/news-release/2026/03/09/3252192/0/en/update-ipsen-voluntarily-withdraws-tazverik-tazemetostat-in-follicular-lymphoma-and-epithelioid-sarcoma.html" },
      { label: "Gounder et al., Lancet Oncol 2020 (tazemetostat phase 2)", url: "https://doi.org/10.1016/S1470-2045(19)30730-0" },
      { label: "Italiano et al., Lancet Oncol 2018 (AcSe pembrolizumab basket)", url: "https://pubmed.ncbi.nlm.nih.gov/29779840/" },
      { label: "SU2C-SARC032 ctDNA in STS, JCO 2026, PMID 42715505", url: "https://pubmed.ncbi.nlm.nih.gov/42715505/" },
    ],
    journals: [
      "lancet-oncology",
      "nature",
