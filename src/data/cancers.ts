...
export const cancers: CancerInput[] = [
  ...
  c({
    ...
    // Biomarkers, state of the art, history and open problems are written in full by the colorectal deep-dive files
    // (src/data/spikes/colorectal.ts and colorectal-core.ts); the short versions that stood here restated them line for line.
    standardOfCare: [
