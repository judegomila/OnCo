...
export const INTL_ROWS: IntlRow[] = [
  ...
  { id: "israel", country: "Israel", model: "Universal statutory insurance through four health funds. A licensed drug is not funded until a public committee, appointed annually by the Health and Finance Ministers, votes it into the health basket inside a supplement fixed in advance: 650 million shekels in 2026, about one percent of the basket, of which 52 percent went to oncology and haemato-oncology. Applications are open to anyone, deliberations and transcripts are published, and the ranked list of new cancer drugs is produced by the oncology society using the ESMO benefit scale.", patientShare: "Cancer is a statutory severe illness: no co-payment on the medicines for the disease, no quarterly clinic charge, no emergency charge for attendance related to it, and a monthly cap on other basket medicines that the funds set separately. A drug that does not get into the basket is paid for by the patient, by commercial insurance held by about 22% of the population, or through the fund's exceptions committee; supplementary plans are forbidden by law from covering life-extending medicines.", decider: "The public committee for expanding the health services basket, then the Health Council and the government; the Ministry of Health's Pharmaceutical Division licenses separately.", year: 2026, source: { label: "State Comptroller of Israel, Expanding the health basket (May 2022, Hebrew)", url: "https://library.mevaker.gov.il/sites/DigitalLibrary/Documents/2022/2022.5/2022.5-203-Sal_Habriut.pdf" } },
