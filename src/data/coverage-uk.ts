...
const list: UkCoverage[] = [
  ...
  // ================= ADCs =================
  cdf("trastuzumab-deruxtecan", "trastuzumab deruxtecan", 704, 2021, "HER2-positive unresectable or metastatic breast cancer after 2 or more anti-HER2 treatments", { note: "Second-line HER2-positive (DESTINY-Breast03) recommended in TA862 (2023). HER2-low breast cancer (DESTINY-Breast04) was not recommended in final guidance in 2024 after a dispute over the severity modifier, a decision widely criticised by patient groups; NICE opened a rapid review of TA992 (GID-TA12551) which was in progress with no publication date on 25 September 2026. A separate appraisal for hormone receptor-positive HER2-low disease after 2 or more endocrine treatments, TA1112, was terminated on 19 November 2025 because the company did not provide an evidence submission, and the Scottish Medicines Consortium recorded a non-submission (SMC2888). Gastric and NSCLC indications are separate appraisals. HER2-low metastatic breast cancer after chemotherapy (DESTINY-Breast04): TA992 (July 2024), not recommended within the licence. HER2-mutated advanced NSCLC after platinum chemotherapy: TA976 (May 2024), terminated appraisal.", smc: "accepted" }),
  ...
  rec("sacituzumab-govitecan", "sacituzumab govitecan", 819, 2022, "Unresectable triple-negative breast cancer after 2 or more systemic treatments", { note: "The hormone receptor-positive, HER2-negative indication (TROPiCS-02) has no funding route: TA1089 was terminated on 13 August 2025 because the company did not provide an evidence submission, and the Scottish Medicines Consortium recorded a non-submission (SMC2916). Sacituzumab govitecan for untreated PD-L1-negative triple-negative advanced breast cancer (ID6433) is awaiting development. Read from nice.org.uk on 25 September 2026.", smc: "accepted" }),
  ...
  cdf("brexucabtagene-autoleucel", "brexucabtagene autoleucel", 677, 2021, "Relapsed or refractory mantle cell lymphoma after a BTK inhibitor", { note: "Relapsed or refractory B-cell ALL in people 26 and over: TA893 (June 2023), recommended through the Cancer Drugs Fund.", smc: "accepted" }),
  ...
  // ================= Breast =================
  rec("palbociclib", "palbociclib", 495, 2017, "With an aromatase inhibitor for untreated HR-positive, HER2-negative advanced breast cancer", { note: "With fulvestrant after endocrine therapy: TA836 (26 October 2022), which updates and replaces TA619. Read from nice.org.uk on 25 September 2026.", smc: "accepted" }),
  ...
  rec("abemaciclib", "abemaciclib", 563, 2019, "With an aromatase inhibitor for untreated HR-positive, HER2-negative advanced breast cancer", { note: "With fulvestrant: TA725 (15 September 2021), which updates and replaces the Cancer Drugs Fund appraisal TA579. Adjuvant use for high-risk early breast cancer (monarchE): TA810 (2022). Read from nice.org.uk on 25 September 2026.", smc: "accepted" }),
  ...
  term("imlunestrant", "imlunestrant", 1168, 2026, "ER-positive HER2-negative advanced breast cancer after endocrine therapy", { note: "Terminated evaluation published 18 June 2026: NICE states it is unable to make a recommendation because the company did not provide an evidence submission, so imlunestrant has no NHS funding route in England. A terminated evaluation is not a judgement on the evidence; no committee considered it. Read from nice.org.uk on 25 September 2026." }),
  ...
  notRec("fulvestrant", "fulvestrant", 239, 2011, "Locally advanced or metastatic breast cancer as monotherapy", { note: "Refused twice as monotherapy: TA239 (2011) and TA503 (31 January 2018), the latter for untreated locally advanced or metastatic oestrogen-receptor-positive disease in postmenopausal women, pending final overall survival data from FALCON. It is now generic and widely used on the NHS as the partner drug in the CDK4/6, alpelisib and capivasertib combinations, all of which are NICE recommended. Read from nice.org.uk on 25 September 2026.", commissioned: true }),
  ...
  opt("bevacizumab", "bevacizumab (originator and biosimilars)", 1136, 2026, "First- and second-line metastatic colorectal cancer, only when targeted treatments or immunotherapy are unsuitable and chemotherapy would otherwise be offered", { note: "Published 25 February 2026, subject to an agreed price with NHS Medicines Procurement and Supply Chain. It updates and replaces TA212 and partly replaces TA242 and TA118, reversing almost twenty years of refusals for bowel cancer that biosimilar pricing finally undid. NICE has still not recommended bevacizumab for ovarian (TA284, TA285), breast (TA214) or cervical cancer; the Scottish Medicines Consortium has not revisited its 2006 refusal for colorectal cancer (SMC 221/05). Bevacizumab with atezolizumab for HCC is funded under TA666.", commissioned: true }),
  ...
  rec("regorafenib", "regorafenib", 555, 2019, "Advanced HCC after sorafenib", { note: "GIST after imatinib and sunitinib: TA488 (2017). Previously treated metastatic colorectal cancer: TA866 (February 2023), recommended within the licence after an earlier appraisal had not recommended it.", smc: "accepted" }),
  ...
  rec("pemigatinib", "pemigatinib", 722, 2021, "FGFR2 fusion or rearrangement-positive cholangiocarcinoma after 1 or more systemic therapies", { note: "Published 25 August 2021: recommended within its marketing authorisation with a commercial arrangement (routine commissioning, not the Cancer Drugs Fund; the recommendation text carries no managed access wording). SMC2399 accepted 7 February 2022.", smc: "accepted" }),
  ...
  // ================= Genitourinary =================
  rec("abiraterone", "abiraterone", 259, 2012, "Metastatic hormone-relapsed prostate cancer after docetaxel", { note: "Before chemotherapy is indicated: TA387 (2016). Newly diagnosed high-risk hormone-sensitive metastatic disease: TA1110 (19 November 2025), which updates and replaces TA721; TA721's own page now carries only that replacement notice, so its recommendation cannot be read. Two indications are funded in England by NHS England commissioning rather than by appraisal: upfront abiraterone in newly diagnosed high-risk metastatic hormone-sensitive disease from 13 December 2024 (Blueteq ABI4), and abiraterone in high-risk hormone-sensitive non-metastatic disease from 16 January 2026 under clinical commissioning policy URN 2312, an off-label use on STAMPEDE's criteria. Wales reached the non-metastatic indication first, through One Wales decision OW20 in November 2022. Read from the guidance and the Cancer Drugs Fund list v1.408 on 25 September 2026.", smc: "accepted" }),
  rec("enzalutamide", "enzalutamide", 316, 2014, "Metastatic hormone-relapsed prostate cancer after docetaxel", { note: "Before chemotherapy is indicated: TA377 (2016). Hormone-sensitive metastatic disease: TA712 (2021). With talazoparib for untreated hormone-relapsed metastatic disease where abiraterone cannot be used: TA1130 (February 2026). Two settings where it is not funded: high-risk non-metastatic hormone-relapsed disease was NOT recommended (TA580, May 2019, and SMC2195 in Scotland), while apalutamide (TA740) and darolutamide (TA660) were recommended for the same setting; and non-metastatic disease after radical prostatectomy or radiotherapy was a terminated appraisal because Astellas did not submit evidence (TA994, August 2024), refused as a non-submission in Scotland too (SMC2742). Read from the guidance on 25 September 2026.", smc: "accepted" }),
  rec("apalutamide", "apalutamide", 740, 2021, "With androgen deprivation therapy for high-risk hormone-relapsed non-metastatic prostate cancer, high risk being a PSA that has doubled in 10 months or less", { note: "The two 28 October 2021 appraisals are easy to swap: TA740 is the non-metastatic hormone-relapsed indication and TA741 is hormone-sensitive metastatic disease, where it is recommended only for people who cannot have docetaxel. Both read from the guidance on 25 September 2026. SMC2579 accepted the non-metastatic indication in July 2023 and SMC2472 the metastatic one in September 2022.", smc: "accepted" }),
  rec("darolutamide", "darolutamide", 660, 2020, "High-risk non-metastatic hormone-relapsed prostate cancer", { note: "With docetaxel and androgen deprivation therapy for metastatic hormone-sensitive disease (ARASENS): TA903 (2023). With androgen deprivation therapy alone, where docetaxel is not suitable: TA1109 (12 November 2025), with a least-expensive-option clause naming apalutamide. That last indication is the one place the four nations currently diverge on a prostate medicine: the Scottish Medicines Consortium did not recommend it on 8 June 2026 (SMC2940) because the company made no submission. Read from the guidance and the SMC advice on 25 September 2026.", smc: "accepted for other indications; SMC2940 not recommended for darolutamide with ADT in hormone-sensitive metastatic disease" }),
  ...
  notRec("pluvicto", "lutetium-177 vipivotide tetraxetan", 930, 2023, "PSMA-positive hormone-relapsed metastatic prostate cancer after taxane chemotherapy and an anti-androgen, or when taxanes are medically unsuitable (VISION)", { note: "Not recommended, read from the guidance itself on 25 September 2026: recommendation 1.1 of TA930, published 15 November 2023, says lutetium-177 vipivotide tetraxetan is not recommended within its marketing authorisation, and the committee noted that no evidence was submitted comparing it with radium-223. The second evaluation, of use after an anti-androgen but before a taxane, was terminated on 16 July 2026 because the company did not provide an evidence submission (TA1179). The Scottish Medicines Consortium refused it twice, SMC2517 in October 2023 and SMC2966 in August 2026. NHS England's molecular radiotherapy service specification 2322 does not list it. It is therefore not commissioned anywhere in the NHS; UK patients receive it in trials such as STAMPEDE2, through expanded access, or privately.", smc: "not recommended" }),
