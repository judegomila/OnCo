...
const RECORDS: UsCoverage[] = [
  ...
  rec("belantamab-mafodotin", "B", `${IV} Withdrawn from the US market in 2022–2023 and re-approved in 2025 in combination; ocular monitoring under a REMS.`, "covered with prior authorisation", `${PA_IV} Plans require documented prior lines and enrolment in the ocular REMS.`, { pap: [...PAP.gsk, ...PAP.charities, ...PAP.lls], oop: B_OOP }),
  ...
  rec("cabazitaxel", "B", `${IV} Generics entered the US market in 2021–2024 after patent litigation.`, "covered with prior authorisation", `${PA_IV} Plans typically require prior docetaxel.`, { pap: [...PAP.sanofi, ...PAP.charities], oop: B_OOP }),
