...
export const ctdnaRoadmaps: RoadmapInput[] = [
  r({
    ...
    keyPapers: ["paper-dynamic-nejm-2022", "paper-galaxy-signatera-nat-med-2023", "paper-imvigor011-nejm-2025", "paper-pathfinder-lancet-2023", "paper-nhs-galleri-design-cancers-2022"],
    ...
    steps: [
      ...
      },
      {
        ...
        refs: ["mced", "galleri", "shield", "grail", "guardant-health", "pathfinder-2", "nhs-galleri", "eclipse-shield", "paper-pathfinder-lancet-2023", "paper-nhs-galleri-design-cancers-2022", "cfdna-methylation-testing", "stage-shift", "ppv", "deb-schrag", "peter-sasieni"],
      },
      {
...
export const ctdnaTerms: TermInput[] = [
  {
    id: "tumour-informed-assay", kind: "term", name: "Tumour-informed versus tumour-naive ctDNA assays", aka: ["Tumour-informed MRD", "Tumour-agnostic ctDNA assay", "Personalised ctDNA panel"], category: "Biomarkers", asOf,
