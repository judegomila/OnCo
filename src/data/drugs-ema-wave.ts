...
export const drugsEmaWave: DrugInput[] = [
  ...
  d({ id: "epoetin-theta", name: "Epoetin theta", brand: "Eporatio / Biopoin", aka: ["epoetin theta", "Eporatio", "Biopoin"], status: "approved", tags: ["supportive"],
    ...
    links: [{ label: "EMA: Eporatio (EPAR)", url: EPAR("eporatio") }, { label: "EMA: Biopoin (EPAR)", url: EPAR("biopoin") }] }),
