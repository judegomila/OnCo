...
const baseDrugs: DrugInput[] = [
  ...
  },
  {
    ...
    tldr: "Gemtuzumab ozogamicin (Mylotarg) is an anti-CD33 antibody linked to the DNA-cutting payload calicheamicin, the first ADC approved, in 2000 for relapsed acute myeloid leukaemia. An unstable linker and no benefit in a confirmatory trial led to withdrawal in 2010; it returned in 2017 at a lower fractionated dose, with liver toxicity, including veno-occlusive disease, its defining risk.",
