...
export const drugs: DrugInput[] = [
  ...
  {
    id: "daraxonrasib", kind: "drug", name: "Daraxonrasib", code: "RMC-6236", modality: "Small-molecule pan-RAS(ON) inhibitor", asOf, status: "phase-3",
    tldr: "A drug that blocks all active RAS variants, in a pivotal trial for pancreatic cancer, where KRAS drives 90% of tumours.",
    summary: "Revolution Medicines' tri-complex inhibitor. Phase 1/2: median OS ~14.5 months in second-line pancreatic cancer versus historical ~6 months. RASolute 302 phase 3 (second-line PDAC) fully enrolled; RASolute 303 (first-line) and NSCLC phase 3 (RASolve 301) ongoing. Breakthrough Therapy designation. Rash and stomatitis are the main toxicities.",
