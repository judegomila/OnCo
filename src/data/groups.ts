...
export const groups: InstitutionInput[] = [
  grp({ id: "swog", name: "SWOG Cancer Research Network", city: "Portland, OR", country: "US", lat: 45.512, lng: -122.658, website: "https://www.swog.org",
    tldr: "One of the US National Cancer Institute's cooperative groups: thousands of community and academic sites running practice-changing trials, including the 2026 first-line Hodgkin lymphoma result.",
  ...
  grp({ id: "childrens-oncology-group", name: "Children's Oncology Group (COG)", city: "Monrovia, CA", country: "US", lat: 34.144, lng: -118.001, website: "https://childrensoncologygroup.org",
    tldr: "The world's largest paediatric cancer trials organisation; most children with cancer in North America are treated on or according to a COG protocol.",
  ...
  grp({ id: "cctg", name: "Canadian Cancer Trials Group (CCTG)", city: "Kingston, ON", country: "CA", lat: 44.231, lng: -76.486, website: "https://www.ctg.queensu.ca",
    ...
    summary: "Based at Queen's University. CHALLENGE (CO.21, NEJM 2025) showed a structured exercise programme improves survival in colon cancer; MA.17 (extended letrozole) and PA.3 (erlotinib in pancreatic cancer) were earlier landmarks.",
  ...
  grp({ id: "big", name: "Breast International Group (BIG)", city: "Brussels", country: "BE", lat: 50.850, lng: 4.352, website: "https://www.bigagainstbreastcancer.org",
    tldr: "The umbrella for 50+ academic breast cancer groups worldwide, co-sponsor of OlympiA, APHINITY, and HERA.",
  ...
  grp({ id: "jcog", name: "Japan Clinical Oncology Group (JCOG)", city: "Tokyo", country: "JP", lat: 35.665, lng: 139.767, website: "https://jcog.jp",
    tldr: "Japan's national cooperative group, defining surgical and perioperative standards in gastric and oesophageal cancer.",
  ...
  grp({ id: "unicancer", name: "UNICANCER", city: "Paris", country: "FR", lat: 48.856, lng: 2.352, website: "https://www.unicancer.fr",
    tldr: "The network of France's comprehensive cancer centres and its academic trials sponsor.",
  ...
  grp({ id: "nccn-org", name: "National Comprehensive Cancer Network (NCCN)", city: "Plymouth Meeting, PA", country: "US", lat: 40.102, lng: -75.274, website: "https://www.nccn.org",
    tldr: "The alliance of 33 US cancer centres whose guidelines decide, in practice, what US oncologists do and what insurers pay for.",
