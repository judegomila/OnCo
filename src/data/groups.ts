...
export const groups: InstitutionInput[] = [
  grp({ id: "swog", name: "SWOG Cancer Research Network", city: "Portland, OR", country: "US", lat: 45.512, lng: -122.658, website: "https://www.swog.org",
    ...
    trials: ["scarlet-s2212"], drugs: ["nivolumab"], cancers: ["hodgkin-lymphoma", "tnbc"], institutions: ["fred-hutch", "nci"], people: ["kathy-albain", "anne-chiang", "hagen-kennecke"], links: [{ label: "Official website", url: "https://www.swog.org" }] }),
  grp({ id: "nrg-oncology", name: "NRG Oncology", city: "Philadelphia, PA", country: "US", lat: 39.952, lng: -75.165, website: "https://www.nrgoncology.org",
    ...
    trials: ["olympia"], drugs: ["olaparib", "artera-ai-prostate"], cancers: ["tnbc", "prostate", "cervical", "endometrial"], institutions: ["nci"], links: [{ label: "Official website", url: "https://www.nrgoncology.org" }] }),
  grp({ id: "alliance-oncology", name: "Alliance for Clinical Trials in Oncology", city: "Chicago, IL", country: "US", lat: 41.881, lng: -87.630, website: "https://www.allianceforclinicaltrialsinoncology.org",
    ...
    trials: ["optimice-pcr"], drugs: ["pembrolizumab", "carboplatin"], technologies: ["sentinel-node"], cancers: ["tnbc"], institutions: ["nci"], links: [{ label: "Official website", url: "https://www.allianceforclinicaltrialsinoncology.org" }] }),
  grp({ id: "ecog-acrin", name: "ECOG-ACRIN Cancer Research Group", city: "Philadelphia, PA", country: "US", lat: 39.955, lng: -75.160, website: "https://ecog-acrin.org",
    ...
    drugs: ["blinatumomab"], technologies: ["mammography"], cancers: ["all-leukemia"], institutions: ["nci", "montefiore-einstein", "uw-carbone"], people: ["peter-odwyer", "mitchell-schnall"], links: [{ label: "Official website", url: "https://ecog-acrin.org" }] }),
  grp({ id: "childrens-oncology-group", name: "Children's Oncology Group (COG)", city: "Monrovia, CA", country: "US", lat: 34.144, lng: -118.001, website: "https://childrensoncologygroup.org",
    ...
    drugs: ["blinatumomab"], cancers: ["all-leukemia", "neuroblastoma"], institutions: ["nci", "uw-carbone", "cche-57357"], people: ["douglas-hawkins"], links: [{ label: "Official website", url: "https://childrensoncologygroup.org" }] }),
  grp({ id: "cctg", name: "Canadian Cancer Trials Group (CCTG)", city: "Kingston, ON", country: "CA", lat: 44.231, lng: -76.486, website: "https://www.ctg.queensu.ca",
    ...
    technologies: ["exercise-oncology", "sbrt"], cancers: ["colorectal", "breast-hr-positive"], people: ["tu-dongsheng", "parulekar-wendy"], links: [{ label: "Official website", url: "https://www.ctg.queensu.ca" }] }),
  grp({ id: "big", name: "Breast International Group (BIG)", city: "Brussels", country: "BE", lat: 50.850, lng: 4.352, website: "https://www.bigagainstbreastcancer.org",
    ...
    trials: ["olympia"], drugs: ["olaparib", "trastuzumab"], cancers: ["tnbc", "breast-her2-positive", "breast-hr-positive"], institutions: ["nrg-oncology"], links: [{ label: "Official website", url: "https://www.bigagainstbreastcancer.org" }] }),
  grp({ id: "gbg", name: "German Breast Group (GBG)", city: "Neu-Isenburg", country: "DE", lat: 50.052, lng: 8.694, website: "https://www.gbg.de",
    ...
    drugs: ["carboplatin", "durvalumab"], terms: ["pcr"], cancers: ["tnbc"], links: [{ label: "Official website", url: "https://www.gbg.de" }] }),
  grp({ id: "jcog", name: "Japan Clinical Oncology Group (JCOG)", city: "Tokyo", country: "JP", lat: 35.665, lng: 139.767, website: "https://jcog.jp",
    ...
    cancers: ["gastric", "esophageal", "nsclc"], institutions: ["ncc-japan"], people: ["fukuda-haruhiko"], links: [{ label: "Official website", url: "https://jcog.jp" }] }),
  grp({ id: "unicancer", name: "UNICANCER", city: "Paris", country: "FR", lat: 48.856, lng: 2.352, website: "https://www.unicancer.fr",
    ...
    technologies: ["hipec"], terms: ["real-world-evidence"], cancers: ["colorectal", "tnbc"], institutions: ["gustave-roussy", "institut-curie", "icm-montpellier", "centre-jean-perrin", "centre-henri-becquerel", "centre-eugene-marquis", "ico-angers-nantes", "centre-francois-baclesse"], people: ["christophe-le-tourneau"], links: [{ label: "Official website", url: "https://www.unicancer.fr" }] }),
