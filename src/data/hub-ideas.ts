...
export const hubIdeas: HubIdea[] = [
  ...
  { n: 27, title: "University output ranking from open bibliometrics", why: "Pull Nature Index and OpenAlex counts per institution for oncology journals; publish the query.", status: "building", theme: "Institutions" },
  { n: 28, title: "Trial leadership index", why: "Which institutions led the pivotal trials in the corpus. A different signal from publication counts.", status: "planned", theme: "Institutions" },
  { n: 29, title: "Open cooperative-group directory", why: "SWOG, NRG, Alliance, EORTC, BIG, GBG, JCOG: what they run and how to join.", status: "proposed", theme: "Institutions" },
  { n: 30, title: "Funding flows", why: "NCI, CRUK, ERC, philanthropy: where the money goes by cancer and modality.", status: "proposed", theme: "Institutions" },
  ...
  { n: 33, title: "Expert review badges", why: "Clinicians and scientists sign off on pages in their area; badge shows reviewer and date.", status: "planned", theme: "Community" },
  ...
  { n: 35, title: "Bounties for gaps", why: "List missing objects and stale facts; recognise contributors who fill them.", status: "proposed", theme: "Community" },
  { n: 36, title: "Weekly 'what changed in oncology' newsletter generated from the diff", why: "The changelog is the newsletter. Zero extra editorial cost.", status: "planned", theme: "Community" },
