...
const files: IdeaInput[][] = [ideasBiology1, ideasBiology2, ideasPrevention, ideasTrials1, ideasTrials2, ideasRegulation, ideasAccess, ideasData, ideasFunding, ideasPeopleMoonshots];
