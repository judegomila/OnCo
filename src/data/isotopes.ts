...
export const isotopes: Isotope[] = [
  { id: "lu-177", symbol: "¹⁷⁷Lu", name: "Lutetium-177", halfLife: "6.65 days", emission: "β⁻ (0.5 MeV, ~2 mm range) + γ (208 keV, imageable)", use: "therapy",
    ...
    supply: "tight", supplyNote: "Demand grew sharply with Pluvicto. Reactor capacity (BR2, HFR, MARIA, SAFARI-1, Russian reactors) and enriched ¹⁷⁶Yb availability are the constraints; accelerator-based routes (SHINE) are scaling. Shortages in 2022 and 2023 delayed Pluvicto doses; supply improved by 2025.",
  ...
  { id: "pb-212", symbol: "²¹²Pb", name: "Lead-212", halfLife: "10.6 hours", emission: "β⁻ to ²¹²Bi, then α (via ²¹²Bi/²¹²Po); effectively an in-vivo α generator", use: "therapy",
    ...
    supply: "emerging", supplyNote: "Short half-life forces same-day logistics but avoids Ac-225's daughter-redistribution problem. Orano Med's industrial-scale ²¹²Pb production came online in 2024 and 2025; AlphaMedix (²¹²Pb-DOTAMTATE) is in registrational development.",
  ...
  { id: "ga-68", symbol: "⁶⁸Ga", name: "Gallium-68", halfLife: "68 minutes", emission: "β⁺ (PET)", use: "imaging",
    ...
    supply: "adequate", supplyNote: "Generator shortages in 2020 and 2021 during PSMA PET launch; cyclotron routes and ¹⁸F-labelled alternatives (Pylarify) relieved pressure.",
  ...
  { id: "zr-89", symbol: "⁸⁹Zr", name: "Zirconium-89", halfLife: "78.4 hours", emission: "β⁺ (PET), γ (909 keV)", use: "imaging",
    ...
    supply: "adequate", supplyNote: "Half-life matched to antibody kinetics (imaging at 3 to 7 days); higher patient dose than ¹⁸F. Supply scales with immuno-PET demand.",
