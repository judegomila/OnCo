...
export const papersSolidTumours: PaperInput[] = [
  ...
  // KEYNOTE-A18 was reported in two Lancet papers in 2024: the first interim analysis (progression-free survival, March)
  // and the second interim analysis (overall survival, September). Each has its own DOI and record; figures are from the abstracts.
  p({ id: "paper-keynote-a18-pfs-lancet-2024", name: "KEYNOTE-A18: pembrolizumab with chemoradiotherapy for locally advanced cervical cancer (progression-free survival)",
    tldr: "Adding pembrolizumab to standard chemoradiotherapy for high-risk locally advanced cervical cancer reduced progression or death by 30%, the first systemic advance in this setting since cisplatin was added to radiotherapy in 1999.",
    summary: "Double-blind, placebo-controlled phase 3 trial (ENGOT-cx11/GOG-3047/KEYNOTE-A18) of 1,060 patients at 176 centres in 30 countries with newly diagnosed, high-risk locally advanced cervical cancer (FIGO 2014 stage IB2-IIB with node-positive disease, or stage III-IVA) randomised 1:1 to five cycles of pembrolizumab 200 mg or placebo every three weeks with chemoradiotherapy, then 15 cycles of pembrolizumab 400 mg or placebo every six weeks. Primary endpoints were progression-free survival and overall survival.\n\nAt the first interim analysis (data cutoff 9 January 2023, median follow-up 17.9 months) median progression-free survival was not reached in either group; the 24-month rate was 68% with pembrolizumab against 57% with placebo (HR 0.70, p=0.0020). Overall survival at 24 months was 87% against 81% (HR 0.73), not yet significant at this analysis. A second Lancet report later in 2024 confirmed the overall survival gain.",
    journal: "The Lancet", year: 2024, doi: "10.1016/S0140-6736(24)00317-9", pmid: "38521086",
    ...
    links: [
      { label: "Lancet 2024 (PFS)", url: "https://doi.org/10.1016/S0140-6736(24)00317-9" },
      { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/38521086/" },
    ...
    terms: ["pfs", "os", "cps", "standard-of-care"], companies: ["merck"], trials: ["keynote-a18"],
    institutions: ["gemelli"], people: ["domenica-lorusso", "giovanni-scambia"], bottlenecks: ["b-global-access", "b-immunotherapy-response", "b-drug-pricing"], journals: ["lancet"] }),

  p({ id: "paper-keynote-a18-os-lancet-2024", name: "KEYNOTE-A18: pembrolizumab with chemoradiotherapy for locally advanced cervical cancer (overall survival)",
    tldr: "The second report from KEYNOTE-A18 showed that adding pembrolizumab to chemoradiotherapy for high-risk locally advanced cervical cancer also lengthened life: 82.6% of women were alive at three years against 74.8%, a third fewer deaths.",
    ...
    journal: "The Lancet", year: 2024, doi: "10.1016/S0140-6736(24)01808-7", pmid: "39288779",
    authors: "Lorusso D, Xiang Y, Hasegawa K, et al.", paperType: "rct", participants: 1060, changedPractice: true,
    findings: [
    ...
    links: [
      { label: "Lancet 2024 (OS)", url: "https://doi.org/10.1016/S0140-6736(24)01808-7" },
      { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/39288779/" },
      { label: "ClinicalTrials.gov NCT04221945", url: "https://clinicaltrials.gov/study/NCT04221945" },
    ],
    cancers: ["cervical"], drugs: ["pembrolizumab"], targets: ["pd1"], technologies: ["checkpoint-inhibitor", "imrt-igrt", "brachytherapy", "platinum"],
    terms: ["pfs", "os", "cps", "standard-of-care"], companies: ["merck"], trials: ["keynote-a18"],
  ...
  // ======================= TOP-CITED LANDMARK TRIALS =======================
  p({ id: "paper-slamon-trastuzumab-nejm-2001", name: "Slamon 2001: adding trastuzumab to chemotherapy for HER2-positive metastatic breast cancer",
    tldr: "The trial that made trastuzumab standard: adding the HER2 antibody to chemotherapy slowed progression and prolonged life in women whose breast cancers overexpressed HER2, at the cost of heart weakening when it was paired with anthracyclines.",
    summary: "This phase 3 trial randomised 469 women with previously untreated HER2-overexpressing metastatic breast cancer to chemotherapy (an anthracycline plus cyclophosphamide, or paclitaxel for those who had received adjuvant anthracycline) with or without trastuzumab. Adding trastuzumab lengthened the time to progression and raised the response rate, and it improved overall survival despite two thirds of the chemotherapy-alone group receiving trastuzumab after progression. Cardiac dysfunction was markedly more frequent when trastuzumab was combined with the anthracycline, which is why the two are not given together today.",
    journal: "New England Journal of Medicine", year: 2001, doi: "10.1056/NEJM200103153441101", authors: "Slamon DJ, Leyland-Jones B, Shak S, et al.", paperType: "rct",
    findings: ["469 women with HER2-overexpressing metastatic breast cancer; chemotherapy with or without trastuzumab.", "Time to progression 7.4 vs 4.6 months; objective response 50% vs 32%.", "Median overall survival 25.1 vs 20.3 months, hazard ratio for death 0.80.", "Cardiac dysfunction in 27% of patients given anthracycline plus trastuzumab versus 8% with anthracycline alone, and 13% with paclitaxel plus trastuzumab."],
    whatItMeans: "This was the first proof that a monoclonal antibody against a growth receptor could extend life in a common solid tumour, and it created HER2-positive breast cancer as a disease treated differently from the rest. Its cardiac finding shaped every later HER2 regimen, which pair trastuzumab with taxanes rather than anthracyclines.",
    caveats: ["Crossover to trastuzumab after progression diluted the survival difference.", "HER2 positivity was defined by immunohistochemistry 2+ or 3+, broader than the 3+ or amplified definition used now.", "Open-label design."],
    changedPractice: true, participants: 469,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1056/NEJM200103153441101" }],
    cancers: ["breast-her2-positive"], drugs: ["trastuzumab", "paclitaxel"], targets: ["her2"], people: ["dennis-slamon"], companies: ["roche-genentech"], terms: ["os", "orr"], related: ["paper-slamon-her2-amplification-science-1987"] }),
  p({ id: "paper-hurwitz-bevacizumab-crc-nejm-2004", name: "Hurwitz 2004: bevacizumab with chemotherapy for metastatic colorectal cancer, the first anti-angiogenic drug to extend life",
    tldr: "Adding the VEGF antibody bevacizumab to irinotecan-based chemotherapy prolonged survival in first-line metastatic colorectal cancer, the first time blocking a tumour's blood supply had been shown to help patients.",
    ...
    journal: "New England Journal of Medicine", year: 2004, doi: "10.1056/NEJMoa032691", authors: "Hurwitz H, Fehrenbacher L, Novotny W, et al.", paperType: "rct",
    ...
    changedPractice: true, participants: 813,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1056/NEJMoa032691" }],
    cancers: ["colorectal"], drugs: ["bevacizumab", "irinotecan", "fluorouracil"], targets: ["vegf"], companies: ["roche-genentech"], terms: ["os", "pfs"], related: [] }),
  p({ id: "paper-keynote-024-nejm-2016", name: "KEYNOTE-024: pembrolizumab alone beats chemotherapy in PD-L1-high lung cancer",
    tldr: "In patients whose lung tumours carried PD-L1 on at least half their cells, pembrolizumab alone held the cancer back longer than chemotherapy and caused fewer serious side effects, making immunotherapy the first treatment for this group.",
    ...
    journal: "New England Journal of Medicine", year: 2016, doi: "10.1056/NEJMoa1606774", authors: "Reck M, Rodríguez-Abreu D, Robinson AG, et al.", paperType: "rct",
    ...
    whatItMeans: "This trial is why PD-L1 is measured on every new advanced lung cancer and why a patient with a high score can start immunotherapy without chemotherapy. Together with KEYNOTE-189 for the rest of the population, it moved checkpoint inhibitors from second-line rescue to the first treatment most lung cancer patients receive.",
    ...
    changedPractice: true, participants: 305,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1056/NEJMoa1606774" }, { label: "ClinicalTrials.gov NCT02142738", url: "https://clinicaltrials.gov/study/NCT02142738" }],
    cancers: ["nsclc"], drugs: ["pembrolizumab"], targets: ["pd1", "pdl1"], trials: ["keynote-024-189"], people: ["martin-reck"], companies: ["merck"], terms: ["tps", "pfs", "os"], related: [] }),
  p({ id: "paper-checkmate-057-nejm-2015", name: "CheckMate 057: nivolumab beats docetaxel after chemotherapy in non-squamous lung cancer",
    tldr: "After platinum chemotherapy had failed, the PD-1 antibody nivolumab prolonged life compared with docetaxel in non-squamous lung cancer with far fewer severe side effects, and the benefit was largest in tumours expressing PD-L1.",
    summary: "CheckMate 057 randomised 582 patients with non-squamous non-small-cell lung cancer that had progressed during or after platinum-based chemotherapy to nivolumab or docetaxel. Nivolumab improved overall survival, the primary endpoint, with a higher response rate, longer duration of response and a fraction of the severe toxicity of docetaxel. Unlike its squamous counterpart CheckMate 017, the benefit depended on PD-L1 expression, with little difference in PD-L1-negative tumours, which fuelled the debate about PD-L1 as a biomarker.",
    journal: "New England Journal of Medicine", year: 2015, doi: "10.1056/NEJMoa1507643", authors: "Borghaei H, Paz-Ares L, Horn L, et al.", paperType: "rct",
    findings: ["582 patients with previously treated non-squamous NSCLC; nivolumab vs docetaxel.", "Median overall survival 12.2 vs 9.4 months, hazard ratio 0.73.", "Response rate 19% vs 12%; median duration of response 17.2 vs 5.6 months.", "Grade 3 or 4 treatment-related adverse events 10% vs 54%.", "Survival benefit increased with PD-L1 expression and was not evident in PD-L1-negative tumours."],
    whatItMeans: "With CheckMate 017 in squamous disease, this trial ended docetaxel's reign as the default second-line treatment for lung cancer and established PD-1 blockade as standard after chemotherapy. Its PD-L1 finding shaped how later first-line trials were designed and how the biomarker is used in the clinic.",
    caveats: ["Open-label design.", "Early crossing of the survival curves suggested some patients fared worse on nivolumab in the first months.", "PD-L1 was assessed retrospectively on archival tissue."],
  ...
  p({ id: "paper-mpact-nab-paclitaxel-gemcitabine-nejm-2013", name: "MPACT (Von Hoff 2013): nab-paclitaxel plus gemcitabine for metastatic pancreatic cancer",
    tldr: "Adding albumin-bound paclitaxel to gemcitabine prolonged survival in metastatic pancreatic cancer in a large international trial, giving patients who are not fit enough for FOLFIRINOX a second effective first-line option.",
    summary: "MPACT randomised 861 patients with untreated metastatic pancreatic adenocarcinoma to nab-paclitaxel plus gemcitabine or gemcitabine alone. The combination improved overall survival, progression-free survival and response rate, with more neutropenia, fatigue and peripheral neuropathy that was usually reversible on dose reduction. Because it accepted patients up to performance status 2 and was less toxic than FOLFIRINOX, it became the alternative first-line standard and the backbone for many later combination trials.",
    journal: "New England Journal of Medicine", year: 2013, doi: "10.1056/NEJMoa1304369", authors: "Von Hoff DD, Ervin T, Arena FP, et al.", paperType: "rct",
    findings: ["861 patients with untreated metastatic pancreatic cancer; nab-paclitaxel plus gemcitabine vs gemcitabine.", "Median overall survival 8.5 vs 6.7 months, hazard ratio 0.72.", "Median progression-free survival 5.5 vs 3.7 months, hazard ratio 0.69; response rate 23% vs 7%.", "Grade 3 or higher neutropenia 38% vs 27% and peripheral neuropathy 17% vs 1%."],
    whatItMeans: "With FOLFIRINOX this trial defined the two chemotherapy standards for metastatic pancreatic cancer that still apply, and the gemcitabine and nab-paclitaxel backbone is the comparator in most current first-line pancreatic trials.",
    caveats: ["Open-label design.", "The survival gain is measured in months and the disease remains one of the most lethal.", "Cross-trial comparison with FOLFIRINOX is unreliable; the populations differed in fitness."],
    changedPractice: true, participants: 861,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1056/NEJMoa1304369" }, { label: "ClinicalTrials.gov NCT00844649", url: "https://clinicaltrials.gov/study/NCT00844649" }],
    cancers: ["pancreatic"], drugs: ["gemcitabine-nab-paclitaxel", "gemcitabine"], people: ["daniel-von-hoff"], terms: ["os", "pfs"], related: ["paper-conroy-folfirinox-pancreatic-nejm-2011"] }),
  p({ id: "paper-keynote-001-pembrolizumab-nsclc-nejm-2015", name: "KEYNOTE-001 (Garon 2015): pembrolizumab in non-small-cell lung cancer and the 50% PD-L1 cut-off",
    tldr: "The large early trial that showed pembrolizumab shrinks about a fifth of advanced lung cancers, with responses that last, and that identified a PD-L1 score of 50% or more as the group most likely to benefit.",
    ...
    journal: "New England Journal of Medicine", year: 2015, doi: "10.1056/NEJMoa1501824", authors: "Garon EB, Rizvi NA, Hui R, et al.", paperType: "translational",
    ...
    whatItMeans: "This trial gave lung cancer its immunotherapy biomarker. The 50% PD-L1 cut-off decides today whether a patient with advanced lung cancer can start immunotherapy alone or needs chemotherapy added, and the five-year follow-up later showed long-term survivors among first-line responders.",
    ...
    changedPractice: true, participants: 495,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1056/NEJMoa1501824" }, { label: "ClinicalTrials.gov NCT01295827", url: "https://clinicaltrials.gov/study/NCT01295827" }],
    cancers: ["nsclc"], drugs: ["pembrolizumab"], targets: ["pd1", "pdl1"], terms: ["tps", "pd-l1-testing", "orr"], companies: ["merck"], related: ["paper-keynote-024-nejm-2016", "paper-keynote-010-lancet-2016"] }),
  p({ id: "paper-keynote-010-lancet-2016", name: "KEYNOTE-010 (Herbst 2016): pembrolizumab versus docetaxel in previously treated PD-L1-positive lung cancer",
    tldr: "After chemotherapy had failed, pembrolizumab prolonged life compared with docetaxel in lung cancers expressing any PD-L1, with the largest gain in tumours where at least half the cells were positive, and caused fewer severe side effects.",
    ...
    journal: "The Lancet", year: 2016, doi: "10.1016/S0140-6736(15)01281-7", authors: "Herbst RS, Baas P, Kim DW, et al.", paperType: "rct",
    ...
    whatItMeans: "Alongside the CheckMate trials this study replaced docetaxel with PD-1 blockade as second-line treatment for most lung cancers, and its PD-L1 threshold of 1% became the basis of pembrolizumab's label in previously treated disease.",
    ...
    changedPractice: true, participants: 1034,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1016/S0140-6736(15)01281-7" }, { label: "ClinicalTrials.gov NCT01905657", url: "https://clinicaltrials.gov/study/NCT01905657" }],
    cancers: ["nsclc"], drugs: ["pembrolizumab", "docetaxel"], targets: ["pd1", "pdl1"], people: ["roy-herbst"], companies: ["merck"], terms: ["tps", "os"], related: ["paper-keynote-001-pembrolizumab-nsclc-nejm-2015", "paper-checkmate-057-nejm-2015"] }),
  p({ id: "paper-keynote-006-pembrolizumab-ipilimumab-melanoma-nejm-2015", name: "KEYNOTE-006 (Robert 2015): pembrolizumab versus ipilimumab in advanced melanoma",
    tldr: "Head to head, the PD-1 antibody pembrolizumab held melanoma back longer, prolonged life and caused fewer severe side effects than ipilimumab, the CTLA-4 antibody that had been the first immunotherapy to extend survival.",
    ...
    journal: "New England Journal of Medicine", year: 2015, doi: "10.1056/NEJMoa1503093", authors: "Robert C, Schachter J, Long GV, et al.", paperType: "rct",
    ...
    whatItMeans: "This trial settled which checkpoint to block first in melanoma and set the pattern for PD-1 antibodies displacing ipilimumab across cancers. Long-term follow-up later showed that many responders remained free of progression years after stopping treatment.",
    ...
    changedPractice: true, participants: 834,
    links: [{ label: "Full text (DOI)", url: "https://doi.org/10.1056/NEJMoa1503093" }, { label: "ClinicalTrials.gov NCT01866319", url: "https://clinicaltrials.gov/study/NCT01866319" }],
    cancers: ["melanoma"], drugs: ["pembrolizumab", "ipilimumab"], targets: ["pd1", "ctla4"], trials: ["keynote-006"], people: ["caroline-robert"], companies: ["merck"], terms: ["pfs", "os", "orr"], related: ["paper-hodi-ipilimumab-melanoma-nejm-2010"] }),
  p({ id: "paper-sauer-preoperative-chemoradiotherapy-rectal-nejm-2004", name: "Sauer 2004: chemoradiotherapy before rather than after surgery for rectal cancer (CAO/ARO/AIO-94)",
    tldr: "Giving chemotherapy and radiotherapy before surgery rather than after halved local recurrences of rectal cancer, caused less toxicity and let more patients keep their anal sphincter, without changing overall survival.",
    ...
    journal: "New England Journal of Medicine", year: 2004, doi: "10.1056/NEJMoa040694", authors: "Sauer R, Becker H, Hohenberger W, et al.", paperType: "rct",
    ...
    whatItMeans: "This trial made preoperative chemoradiotherapy the standard for locally advanced rectal cancer worldwide and is the foundation on which total neoadjuvant therapy and watch-and-wait organ preservation were later built.",
