...
export const papersSolidTumours: PaperInput[] = [
  ...
  p({ id: "paper-napoli-3-lancet-2023", name: "NAPOLI-3: NALIRIFOX versus gemcitabine plus nab-paclitaxel as first treatment for metastatic pancreatic cancer",
    tldr: "A four-drug chemotherapy combination built on liposomal irinotecan extended survival in metastatic pancreatic cancer by about two months compared with the most widely used doublet, the first positive first-line trial in a decade.",
