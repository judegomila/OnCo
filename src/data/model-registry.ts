...
export const models: ModelRecord[] = [
  ...
  { id: "alphagenome", modality: "DNA", trainingData: "Human and mouse reference genomes with thousands of functional genomics tracks; 1 megabase input at single-base resolution.", weights: "open", weightsUrl: "https://github.com/google-deepmind/alphagenome_research", licence: "API terms (non-commercial preview)", benchmark: "Matched or beat specialist models on 22 of 24 sequence prediction and 24 of 26 variant-effect tasks (DeepMind).", paper: "10.1038/s41586-025-09937-1", year: 2025 },
