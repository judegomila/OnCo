...
export const ORGAN_SCHEMATICS: OrganSchematic[] = [
  ...
  { id: "lung", name: "Lungs, pleura and mediastinum", cancers: ["mediastinal-germ-cell-tumour", "pleuropulmonary-blastoma-dicer1", "thymoma-type-a-ab", "thymoma-type-b1-b2", "thymoma-type-b3", "micronodular-thymoma", "lung-adenocarcinoma", "lung-squamous-cell-carcinoma", "large-cell-lung-carcinoma", "pulmonary-sarcomatoid-carcinoma", "lung-adenosquamous-carcinoma", "invasive-mucinous-adenocarcinoma-lung", "lung-adenocarcinoma-in-situ-and-minimally-invasive", "basaloid-squamous-cell-carcinoma-lung", "lymphoepithelial-carcinoma-lung", "pulmonary-blastoma", "nsclc", "lung-cancer", "sclc", "mesothelioma", "pleural-mesothelioma", "thymic-epithelial", "pleuropulmonary-blastoma", "inflammatory-myofibroblastic-tumour", "egfr-mutant-nsclc", "alk-positive-nsclc", "kras-g12c-nsclc", "ros1-positive-nsclc", "met-altered-nsclc", "ret-fusion-nsclc", "braf-v600e-nsclc", "her2-mutant-nsclc", "ntrk-fusion-nsclc", "pdl1-high-nsclc", "resectable-nsclc", "stage-iii-unresectable-nsclc", "limited-stage-sclc", "extensive-stage-sclc", "lung-net", "lung-lcnec", "thymoma", "thymic-carcinoma"],
  ...
  { id: "pancreas-biliary", name: "Pancreas and bile ducts", cancers: ["glucagonoma", "vipoma", "somatostatinoma","pancreatic", "cholangiocarcinoma", "intrahepatic-cholangiocarcinoma", "extrahepatic-cholangiocarcinoma", "biliary-tract-cancer", "neuroendocrine", "pancreatic-net", "grade-3-net", "extrapulmonary-nec", "gallbladder", "gallbladder-adenocarcinoma", "gallbladder-papillary-carcinoma", "gallbladder-mucinous-carcinoma", "gallbladder-adenosquamous-squamous-carcinoma", "gallbladder-neuroendocrine-carcinoma", "incidental-gallbladder-cancer", "gallbladder-carcinoma-in-situ-and-dysplasia", "cystic-duct-carcinoma", "ampullary", "resectable-pdac", "borderline-resectable-pdac", "locally-advanced-pdac", "metastatic-pdac", "kras-g12c-pdac", "kras-wild-type-pdac", "brca-palb2-pdac", "msi-high-pdac", "pancreatic-acinar-cell-carcinoma", "ipmn-cystic-precursors", "pancreatoblastoma", "pancreatic-adenosquamous-carcinoma", "pancreatic-colloid-carcinoma", "pancreatic-undifferentiated-carcinoma-ogc", "ipmn-associated-carcinoma", "mcn-associated-carcinoma", "solid-pseudopapillary-neoplasm"],
  ...
  { id: "kidney-bladder-adrenal", name: "Kidneys, adrenals, ureters and bladder", cancers: ["collecting-duct-carcinoma", "renal-medullary-carcinoma", "tfe3-rearranged-renal-cell-carcinoma", "fh-deficient-renal-cell-carcinoma", "sdh-deficient-renal-cell-carcinoma", "mucinous-tubular-spindle-cell-carcinoma", "eosinophilic-solid-cystic-renal-cell-carcinoma", "clear-cell-papillary-renal-cell-tumour", "urethral-urothelial-carcinoma", "urethral-squamous-cell-carcinoma", "urethral-adenocarcinoma", "urethral-melanoma","non-muscle-invasive-bladder-cancer", "muscle-invasive-bladder-cancer", "urothelial", "clear-cell-rcc", "papillary-rcc", "chromophobe-rcc", "rcc", "wilms-tumor", "neuroblastoma", "neuroblastoma-low-risk", "neuroblastoma-intermediate-risk", "neuroblastoma-high-risk", "adrenocortical", "pheochromocytoma-paraganglioma", "urethral", "penile", "localised-penile-cancer", "node-positive-penile-cancer", "localised-adrenocortical-carcinoma", "advanced-adrenocortical-carcinoma", "hereditary-ppgl", "metastatic-ppgl"],
  ...
  { id: "testis", name: "Testis and retroperitoneum", cancers: ["retroperitoneal-germ-cell-tumour", "leydig-cell-tumour", "sertoli-cell-tumour", "spermatocytic-tumour", "germ-cell-neoplasia-in-situ", "embryonal-carcinoma-testis", "yolk-sac-tumour-postpubertal", "testicular-choriocarcinoma","testicular", "seminoma", "non-seminoma", "paediatric-germ-cell-tumours"],
  ...
  { id: "eye", name: "Eye", cancers: ["conjunctival-melanoma", "optic-pathway-glioma","uveal-melanoma", "retinoblastoma"],
  ...
  { id: "brain", name: "Brain", cancers: ["lactotroph-pitnet", "somatotroph-pitnet", "corticotroph-pitnet", "gonadotroph-pitnet", "thyrotroph-pitnet", "pineal-parenchymal-tumours", "pineoblastoma", "papillary-tumour-pineal-region", "choroid-plexus-carcinoma","glioblastoma", "primary-cns-lymphoma", "medulloblastoma", "paediatric-low-grade-glioma", "dipg-dmg", "atrt", "ependymoma", "craniopharyngioma", "pituitary-tumours", "brain-tumours", "idh-mutant-astrocytoma", "oligodendroglioma", "paediatric-high-grade-glioma", "meningioma", "secondary-brain-tumours", "vestibular-schwannoma", "cns-germ-cell-tumours", "spinal-cord-tumours", "medulloblastoma-wnt", "medulloblastoma-shh", "medulloblastoma-group-3-4"],
  ...
  { id: "musculoskeletal", name: "Bone and soft tissue (limb cross-section)", cancers: ["adamantinoma", "dedifferentiated-chordoma", "poorly-differentiated-chordoma", "desmoplastic-small-round-cell-tumour","leiomyosarcoma", "liposarcoma", "synovial-sarcoma", "sarcoma", "osteosarcoma", "ewing-sarcoma", "rhabdomyosarcoma", "chordoma", "desmoid-tumour", "tenosynovial-giant-cell-tumour", "epithelioid-sarcoma", "vascular-tumours", "chondrosarcoma", "angiosarcoma", "undifferentiated-pleomorphic-sarcoma", "myxofibrosarcoma", "alveolar-soft-part-sarcoma", "pecoma", "epithelioid-haemangioendothelioma", "malignant-peripheral-nerve-sheath-tumour", "retroperitoneal-sarcoma", "extremity-soft-tissue-sarcoma"],
