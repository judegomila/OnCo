...
const trials: TrialInput[] = [
  t({ id: "firefly-1", technologies: ["kinase-inhibitors"], name: "FIREFLY-1", nct: "NCT04775485", phase: "2", status: "positive", yearReported: 2023, sponsor: "Day One Biopharmaceuticals", enrolled: 141,
  ...
  t({ id: "tadpole", technologies: ["kinase-inhibitors"], name: "TADPOLE (CDRB436G2201)", nct: "NCT02684058", phase: "2", status: "positive", yearReported: 2023, sponsor: "Novartis", enrolled: 110, enrolledBasis: "randomised",
    enrolledNote: "ClinicalTrials.gov lists 151 participants (actual) across the study's cohorts; the NEJM 2023 low-grade glioma analysis randomised 110 patients (73 dabrafenib plus trametinib, 37 chemotherapy).",
  ...
  t({ id: "aren0533", technologies: ["cytotoxic-chemotherapy"], name: "COG AREN0533", nct: "NCT00379340", phase: "3", status: "positive", yearReported: 2018, sponsor: "Children's Oncology Group", enrolled: 395,
  ...
  t({ id: "euramos-1", name: "EURAMOS-1", nct: "NCT00134030", phase: "3", status: "negative", yearReported: 2016, sponsor: "Children's Oncology Group, COSS, EOI and SSG (EURAMOS collaboration)", enrolled: 2260, enrolledBasis: "registered",
    enrolledNote: "ClinicalTrials.gov lists 1,334 participants (actual), the patients randomised (618 poor responders and 716 good responders); the Lancet Oncology 2016 paper reports 2,260 patients registered from 325 sites in 17 countries.",
  ...
  t({ id: "inter-b-nhl-ritux-2010", technologies: ["monoclonal-antibody"], name: "Inter-B-NHL Ritux 2010", nct: "NCT01516580", phase: "3", status: "positive", yearReported: 2020, sponsor: "Gustave Roussy (European Intergroup for Childhood NHL) and Children's Oncology Group", enrolled: 482,
  ...
  t({ id: "lch-iii", technologies: ["cytotoxic-chemotherapy"], name: "LCH-III", nct: "NCT00276757", phase: "3", status: "positive", yearReported: 2013, sponsor: "Histiocyte Society", enrolled: 376,
...
const terms: TermInput[] = [
  term({ id: "race-for-children-act", wikipediaChecked: "2026-09-22", name: "RACE for Children Act", aka: ["Research to Accelerate Cures and Equity for Children Act", "FDARA Title V section 504", "PREA molecular target amendment"], category: "regulatory",
