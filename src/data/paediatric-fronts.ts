...
const institutions: InstitutionInput[] = [
  b({ id: "accelerate-platform", name: "ACCELERATE", aka: ["ACCELERATE platform", "ACCELERATE Paediatric Oncology Platform"], institutionType: "consortium", city: "Brussels", country: "BE", lat: 50.850, lng: 4.352, website: "https://www.accelerate-platform.org",
    tldr: "A Brussels-based forum where children's cancer doctors, drug companies, regulators and parents agree how new cancer drugs should be tested in children, so that fewer promising medicines skip childhood cancers.",
    ...
    institutions: ["siop-europe", "itcc", "ema", "fda-oce"], terms: ["race-for-children-act"], cancers: ["neuroblastoma", "dipg-dmg", "paediatric-low-grade-glioma", "all-leukemia"], bottlenecks: ["b-rare-cancers", "b-incentive-misalignment", "b-regulatory-fragmentation"], tags: PAEDIATRIC_TAGS }),
  ...
  b({ id: "itcc", name: "Innovative Therapies for Children with Cancer (ITCC)", aka: ["ITCC", "ITCC consortium"], institutionType: "consortium", city: "Villejuif", country: "FR", lat: 48.794, lng: 2.349, website: "https://www.itcc-consortium.org",
    ...
    institutions: ["gustave-roussy", "siop-europe", "accelerate-platform", "princess-maxima", "great-ormond-street"], trials: ["pediatric-match"], technologies: ["pdx-models", "cgp"], cancers: ["neuroblastoma", "dipg-dmg", "paediatric-low-grade-glioma", "rhabdomyosarcoma"], bottlenecks: ["b-rare-cancers", "b-trial-enrolment"], tags: PAEDIATRIC_TAGS }),
  ...
  b({ id: "histiocyte-society", name: "Histiocyte Society", institutionType: "consortium", city: "Pitman", country: "US", lat: 39.733, lng: -75.132, website: "https://histiocytesociety.org",
    ...
    trials: ["lch-iii"], cancers: ["langerhans-cell-histiocytosis", "histiocytoses"], drugs: ["vinblastine"], bottlenecks: ["b-rare-cancers"], tags: PAEDIATRIC_TAGS }),
];
