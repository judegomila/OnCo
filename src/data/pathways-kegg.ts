...
export const pathwaysKegg: PathwayInput[] = [
  ...
  p({
    ...
    tldr: "This KEGG map shows the two genetic roads to glioblastoma: primary tumours amplify EGFR and lose PTEN and p16, secondary tumours from lower-grade astrocytomas over-express PDGF and CDK4 and lose TP53 and RB. It matters because it explains why growth-factor and cell-cycle drugs are the main targeted options in brain tumours, and why paediatric low-grade gliomas with BRAF changes respond to MAPK inhibitors.",
