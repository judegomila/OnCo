...
export const linkers: Linker[] = [
  ...
  { id: "hydrazone", wikipedia: "https://en.wikipedia.org/wiki/Hydrazone", name: "Acid-labile hydrazone (AcBut)", type: "cleavable", trigger: "Low pH in endosomes/lysosomes; also slowly in plasma", releases: "Calicheamicin", adcs: ["gemtuzumab-ozogamicin"], note: "Plasma instability contributed to Mylotarg's first-generation toxicity." },
