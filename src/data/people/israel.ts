...
export const peopleIsrael: PersonInput[] = [
  ...
  p({ id: "yosef-yarden", name: "Yosef Yarden", role: "Professor, Department of Immunology and Regenerative Biology, Weizmann Institute of Science", institutionId: "weizmann", institutions: ["weizmann"],
    ...
    summary: "Yosef Yarden's laboratory at the Weizmann Institute has spent four decades on the ErbB/HER receptor family: how EGFR and HER2 dimerise and signal, how the cell shuts them down, and how tumours escape drugs aimed at them. His group's work on combining monoclonal antibodies against distinct epitopes of the same receptor is part of the intellectual lineage behind pairing trastuzumab with pertuzumab, and his recent reviews trace how resistance to EGFR inhibitors in lung cancer emerges and how it might be pre-empted. He also publishes on endocrine resistance in breast cancer and on androgen-receptor resistance in prostate cancer.",
  ...
  p({ id: "moshe-oren", name: "Moshe Oren", role: "Professor, Department of Molecular Cell Biology, Weizmann Institute of Science", institutionId: "weizmann", institutions: ["weizmann"],
    ...
    tldr: "One of the small group of scientists who cloned p53 and then spent a career on what it does, including the discovery that mutant p53 is not merely broken but actively harmful.",
    summary: "Moshe Oren cloned the p53 gene at the start of the 1980s and his laboratory at the Weizmann Institute has worked on it ever since, with Varda Rotter's group alongside. The work established that p53 is a tumour suppressor rather than an oncogene, that the mutant forms found in half of human cancers acquire new activities of their own rather than simply losing the old ones, and more recently that p53 restrains stemness by controlling histone modifiers. That gain-of-function idea is the reason mutant-p53 reactivators and selective degraders are a drug class at all, and the reason TP53 status carries prognostic weight across the corpus.",
    ...
    papers: [
      ...
      { title: "Multi-parametric atlas of the pre-metastatic liver for prediction of metastatic outcome", year: 2024, note: "Department of Molecular Cell Biology, Weizmann Institute of Science; indexed on Europe PMC" },
    ],
