...
export const peopleLeadersWave3: PersonInput[] = [
  ...
  // =================== Cedars-Sinai Cancer ===================
  p({ id: "robert-figlin", name: "Robert Figlin", role: "Interim Director of Cedars-Sinai Cancer", institutionId: "cedars-sinai-cancer", specialisms: ["Medical oncology", "Cancer centre leadership", "Translational research"],
    tldr: "Medical oncologist who has led Cedars-Sinai Cancer in Los Angeles as Interim Director since March 2025.",
    summary: "Robert Figlin, MD, is Interim Director of Cedars-Sinai Cancer, the cancer programme of Cedars-Sinai in Los Angeles. He was Deputy Director of the cancer centre and took over as Interim Director on 28 February 2025 when Dan Theodorescu stepped down, with Cristina Ferrone as Interim Co-Director for Cancer Clinical Services and Ze'ev Ronai as Interim Cancer Scientific Director. In a March 2026 Becker's Healthcare podcast he was still described as Interim Director, speaking on expanding access to cancer care and bridging discovery with clinical practice.",
    profiles: [{ label: "Institution newsroom (March 2026)", url: "https://www.cedars-sinai.org/newsroom/beckers-healthcare-podcast-expanding-access-translational-research-and-the-future-of-cancer-care/" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Figlin+RA%5BAuthor%5D" }],
    links: [{ label: "Source: Cedars-Sinai newsroom, director stepping down (Feb 2025)", url: "https://www.cedars-sinai.org/newsroom/cedars-sinai-cancer-director-stepping-down/" }],
    tags: ["leadership", "clinician-scientist", "cancer-centre"], cancers: [] }),
  // =================== Centre Antoine Lacassagne ===================
  p({ id: "emmanuel-barranger", name: "Emmanuel Barranger", role: "Directeur Général of the Centre Antoine Lacassagne", institutionId: "centre-antoine-lacassagne", specialisms: ["Cancer centre leadership", "Comprehensive cancer care", "Hospital governance"],
    tldr: "Professor who runs the Centre Antoine Lacassagne, the regional cancer centre in Nice, as its Directeur Général.",
    summary: "Professor Emmanuel Barranger is Directeur Général of the Centre Antoine Lacassagne in Nice, one of the French Centres de Lutte Contre le Cancer created by the ordinance of 1 October 1945 and part of the Unicancer network. The centre's organisation page states he was appointed for five years by ministerial decree of the Minister of Health. He leads the establishment together with Deputy Director General Guillaume Girard, alongside a medical conference chaired by Professor Alexandre Bozec.",
    profiles: [{ label: "Institution organisation page", url: "https://www.centreantoinelacassagne.org/organisation-du-centre/" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Barranger+E%5BAuthor%5D" }],
    links: [{ label: "Source: Centre Antoine Lacassagne organisation page", url: "https://www.centreantoinelacassagne.org/organisation-du-centre/" }],
    tags: ["leadership", "clinician-scientist", "cancer-centre"], cancers: [] }),
  // =================== Centre hospitalier de l'Université de Montréal (CHUM) ===================
  p({ id: "marie-eve-desrosiers", name: "Marie-Eve Desrosiers", role: "Présidente-directrice générale of the CHUM", institutionId: "chum", specialisms: ["Hospital leadership", "Health system management", "Academic medicine"],
    tldr: "President and chief executive of the CHUM, the University of Montreal's teaching hospital and one of Canada's largest academic health centres.",
    summary: "Marie-Eve Desrosiers is Présidente-directrice générale of the Centre hospitalier de l'Université de Montréal (CHUM), a university teaching hospital in Montreal. The CHUM's executive organisation chart dated July 2026 names her in the role at the head of the hospital's management committee. The French Wikipedia article on the CHUM also records her as the new president and chief executive.",
    profiles: [{ label: "Institution leadership page", url: "https://www.chumontreal.qc.ca/propos-chum/leadership-organisationnel" }],
    links: [{ label: "Source: CHUM executive organisation chart (July 2026, PDF)", url: "https://www.chumontreal.qc.ca/sites/default/files/2026-07/Organigramme%20exe%CC%81cutif.pdf" }],
    tags: ["leadership", "hospital"], cancers: [] }),
  // =================== Children's Cancer and Leukaemia Group ===================
  p({ id: "ashley-ball-gamble", name: "Ashley Ball-Gamble", role: "Chief Executive Officer of the Children's Cancer and Leukaemia Group", institutionId: "cclg", specialisms: ["Childhood cancer", "Charity leadership", "Professional membership organisations"],
    tldr: "Chief executive of CCLG, the UK charity and professional body that unites the children's and young people's cancer community.",
    summary: "Ashley Ball-Gamble is Chief Executive Officer of the Children's Cancer and Leukaemia Group (CCLG), a registered charity founded nearly 50 years ago that brings together professionals working in children's and young people's cancer to drive collective action and research. The executive team also includes Claire Shinfield (Director of Engagement) and Chief Nurses Jeanette Hawkins and Jo Stark. The charity's Chair is Dr Sara Stoneham, a consultant paediatric and teenage and young adult oncologist at University College London Hospital, and David Oxnam chairs the Board of Trustees.",
    profiles: [{ label: "Institution executive members page", url: "https://www.cclg.org.uk/about-us/our-team/our-executive-members" }],
    links: [{ label: "Source: CCLG executive members page", url: "https://www.cclg.org.uk/about-us/our-team/our-executive-members" }],
    tags: ["leadership", "paediatric-oncology", "charity"], cancers: [] }),
  // =================== Chris O'Brien Lifehouse ===================
  p({ id: "michael-boyer", name: "Michael Boyer", role: "Chief Executive Officer of Chris O'Brien Lifehouse", institutionId: "chris-obrien-lifehouse", specialisms: ["Medical oncology", "Thoracic cancers", "Head and neck cancer", "Clinical trials"],
    tldr: "Thoracic medical oncologist who has been chief executive of Chris O'Brien Lifehouse, Sydney's not-for-profit cancer hospital, since 2023.",
    summary: "Professor Michael Boyer AM is Chief Executive Officer of Chris O'Brien Lifehouse, a not-for-profit comprehensive cancer hospital in Sydney, and Conjoint Chair of Medical Oncology (Thoracic Oncology). A medical oncologist for more than 20 years specialising in thoracic and head and neck cancers, he was appointed Chief Clinical Officer at Lifehouse in 2011 and Chief Executive Officer in 2023, and also sits on its Board of Directors. He was previously director of the Sydney Cancer Centre and area director of Cancer Services for the Sydney South West Area Health Service.",
    profiles: [{ label: "Institution profile", url: "https://www.mylifehouse.org.au/team/michael-boyer/" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Boyer+MJ%5BAuthor%5D+lung" }],
    links: [{ label: "Source: Lifehouse our people page", url: "https://www.mylifehouse.org.au/about-us/our-people/" }],
    tags: ["leadership", "clinician-scientist", "thoracic-oncology"], cancers: ["nsclc", "sclc", "head-and-neck", "mesothelioma"] }),
  // =================== Chulabhorn Hospital / Chulabhorn Royal Academy ===================
  p({ id: "princess-chulabhorn", name: "Princess Chulabhorn", role: "President of the Chulabhorn Royal Academy Council and Acting Secretary-General", institutionId: "chulabhorn-hospital", specialisms: ["Organic chemistry", "Scientific research leadership", "Cancer care institutions"],
    tldr: "Thai princess and professor of organic chemistry who founded and presides over the Chulabhorn Royal Academy, the parent body of Chulabhorn Hospital in Bangkok.",
    summary: "Princess Chulabhorn (Chulabhorn, Princess Srisavangavadhana) leads the Chulabhorn Royal Academy, the Thai royal academy whose departments include Chulabhorn Hospital in Bangkok. The Thai Wikipedia article on the Academy lists her as President of the Academy Council and Acting Secretary-General; the English article records that she is president of the Chulabhorn Research Institute and a Professor of Organic Chemistry at Mahidol University, having received her doctorate in chemistry in 1985 and the UNESCO Einstein Medal in 1986. The hospital's own website does not name a hospital director.",
    profiles: [{ label: "Wikipedia", url: "https://en.wikipedia.org/wiki/Princess_Chulabhorn" }],
    links: [{ label: "Source: Thai Wikipedia article on the Chulabhorn Royal Academy", url: "https://th.wikipedia.org/wiki/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A7%E0%B8%B4%E0%B8%97%E0%B8%A2%E0%B8%B2%E0%B8%A5%E0%B8%B1%E0%B8%A2%E0%B8%88%E0%B8%B8%E0%B8%AC%E0%B8%B2%E0%B8%A0%E0%B8%A3%E0%B8%93%E0%B9%8C" }],
    tags: ["leadership", "clinician-scientist", "thailand"], cancers: [] }),
  // =================== City of Hope Orange County ===================
  p({ id: "annette-walker", name: "Annette Walker", role: "President of City of Hope Orange County", institutionId: "city-of-hope-orange-county", specialisms: ["Health system leadership", "Cancer campus development", "Healthcare strategy"],
    tldr: "Health system executive who leads City of Hope Orange County and oversaw the opening of Orange County's first cancer specialty hospital in Irvine.",
    summary: "Annette Walker is President of City of Hope Orange County, the Orange County arm of the City of Hope cancer research and treatment organisation. She led development of its comprehensive cancer campus and regional network in Irvine, a project of about one billion dollars whose cancer specialty hospital opened in December 2025. She was previously president of strategy at Providence St. Joseph Health, where she helped merge two large health organisations.",
    profiles: [{ label: "Orange County Business Journal OC500 2025 profile", url: "https://www.ocbj.com/oc-500/2025/oc500-2025-annette-walker/" }],
    links: [{ label: "Source: Orange County Business Journal OC500 profile (Nov 2025)", url: "https://www.ocbj.com/oc-500/2025/oc500-2025-annette-walker/" }],
    tags: ["leadership", "hospital", "cancer-centre"], cancers: [] }),
  // =================== Comisión Federal para la Protección contra Riesgos Sanitarios ===================
  p({ id: "victor-hugo-borja-aburto", name: "Víctor Hugo Borja Aburto", role: "Comisionado Federal para la Protección contra Riesgos Sanitarios (2026-)", institutionId: "cofepris", specialisms: ["Epidemiology", "Public health", "Health regulation", "Environmental health"],
    tldr: "Epidemiologist who heads COFEPRIS, Mexico's federal regulator for medicines, medical devices and other health risks.",
    summary: "Dr Víctor Hugo Borja Aburto is Comisionado Federal of the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS), Mexico's health regulatory agency; Spanish Wikipedia lists his term as beginning in 2026. He trained in medicine at the Universidad Autónoma Metropolitana-Xochimilco, holds master's degrees in public health and epidemiological sciences from the Instituto Nacional de Salud Pública and a doctorate in epidemiology from the University of North Carolina at Chapel Hill. His earlier career included directing the Centro Nacional de Salud Ambiental, research at CINVESTAV-IPN and leadership roles in epidemiological surveillance and primary care at IMSS.",
    profiles: [{ label: "Institution profile", url: "https://www.gob.mx/cofepris/estructuras/dr-victor-hugo-borja-aburto" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Borja-Aburto+VH%5BAuthor%5D" }],
    links: [{ label: "Source: COFEPRIS commissioner profile", url: "https://www.gob.mx/cofepris/estructuras/dr-victor-hugo-borja-aburto" }],
    tags: ["leadership", "clinician-scientist", "regulator"], cancers: [] }),
  // =================== Comprehensive Cancer Center Freiburg (CCCF) ===================
  p({ id: "elisabeth-schorb", name: "Elisabeth Schorb", role: "Director and Spokesperson of the Tumorzentrum Freiburg - CCCF", institutionId: "ccc-freiburg", specialisms: ["Haematology and oncology", "Clinical trials", "Cancer centre leadership"],
    tldr: "Internal medicine oncologist who directs the Comprehensive Cancer Center Freiburg and heads its clinical trials unit.",
    summary: "PD Dr Elisabeth Schorb is Direktorin und Sprecherin of the Tumorzentrum Freiburg - CCCF, the certified oncology centre of excellence of the University Medical Center Freiburg. She is a senior physician in the Department of Internal Medicine I and heads its clinical trials centre and early clinical trials unit. The CCCF executive board she leads includes Justus Duyster (medical oncology), Stefan Fichtner-Feigl (surgical oncology), Melanie Börries (data-driven medicine), Michael Quante (prevention and patient participation) and Andreas Rimner (scientific director since 2025).",
    profiles: [{ label: "Institution leadership page", url: "https://www.uniklinik-freiburg.de/cccf/ueber-uns/leitung.html" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Schorb+E%5BAuthor%5D" }],
    links: [{ label: "Source: CCCF leadership page", url: "https://www.uniklinik-freiburg.de/cccf/ueber-uns/leitung.html" }],
    tags: ["leadership", "clinician-scientist", "cancer-centre"], cancers: [] }),
  // =================== Comprehensive Cancer Center Mainfranken, University Hospital Würzburg ===================
  p({ id: "ralf-c-bargou", name: "Ralf C. Bargou", role: "Director of the Comprehensive Cancer Center Mainfranken", institutionId: "ccc-wuerzburg", specialisms: ["Translational oncology", "Haematology and oncology", "Cancer centre leadership"],
    tldr: "Professor of translational oncology who directs the Comprehensive Cancer Center Mainfranken at University Hospital Würzburg.",
    summary: "Professor Ralf C. Bargou is Direktor of the Comprehensive Cancer Center Mainfranken (CCC MF), the oncology centre of excellence of University Hospital Würzburg and the University of Würzburg, and holds the Chair of Translational Oncology. He also serves as Sprecher of the hospital's Onkologisches Zentrum. The CCC MF board includes Deputy Director Christoph-Thomas Germer and Managing Director Jutta Riese.",
    profiles: [{ label: "Institution board page", url: "https://www.med.uni-wuerzburg.de/ccc/ueber-uns/vorstand/" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Bargou+RC%5BAuthor%5D" }],
    links: [{ label: "Source: CCC Mainfranken Vorstand page", url: "https://www.med.uni-wuerzburg.de/ccc/ueber-uns/vorstand/" }],
    tags: ["leadership", "clinician-scientist", "cancer-centre"], cancers: ["multiple-myeloma"] }),
  // =================== Damon Runyon Cancer Research Foundation ===================
  p({ id: "yung-s-lie", name: "Yung S. Lie", role: "President and Chief Executive Officer of the Damon Runyon Cancer Research Foundation", institutionId: "damon-runyon", specialisms: ["Research funding", "Early-career scientist support", "Cancer research strategy"],
    tldr: "Scientist who leads the Damon Runyon Cancer Research Foundation, a US funder of high-risk, high-reward research by young cancer investigators.",
    summary: "Yung S. Lie, PhD, is President and Chief Executive Officer of the Damon Runyon Cancer Research Foundation in New York. The foundation funds young investigators pursuing high-risk, high-reward research across all cancer types, selecting them through panels of distinguished scientists. She is listed at the head of the foundation's leadership and staff pages.",
    profiles: [{ label: "Institution leadership page", url: "https://www.damonrunyon.org/our-strategy/our-leadership" }],
    links: [{ label: "Source: Damon Runyon leadership page", url: "https://www.damonrunyon.org/our-strategy/our-leadership" }],
    tags: ["leadership", "funder"], cancers: [] }),
  // =================== Deutsche Krebshilfe ===================
  p({ id: "rita-schmutzler", name: "Rita Schmutzler", role: "Präsidentin of the Stiftung Deutsche Krebshilfe (2026-)", institutionId: "deutsche-krebshilfe", specialisms: ["Hereditary breast and ovarian cancer", "Gynaecological oncology", "Cancer prevention", "Cancer genetics"],
    tldr: "Gynaecological oncologist and hereditary cancer expert who became President of Deutsche Krebshilfe, Germany's largest cancer charity, in 2026.",
    summary: "Professor Rita Schmutzler is Präsidentin of the Stiftung Deutsche Krebshilfe, the German cancer aid foundation founded in 1974 by Mildred Scheel; German Wikipedia records that she took up the presidency in February 2026, succeeding Anne-Sophie Mutter. A gynaecologist specialising in hereditary breast and ovarian cancer, she directed the Center for Familial Breast and Ovarian Cancer and the National Center for Familial Tumor Diseases at Cologne University Hospital from 2012 until her emeritus status in 2025. The foundation's executive board (Vorstand) comprises Gerd Nettekoven, Lutz M. Heitmüller and Franz Kohlhuber, with Charlotte Niemeyer chairing the Stiftungsrat.",
    profiles: [{ label: "Institution organisation page", url: "https://www.krebshilfe.de/informieren/ueber-uns/organisation/" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Schmutzler+RK%5BAuthor%5D" }],
    links: [{ label: "Source: Deutsche Krebshilfe organisation page", url: "https://www.krebshilfe.de/informieren/ueber-uns/organisation/" }],
    tags: ["leadership", "clinician-scientist", "charity", "hereditary-cancer"], cancers: ["breast-hr-positive", "tnbc", "ovarian"] }),
  // =================== Dharmais National Cancer Center ===================
  p({ id: "eniarti", name: "Eniarti", role: "Direktur Utama of RS Kanker Dharmais", institutionId: "dharmais-cancer-hospital", specialisms: ["Hospital leadership", "Psychiatry", "Cancer service development"],
    tldr: "Physician who leads Dharmais Cancer Hospital in Jakarta, Indonesia's national cancer centre, as its president director.",
    summary: "Dr Eniarti, M.Sc., Sp.KJ., M.M.R., QHIA, is Direktur Utama of Rumah Sakit Kanker Dharmais, the national cancer centre in Jakarta. In June 2026 she announced a collaboration with AstraZeneca Indonesia to introduce next-generation sequencing for precision diagnostics, describing it as part of the hospital's effort to strengthen cancer care capacity. Her credentials indicate specialist training in psychiatry and hospital management.",
    profiles: [{ label: "Antara news report (June 2026)", url: "https://www.antaranews.com/berita/5594340/rs-kanker-dharmais-terapkan-ngs-untuk-dukung-diagnostik-presisi" }],
    links: [{ label: "Source: Antara news report quoting the Direktur Utama (June 2026)", url: "https://www.antaranews.com/berita/5594340/rs-kanker-dharmais-terapkan-ngs-untuk-dukung-diagnostik-presisi" }],
    tags: ["leadership", "hospital", "indonesia"], cancers: [] }),
];
