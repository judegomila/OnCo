...
const raw: EntityInput[] = [
  {
    id: "ascent-05", technologies: ["adc", "topoisomerase-inhibitors"], kind: "trial", name: "ASCENT-05 / OptimICE-RD (AFT-65, GBG 119, NSABP B-63)", nct: "NCT05633654", phase: "3", status: "active", asOf, sponsor: "Gilead / Alliance Foundation Trials",
  ...
  {
    id: "tropion-breast03", technologies: ["adc", "topoisomerase-inhibitors"], kind: "trial", name: "TROPION-Breast03", nct: "NCT05629585", phase: "3", status: "active", asOf, sponsor: "AstraZeneca / Daiichi Sankyo",
