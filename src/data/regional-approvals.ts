...
export const regionalApprovals: Record<string, RegionalRow> = {
  ...
  ensartinib: { US: A(2024, undefined, "Ensacove"), EU: UR("Gevalka (applicant SFL Pharmaceuticals Deutschland): CHMP positive opinion 17 Sep 2026 for ALK-positive advanced NSCLC, ALK-inhibitor-naive or after crizotinib; European Commission decision pending. EMA register: 'Opinion: EMA has issued an opinion on this medicine'; checked 2026-09-24", epar("gevalka")), CN: A(2020, NMPA, "Betta; ALK+ NSCLC after crizotinib (Nov 2020)") },
  ...
  // PR 74 residue decided by hand on 2026-09-24 (docs/proposals/latest.md rows a person had to read): register pages re-read, status lines quoted.
  olaratumab: { US: W(2019, undefined, "Lartruvo: FDA accelerated approval Oct 2016 with doxorubicin for soft tissue sarcoma; withdrawn 2019 after the ANNOUNCE trial (record's own sourced approval)"), EU: W(2019, epar("lartruvo"), "Lartruvo (Eli Lilly): conditional marketing authorisation 9 Nov 2016 with doxorubicin for advanced soft tissue sarcoma; revoked by the European Commission 22 Jul 2019. EMA register: 'Revoked: This medicine's authorisation has been revoked'; checked 2026-09-24") },
  pixantrone: { EU: W(2024, epar("pixuvri"), "Pixuvri (Servier): conditional marketing authorisation 10 May 2012 for multiply relapsed or refractory aggressive B-cell non-Hodgkin lymphoma; the authorisation expired 12 Jun 2024 after the holder did not apply for renewal, citing lack of demand. EMA register: 'Expired: This medicine's authorisation has expired'; checked 2026-09-24") },
  alitretinoin: { US: A(1999, "https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=020886", "Cutaneous lesions of AIDS-related Kaposi sarcoma (Panretin gel); Feb 1999"), EU: W(2021, epar("panretin"), "Panretin (Amdipharm): authorised 11 Oct 2000 for cutaneous lesions of AIDS-related Kaposi sarcoma; marketing authorisation withdrawn 1 Jan 2021 at the holder's request for commercial reasons. EMA register: 'Withdrawn: This medicine's authorisation has been withdrawn'; checked 2026-09-24") },
  cediranib: { EU: W(undefined, epar("zemfirza"), "Zemfirza (AstraZeneca AB): marketing authorisation application for relapsed ovarian cancer withdrawn 19 Sep 2016 before a Commission decision. EMA register: 'Application withdrawn: The application for this medicine has been withdrawn'; checked 2026-09-24") },
  imp4927: { EU: UR("Sepalna (senaparib; applicant SFL Pharmaceuticals Deutschland): CHMP positive opinion 17 Sep 2026 as maintenance monotherapy for advanced high-grade epithelial ovarian, fallopian tube or primary peritoneal cancer in response after first-line platinum chemotherapy; European Commission decision pending. EMA register: 'Opinion: EMA has issued an opinion on this medicine'; checked 2026-09-24", epar("sepalna")) },
};
