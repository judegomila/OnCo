...
export const resistance: ResistanceClass[] = [
  {
    ...
    mechanisms: [
      { name: "On-target EGFR C797S", category: "on-target", how: "Mutation of the cysteine that osimertinib binds covalently; abolishes drug binding while EGFR stays active.", frequency: "~7–15% after first-line osimertinib", refs: ["egfr"],
      ...
      { name: "MET amplification / bypass", category: "bypass", how: "Amplified MET signals to PI3K/MAPK independently of EGFR.", frequency: "~15–20%", refs: ["met"],
      ...
      { name: "Histologic transformation", category: "lineage", how: "Conversion to small-cell lung cancer (RB1/TP53 co-loss) or squamous histology; EGFR mutation persists but the cell no longer depends on it.", frequency: "~5–15%", refs: ["sclc", "tp53"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "ESR1 ligand-binding-domain mutations", category: "on-target", how: "Y537S/D538G render ER constitutively active; arise under aromatase-inhibitor pressure, detectable in ctDNA.", frequency: "~30–40% after AI progression", refs: ["estrogen-receptor", "liquid-biopsy"],
      ...
      { name: "RB1 loss", category: "bypass", how: "Without RB, CDK4/6 inhibition cannot arrest the cell cycle.", frequency: "~5–10% acquired", refs: ["p53-cell-cycle"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "BRCA1/2 reversion mutations", category: "bypass", how: "Secondary mutations restore the open reading frame and homologous recombination; also confers platinum resistance.", frequency: "~20–40% of PARPi-resistant ovarian cancer", refs: ["brca", "ddr"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "BCMA antigen loss (biallelic TNFRSF17 deletion, extracellular mutations)", category: "antigen", how: "Deletion or mutation removes or alters the epitope; more common after bispecifics than CAR-T.", frequency: "~10–30% after bispecifics", refs: ["bcma"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "CD19-negative relapse", category: "antigen", how: "Alternative splicing, mutation, or lineage switch (to myeloid) removes the CD19 epitope.", frequency: "~30–50% of relapses in ALL, less in lymphoma", refs: ["cd19"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "AR amplification and ligand-binding-domain mutations", category: "on-target", how: "More receptor, or mutations (F877L, T878A) that turn antagonists into agonists.", frequency: "AR amplification ~30–50% of CRPC", refs: ["androgen-receptor", "ar-signaling"],
      ...
      { name: "Lineage plasticity to neuroendocrine prostate cancer", category: "lineage", how: "RB1/TP53 loss enables transdifferentiation; AR-indifferent, DLL3-positive, PSMA-negative.", frequency: "~15–20% of CRPC", refs: ["dll3", "tp53"],
