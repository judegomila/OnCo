...
export type Mechanism = { name: string; how: string; frequency?: string; countermeasures: Countermeasure[]; refs: string[] };
...
export const resistance: ResistanceClass[] = [
  {
    ...
    mechanisms: [
      { name: "On-target EGFR C797S", how: "Mutation of the cysteine that osimertinib binds covalently; abolishes drug binding while EGFR stays active.", frequency: "~7–15% after first-line osimertinib", refs: ["egfr"],
      ...
      { name: "MET amplification / bypass", how: "Amplified MET signals to PI3K/MAPK independently of EGFR.", frequency: "~15–20%", refs: ["met"],
      ...
      { name: "Histologic transformation", how: "Conversion to small-cell lung cancer (RB1/TP53 co-loss) or squamous histology; EGFR mutation persists but the cell no longer depends on it.", frequency: "~5–15%", refs: ["sclc", "tp53"],
        countermeasures: [{ text: "Re-biopsy at progression; platinum-etoposide for SCLC transformation", refs: ["cytotoxic-chemotherapy"] }] },
      { name: "Adding chemotherapy up front", how: "Pre-empts heterogeneous resistance by killing minor clones early.", refs: ["flaura2"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "Solvent-front G1202R and compound mutations", how: "Steric clash blocks first- and second-generation inhibitors; compound mutations (G1202R + L1196M etc.) emerge after lorlatinib.", frequency: "G1202R in ~40% after second-generation TKIs", refs: ["alk"],
      ...
      { name: "Bypass signalling (MET, EGFR, KRAS)", how: "Alternative receptors or downstream mutations re-activate MAPK/PI3K.", refs: ["met", "kras"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "Payload resistance: TOP1 mutation or loss", how: "TOP1 mutations (e.g., E418K) or reduced expression prevent trapping of the cleavage complex.", refs: ["topoisomerase-inhibitors", "adc-sequencing"],
      ...
      { name: "SLFN11 loss", how: "Schlafen-11 is required for replication-stress-induced death; its epigenetic silencing confers resistance to TOP1 (and platinum) agents.", refs: ["topoisomerase-inhibitors"],
      ...
      { name: "Efflux pump upregulation (ABCG2, ABCB1)", how: "SN-38 is an ABCG2 substrate; DXd and MMAE are ABCB1 substrates; mesenchymal states upregulate both.", refs: ["efflux-pump", "emt"],
      ...
      { name: "Antigen loss or downregulation", how: "Reduced HER2 or TROP2 surface expression after treatment; less frequent than payload resistance for HER2-low disease.", refs: ["her2", "trop2"],
      ...
      { name: "Impaired internalisation / lysosomal processing", how: "Defective endocytosis or lysosomal cathepsin activity limits payload release.", refs: ["adc", "linker"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "Loss of antigen presentation (B2M, HLA, JAK1/2)", how: "Mutations in B2M or HLA class I stop tumour cells displaying antigen; JAK1/2 loss removes interferon responsiveness (and PD-L1 induction).", frequency: "Acquired resistance in melanoma: ~25% JAK/B2M", refs: ["pd1-checkpoint"],
      ...
      { name: "Immune-desert / excluded tumours", how: "No pre-existing T-cell infiltrate (cold tumour) or T cells held at the margin by TGF-β and stroma.", refs: ["cold-vs-hot", "fap"],
      ...
      { name: "Alternative checkpoints (LAG-3, TIM-3, TIGIT)", how: "Exhausted T cells co-express other inhibitory receptors.", refs: ["lag3", "tigit"],
      ...
      { name: "Immunosuppressive myeloid cells and VEGF", how: "MDSCs, M2 macrophages, and VEGF suppress T-cell function and dendritic-cell maturation.", refs: ["vegf"],
        countermeasures: [{ text: "PD-1 + VEGF blockade; PD-1×VEGF bispecifics", refs: ["io-plus-vegf", "ivonescimab"] }] },
      { name: "Loss of neoantigens / low TMB", how: "Immunoediting removes the clones that carried immunogenic mutations.", refs: ["neoantigen", "tmb"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "ESR1 ligand-binding-domain mutations", how: "Y537S/D538G render ER constitutively active; arise under aromatase-inhibitor pressure, detectable in ctDNA.", frequency: "~30–40% after AI progression", refs: ["estrogen-receptor", "liquid-biopsy"],
      ...
      { name: "RB1 loss", how: "Without RB, CDK4/6 inhibition cannot arrest the cell cycle.", frequency: "~5–10% acquired", refs: ["p53-cell-cycle"],
      ...
      { name: "Cyclin E / CDK2 activation", how: "CCNE1 amplification or CDK2 activity bypasses the G1 block.", refs: ["cdk4-6"],
        countermeasures: [{ text: "CDK2 inhibitors (AVZO-021 and others) and CDK4-selective inhibitors in trials", refs: ["avenzo"] }] },
      { name: "PI3K/AKT/mTOR activation", how: "PIK3CA mutation, PTEN loss, or AKT1 E17K sustain growth independent of ER.", frequency: "PIK3CA ~40% of HR+ disease", refs: ["pi3k-akt-mtor", "pik3ca", "akt"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "BRCA1/2 reversion mutations", how: "Secondary mutations restore the open reading frame and homologous recombination; also confers platinum resistance.", frequency: "~20–40% of PARPi-resistant ovarian cancer", refs: ["brca", "ddr"],
      ...
      { name: "Restoration of HR via 53BP1/Shieldin loss", how: "Loss of end-protection factors lets BRCA1-deficient cells resect DNA ends and repair by HR.", refs: ["ddr"],
        countermeasures: [{ text: "ATR inhibitors; POLQ inhibitors (trials)", refs: ["atr", "synthetic-lethality-approaches"] }] },
      { name: "Replication fork protection and PARP1 loss", how: "Stabilised forks tolerate PARP trapping; PARP1 mutations abolish trapping.", refs: ["parp"],
        countermeasures: [{ text: "PARP1-selective saruparib for a wider window; PARP PET to confirm target", refs: ["parp-pet"] }] },
      { name: "Drug efflux (ABCB1)", how: "Olaparib and rucaparib are P-gp substrates.", refs: ["efflux-pump"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "Adaptive RTK feedback (EGFR, others)", how: "Relief of ERK-mediated negative feedback re-activates receptors within hours, producing new wild-type KRAS-GTP the drug cannot bind.", frequency: "Universal, especially in colorectal cancer", refs: ["ras-mapk", "egfr"],
      ...
      { name: "Secondary KRAS mutations (Y96D, R68S, H95) and amplification", how: "Alter the switch-II pocket or overwhelm the drug.", refs: ["kras"],
        countermeasures: [{ text: "Pan-RAS(ON) tri-complex inhibitors (daraxonrasib) bind a different site", refs: ["daraxonrasib"] }] },
      { name: "Bypass alterations (MET amplification, NRAS/BRAF mutations, RTK fusions)", how: "Alternative MAPK activation.", refs: ["met", "braf"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "BCMA antigen loss (biallelic TNFRSF17 deletion, extracellular mutations)", how: "Deletion or mutation removes or alters the epitope; more common after bispecifics than CAR-T.", frequency: "~10–30% after bispecifics", refs: ["bcma"],
        countermeasures: [{ text: "Switch to GPRC5D-directed therapy (talquetamab, GPRC5D CAR-T) or FcRH5", refs: ["gprc5d"] }] },
      { name: "T-cell exhaustion and low fitness", how: "Prior lines, high tumour burden, and continuous bispecific dosing exhaust T cells; CAR-T products from heavily pretreated patients expand poorly.", refs: ["t-cell-engager", "car-t"],
      ...
      { name: "Soluble BCMA decoy", how: "Shed BCMA binds drug in circulation.", refs: ["bcma"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "CD19-negative relapse", how: "Alternative splicing, mutation, or lineage switch (to myeloid) removes the CD19 epitope.", frequency: "~30–50% of relapses in ALL, less in lymphoma", refs: ["cd19"],
        countermeasures: [{ text: "CD22 CAR-T, CD20 bispecifics, dual-target CARs", refs: ["cd20", "glofitamab"] }] },
      { name: "CD19-positive relapse from poor CAR-T persistence", how: "Limited expansion or early loss of CAR-T cells; 4-1BB products persist longer than CD28.", refs: ["car-t"],
      ...
      { name: "Immunosuppressive microenvironment and T-cell exhaustion", how: "PD-1 upregulation, TGF-β, and myeloid suppression in lymphoma.", refs: ["pd1-checkpoint"],
  ...
  },
  {
    ...
    mechanisms: [
      { name: "AR amplification and ligand-binding-domain mutations", how: "More receptor, or mutations (F877L, T878A) that turn antagonists into agonists.", frequency: "AR amplification ~30–50% of CRPC", refs: ["androgen-receptor", "ar-signaling"],
      ...
      { name: "AR splice variants (AR-V7)", how: "Truncated receptor lacking the ligand-binding domain is constitutively active and invisible to enzalutamide.", refs: ["androgen-receptor"],
        countermeasures: [{ text: "Taxanes retain activity; N-terminal-domain inhibitors", refs: ["cytotoxic-chemotherapy"] }] },
      { name: "Lineage plasticity to neuroendocrine prostate cancer", how: "RB1/TP53 loss enables transdifferentiation; AR-indifferent, DLL3-positive, PSMA-negative.", frequency: "~15–20% of CRPC", refs: ["dll3", "tp53"],
      ...
      { name: "PI3K/AKT activation via PTEN loss", how: "Reciprocal feedback between AR and PI3K pathways.", frequency: "PTEN loss ~40% of mCRPC", refs: ["akt", "pi3k-akt-mtor"],
        countermeasures: [{ text: "Capivasertib + abiraterone (approved 2026 for PTEN-deficient disease)", refs: ["capivasertib"] }] },
      { name: "Glucocorticoid receptor substitution", how: "GR drives an AR-like transcriptional programme under enzalutamide.", refs: ["relacorilant"],
