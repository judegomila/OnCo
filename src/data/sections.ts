...
export const sections: SectionInput[] = [
  ...
  },
  {
    ...
    summary: "Cytotoxics (platinums, taxanes, anthracyclines, antimetabolites, topoisomerase inhibitors) remain curative in several cancers and are the payloads of antibody-drug conjugates. Progress is in dosing, sequencing, biomarker-guided de-escalation, and toxicity mitigation.",
  },
  {
  ...
  },
  {
    ...
    summary: "Theranostic pairs (68Ga/18F for PET imaging; 177Lu for beta therapy; 225Ac/212Pb for alpha therapy) against PSMA, SSTR, FAP and more. Pluvicto and Lutathera are approved; alpha emitters and new targets are in late-stage trials. Isotope supply is the bottleneck.",
  },
  {
