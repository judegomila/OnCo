...
export const sections: SectionInput[] = [
  ...
  },
  {
    ...
    summary: "Cell therapy covers treatments in which immune cells are taken from a patient or a donor, engineered or expanded, and given back as a living drug. CAR-T has transformed B-cell malignancies and myeloma, and solid tumours are the frontier, with TIL therapy such as lifileucel, TCR-T such as afamitresgene, CAR-T against CLDN18.2 and GPC3, armoured and logic-gated CARs, allogeneic and in vivo CAR-T delivered by targeted LNPs carrying CAR mRNA, and CAR-NK and CAR-macrophages. The section lists cell-therapy release and potency testing and is linked from CAR-T, in vivo CAR-T, TIL therapy, TCR-T, CAR-NK and CAR-macrophage, allogeneic cell therapy, CAR-T for glioma, stem cell transplantation, and the companies Autolus Therapeutics and US WorldMeds.", technologies: ["cell-therapy-release-testing"],
  },
  {
  ...
  },
  {
    ...
    summary: "Supportive care and survivorship covers everything that keeps a patient well enough to receive treatment and well afterwards: anti-emetics, growth factors, scalp cooling, cardio-oncology, fertility preservation, geriatric assessment, palliative integration, exercise oncology, financial toxicity mitigation and survivorship monitoring, an area under-studied relative to its impact. It also houses the complementary approaches people ask about, from acupuncture, CBT for fatigue and music therapy to ginger, curcumin, melatonin, medicinal mushrooms, homeopathy and the so-called herbal cancer cures. Scalp cooling, cardio-oncology, exercise oncology, geriatric assessment, head and neck and thyroid cancer, and companies such as Cancer Commons link here.", technologies: ["acupuncture-nausea", "cbt-fatigue-distress", "tai-chi-qigong", "relaxation-guided-imagery", "music-therapy-cancer", "aromatherapy-cancer", "reiki-energy-therapies", "ginger-nausea", "curcumin-turmeric", "melatonin-cancer", "medicinal-mushrooms-reishi-turkey-tail", "ayurvedic-medicine-cancer", "homeopathy-cancer", "essiac-herbal-cancer-cures"],
  },
  {
