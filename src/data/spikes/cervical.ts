...
const trials: TrialInput[] = [
  ...
  t({ id: "outback", name: "OUTBACK / ANZGOG 0902 / GOG-0274", nct: "NCT01414608", phase: "3", status: "negative", yearReported: 2021, sponsor: "ANZGOG / NRG Oncology", enrolled: 926,
  ...
  t({ id: "lacc", name: "LACC (Laparoscopic Approach to Cervical Cancer)", nct: "NCT00614211", phase: "3", status: "negative", yearReported: 2018, sponsor: "MD Anderson", enrolled: 636,
    ...
    outcomes: [{ endpoint: "Disease-free survival at 4.5 years", primary: true, unit: "%", arms: [{ name: "Minimally invasive", n: 319, value: 86.0 }, { name: "Open surgery", n: 312, value: 96.5 }], hr: 3.74, ci: [1.63, 8.58], source: "https://www.nejm.org/doi/full/10.1056/NEJMoa1806395" },
      { endpoint: "Overall survival at 3 years", unit: "%", arms: [{ name: "Minimally invasive", value: 93.8 }, { name: "Open surgery", value: 99.0 }], hr: 6.0, ci: [1.77, 20.3], source: "https://www.nejm.org/doi/full/10.1056/NEJMoa1806395" }],
  ...
  t({ id: "ken-she", name: "KEN SHE (single-dose HPV vaccine)", nct: "NCT03675256", phase: "4", status: "positive", yearReported: 2022, sponsor: "University of Washington / Bill & Melinda Gates Foundation", enrolled: 2275,
    ...
    drugs: ["gardasil-9"], technologies: ["hpv-vaccine"], cancers: ["cervical", "head-and-neck"], links: [ct("NCT03675256"), { label: "Single-dose evidence, Lancet Global Health 2024", url: "https://www.thelancet.com/journals/langlo/article/PIIS2214-109X(24)00009-3/fulltext" }], people: ["ian-frazer"] }),
  t({ id: "senticol-iii", name: "SENTICOL III", nct: "NCT03386734", phase: "3", status: "active", sponsor: "ARCAGY-GINECO / ENGOT",
...
const technologies: TechnologyInput[] = [
  te({ id: "hpv-testing", name: "HPV DNA testing and self-sampling", sections: ["early-detection", "diagnostics"], status: "standard-of-care", since: 2003, wikipedia: W("HPV_DNA_test"),
    ...
    cancers: ["cervical"], technologies: ["colposcopy-excision", "hpv-vaccine"], terms: ["cin-hsil"], trials: ["mumbai-via-screening"], links: [{ label: "Wikipedia", url: W("HPV_DNA_test") }], journals: ["tumour-virus-research"] }),
...
const pairings: PairingInput[] = [
  pr({ id: "induction-chemo-then-crt", links: [{ label: "ClinicalTrials.gov NCT01566240: INTERLACE", url: "https://clinicaltrials.gov/study/NCT01566240" }, { label: "ClinicalTrials.gov NCT01414608: OUTBACK / ANZGOG 0902 / GOG-0274", url: "https://clinicaltrials.gov/study/NCT01414608" }], name: "Induction chemotherapy → chemoradiation (locally advanced cervical cancer)", a: "carboplatin", b: "imrt-igrt", pairingType: "sequence",
    ...
    summary: "Six weeks of carboplatin-based induction chemotherapy before definitive chemoradiation for locally advanced cervical cancer is a sequence pairing that improved survival in the phase 3 INTERLACE trial. By contrast, OUTBACK / ANZGOG 0902 / GOG-0274 gave adjuvant chemotherapy after chemoradiation and found no benefit but considerably more toxicity, so the order matters. The rationale is that induction achieves early systemic control of micrometastases while patients are still fit, whereas chemotherapy after radiation suffers from poor compliance and marrow toxicity. Because the induction drugs are cheap, the approach is deliverable in low- and middle-income countries where pembrolizumab is not, and it pairs with modern external beam radiotherapy and brachytherapy.",
  ...
  pr({ id: "io-plus-crt-cervical", links: [{ label: "ClinicalTrials.gov NCT04221945: KEYNOTE-A18 / ENGOT-cx11 / GOG-3047", url: "https://clinicaltrials.gov/study/NCT04221945" }], name: "PD-1 blockade + chemoradiation (locally advanced cervical cancer)", a: "pembrolizumab", b: "brachytherapy", pairingType: "combination",
  ...
  pr({ id: "caution-mis-radical-hysterectomy", links: [{ label: "ClinicalTrials.gov NCT00614211: LACC (Laparoscopic Approach to Cervical Cancer)", url: "https://clinicaltrials.gov/study/NCT00614211" }], name: "Caution: minimally invasive radical hysterectomy for early cervical cancer", a: "robotic-surgery", b: "cervical", pairingType: "caution",
...
const ideas: IdeaInput[] = [
  idea({ id: "idea-single-dose-hpv-self-sampling-elimination", links: [{ label: "ClinicalTrials.gov NCT03675256: KEN SHE (single-dose HPV vaccine)", url: "https://clinicaltrials.gov/study/NCT03675256" }], name: "Single-dose HPV vaccination plus HPV self-sampling to reach WHO elimination in low-income countries", maturity: "being-tested-at-scale",
  ...
  idea({ id: "idea-hpv-ctdna-cervical", links: [{ label: "ClinicalTrials.gov NCT04221945: KEYNOTE-A18 / ENGOT-cx11 / GOG-3047", url: "https://clinicaltrials.gov/study/NCT04221945" }], name: "HPV circulating tumour DNA to guide cervical cancer therapy", maturity: "early-clinical",
