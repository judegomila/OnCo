...
const trials: TrialInput[] = [
  ...
  t({ id: "compassion-16", name: "COMPASSION-16 / AK104-303", nct: "NCT04982237", phase: "3", status: "positive", yearReported: 2024, sponsor: "Akeso", enrolled: 445,
    ...
    summary: "PFS HR 0.62 and OS HR 0.64 (Lancet 2024), with benefit in both PD-L1-positive and PD-L1-negative subgroups. NMPA approved the first-line combination in 2024 (second-line monotherapy since 2022). It was not approved outside China by 2026.",
...
const spike: Spike = {
  ...
  patch: {
    ...
    burden: "Cervical cancer causes ~660,000 cases and ~350,000 deaths per year. It is the fourth most common cancer in women worldwide and the leading cancer killer of women in many sub-Saharan African countries.",
