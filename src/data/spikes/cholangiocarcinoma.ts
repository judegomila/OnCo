...
const companies: CompanyInput[] = [
  co({ id: "incyte", name: "Incyte", hq: "Wilmington, DE", country: "US", companyType: "biotech", website: "https://www.incyte.com", ticker: "INCY", sections: ["targeted-therapy"],
    tldr: "Maker of pemigatinib, the first targeted drug approved for bile duct cancer (2020), and of the JAK inhibitor ruxolitinib.",
...
const drugs: DrugInput[] = [
  d({ id: "gemcitabine-cisplatin", name: "Gemcitabine + cisplatin", modality: "Cytotoxic regimen", status: "standard-of-care", wikipedia: W("Gemcitabine"),
    tldr: "The chemotherapy backbone for bile duct cancer since 2010, now given with immunotherapy.",
  ...
  d({ id: "pemigatinib", name: "Pemigatinib", brand: "Pemazyre", modality: "Small-molecule kinase inhibitor (FGFR1-3)", status: "approved", wikipedia: W("Pemigatinib"),
    tldr: "The first targeted therapy for bile duct cancer, for tumours with an FGFR2 gene fusion.",
  ...
  d({ id: "futibatinib", name: "Futibatinib", brand: "Lytgobi", modality: "Small-molecule irreversible kinase inhibitor (FGFR1-4)", status: "approved", wikipedia: W("Futibatinib"),
    tldr: "A covalent FGFR inhibitor for FGFR2-fusion bile duct cancer, with the highest response rate of the first-generation drugs.",
  ...
  d({ id: "ivosidenib", name: "Ivosidenib", brand: "Tibsovo", modality: "Small-molecule IDH1 inhibitor", status: "approved", wikipedia: W("Ivosidenib"),
    tldr: "A pill that blocks the mutant IDH1 enzyme, approved in bile duct cancer and in leukaemia.",
...
const trials: TrialInput[] = [
  ...
  t({ id: "topaz-1", name: "TOPAZ-1", nct: "NCT03875235", phase: "3", status: "positive", yearReported: 2022, sponsor: "AstraZeneca", enrolled: 685,
    ...
    tldr: "The first immunotherapy success in bile duct cancer; a small median gain but a growing tail of long survivors.",
  ...
  t({ id: "fight-202", name: "FIGHT-202", nct: "NCT02924376", phase: "2", status: "positive", yearReported: 2020, sponsor: "Incyte", enrolled: 147,
    ...
    tldr: "The single-arm study that produced the first targeted approval in bile duct cancer.",
...
const spike: Spike = {
  ...
  patch: {
    tldr: "Cancer of the bile ducts or gallbladder. It is rare and often found late, but it turned out to carry more targetable mutations than almost any other gastrointestinal cancer, and immunotherapy now adds to chemotherapy from the first treatment.",
