...
const drugs: DrugInput[] = [
  ...
  d({ id: "tinengotinib", links: [{ label: "ClinicalTrials.gov: trials of Tinengotinib", url: "https://clinicaltrials.gov/search?intr=TT-00420" }], name: "Tinengotinib", code: "TT-00420", modality: "Small-molecule multi-kinase inhibitor (FGFR1-3, VEGFR, Aurora, JAK)", status: "phase-3",
