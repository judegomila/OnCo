...
const backlinkSupplements: Spike["supplements"] = [
  ...
  { id: "paper-cms-guinney-nat-med-2015", related: [ROADMAP, "paper-tcga-colon-rectal-molecular-characterization-nature-2012"] } satisfies { id: string } & Partial<PaperInput>,
  ...
  { id: "paper-niche-2-neoadjuvant-colon-nejm-2024", related: [ROADMAP, "paper-andre-checkmate-8hw-nivolumab-ipilimumab-nejm-2024", "paper-cercek-nonoperative-management-mismatch-repair-deficient-tumours-nejm-2025"] } satisfies { id: string } & Partial<PaperInput>,
  { id: "paper-cercek-dmmr-rectal-nejm-2022", related: [ROADMAP, "paper-cercek-nonoperative-management-mismatch-repair-deficient-tumours-nejm-2025"] } satisfies { id: string } & Partial<PaperInput>,
...
const spike: Spike = {
  ...
  patch: {
    ...
    history: [
      { year: 1982, title: "Total mesorectal excision described", note: "Heald, Husband and Ryall found tumour deposits in the mesorectum centimetres below the tumour; 50 curative operations followed for over two years with no pelvic or staple-line recurrence.", refs: ["paper-heald-mesorectum-rectal-cancer-surgery-br-j-surg-1982", "total-mesorectal-excision"] },
      { year: 1993, title: "Stool blood testing cuts bowel cancer deaths", note: "Minnesota (1993), then Nottingham (1996, 152,850 people, 15 percent reduction) and Funen (1996, 18 percent) build the case for national programmes.", refs: ["paper-minnesota-fobt-nejm-1993", "paper-hardcastle-nottingham-faecal-occult-blood-lancet-1996", "paper-kronborg-funen-faecal-occult-blood-lancet-1996"] },
      ...
      { year: 2012, title: "Polypectomy prevents deaths; the genome is read", note: "National Polyp Study at 23 years: colorectal cancer mortality halved against the general population. The Cancer Genome Atlas: 276 tumours, 16 percent hypermutated, ERBB2 amplification found.", refs: ["paper-zauber-national-polyp-study-colonoscopic-polypectomy-nejm-2012", "paper-tcga-colon-rectal-molecular-characterization-nature-2012"] },
      { year: 2013, title: "Extended RAS testing, and the first refractory-line drug", note: "PRIME: a further 17 percent of KRAS exon 2 wild-type patients carry other RAS mutations and do worse on panitumumab. CORRECT: regorafenib 6.4 versus 5.0 months.", refs: ["paper-douillard-prime-panitumumab-ras-nejm-2013", "paper-grothey-correct-regorafenib-lancet-2013"] },
      { year: 2016, title: "Circulating tumour DNA measures residual disease", note: "Tie, 230 stage II patients: a positive test after surgery carried a hazard ratio of 18 for recurrence.", refs: ["paper-tie-ctdna-minimal-residual-disease-stage-ii-colon-sci-transl-med-2016", "ctdna", "mrd"] },
      ...
      { year: 2021, title: "Total neoadjuvant therapy, and HIPEC falls", note: "RAPIDO cuts three-year treatment failure from 30.4 to 23.7 percent; PRODIGE 23 raises three-year disease-free survival from 69 to 76 percent. PRODIGE 7 removes the heated chemotherapy and finds survival unchanged at 41.7 versus 41.2 months.", refs: ["paper-bahadoer-rapido-short-course-radiotherapy-lancet-oncol-2021", "paper-conroy-prodige-23-neoadjuvant-folfirinox-rectal-lancet-oncol-2021", "paper-quenet-prodige-7-hipec-peritoneal-colorectal-lancet-oncol-2021"] },
    ...
    openProblems: [
      "Screening delivers the effect of its uptake, not of its test: NordICC's 18 percent reduction in ten-year incidence came with 42 percent attendance, and 40.4 percent of the Nottingham screening group never returned a kit. Endoscopy capacity and the endoscopist's adenoma detection rate then decide what a positive test is worth.",
      ...
      "Ninety-five percent of metastatic colorectal cancer is microsatellite stable and responds to no immunotherapy on this roadmap; the best signal is a 17 percent response rate in a single-arm phase 1, concentrated in patients without active liver metastases, and no randomised trial has selected patients by immune biology rather than by line of therapy.",
      "Circulating tumour DNA identifies who will relapse with a hazard ratio around 10, and de-escalation on a negative result is proven in stage II, but no trial has shown that escalating treatment for a positive result changes anything.",
