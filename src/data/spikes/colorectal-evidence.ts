...
const spike: Spike = {
  ...
  patch: {
    ...
    history: [
      ...
      { year: 2012, title: "Polypectomy prevents deaths, not just cancers", note: "National Polyp Study at 23 years: colorectal cancer mortality halved against the general population.", refs: ["paper-zauber-national-polyp-study-colonoscopic-polypectomy-nejm-2012", "paper-tcga-colon-rectal-molecular-characterization-nature-2012"] },
