...
const trials: TrialInput[] = [
  ...
  t({ id: "azur-1", name: "AZUR-1", nct: "NCT05723562", phase: "2", status: "positive", yearReported: 2026, sponsor: "GSK", enrolled: 154,
    ...
    links: [ct("NCT05723562"), { label: "GSK priority review announcement", url: "https://www.gsk.com/en-gb/media/press-releases/jemperli-dostarlimab-accepted-for-priority-review-by-the-us-fda/" }] }),
