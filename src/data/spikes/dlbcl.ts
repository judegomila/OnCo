...
const terms: TermInput[] = [
  ...
  term({ id: "lugano-classification", name: "Lugano classification / Ann Arbor staging", category: "Clinical", wikipedia: W("Ann_Arbor_staging"),
    ...
    summary: "The Lugano classification is the staging and response system for lymphoma: stages I to IV are assigned by how many lymph node regions and organs are involved, and response is judged on FDG PET-CT using the Deauville five-point scale. Published in 2014, it merged the older Ann Arbor staging with PET-based response assessment and dropped the bulky-disease and X designations in favour of measured diameters. Readers meet it on the pages for diffuse large B-cell lymphoma, Hodgkin lymphoma, follicular lymphoma, mantle cell lymphoma and the peripheral T-cell lymphomas, since it is common to all of them. It is the framework within which FDG PET, the linked technology, is read in lymphoma.",
    cancers: ["dlbcl", "hodgkin-lymphoma"], technologies: ["fdg-pet"], links: [{ label: "Wikipedia", url: W("Ann_Arbor_staging") }] }),
];
...
const drugs: DrugInput[] = [
  ...
  d({ id: "epcoritamab", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Epcoritamab" }], name: "Epcoritamab", brand: "Epkinly", modality: "Bispecific T-cell engager (CD20×CD3)", status: "approved", wikipedia: W("Epcoritamab"),
    ...
    targets: ["cd20", "cd3"], technologies: ["t-cell-engager"], companies: ["genmab", "abbvie"], cancers: ["dlbcl"], trials: ["epcore-nhl-1", "epcore-dlbcl-1", "epcore-dlbcl-2"], terms: ["crs", "icans", "step-up-dosing"] }),
  d({ id: "tafasitamab", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Tafasitamab" }], name: "Tafasitamab", brand: "Monjuvi", modality: "Monoclonal antibody (anti-CD19, Fc-enhanced)", status: "approved", wikipedia: W("Tafasitamab"),
    ...
    targets: ["cd19"], technologies: ["monoclonal-antibody"], companies: ["incyte", "morphosys"], cancers: ["dlbcl"], trials: ["l-mind", "frontmind"], drugs: ["lenalidomide"], terms: ["adcc"] }),
  ...
  d({ id: "golcadomide", links: [{ label: "ClinicalTrials.gov NCT06356129 (GOLSEEK-1)", url: "https://clinicaltrials.gov/study/NCT06356129" }], name: "Golcadomide", code: "CC-99282, BMS-986369", modality: "Molecular glue degrader (CELMoD, IKZF1/3)", status: "phase-3",
...
const trials: TrialInput[] = [
  t({ id: "polarix", name: "POLARIX", nct: "NCT03274492", phase: "3", status: "positive", yearReported: 2021, sponsor: "Roche", enrolled: 879,
    ...
    drugs: ["polatuzumab-vedotin", "doxorubicin"], cancers: ["dlbcl"], technologies: ["adc"], terms: ["pfs", "ipi-score"], links: [ct("NCT03274492"), { label: "NEJM 2022", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2115304" }, { label: "5-year JCO 2025", url: "https://ascopubs.org/doi/10.1200/JCO-25-00925" }], people: ["gilles-salles", "herve-tilly", "laurie-sehn"] }),
  ...
  t({ id: "transform", name: "TRANSFORM", nct: "NCT03575351", phase: "3", status: "positive", yearReported: 2022, sponsor: "BMS", enrolled: 184,
    ...
    summary: "TRANSFORM, trial NCT03575351 sponsored by Bristol Myers Squibb and reported in 2022, was the second trial to show that a CAR-T beats salvage chemotherapy and autologous transplant in primary refractory or early-relapsed large B-cell lymphoma. It randomised 184 transplant-eligible patients to lisocabtagene maraleucel or standard care, met its primary event-free survival endpoint with a large effect and a much higher complete response rate, and was the basis of liso-cel's second-line approval in June 2022, although crossover to liso-cel confounded overall survival. OnCo links it to lymphoma, CAR-T, CD19 as a target, the pairing of CAR-T before transplant at early relapse and the ZUMA-7 and TRANSFORM papers, and the result is concordant with ZUMA-7. Whether the two approved second-line CAR-Ts differ meaningfully in efficacy or toxicity is the open question.",
  ...
  t({ id: "starglo", name: "STARGLO", nct: "NCT04408638", phase: "3", status: "mixed", yearReported: 2024, sponsor: "Roche", enrolled: 274,
    ...
    summary: "STARGLO, trial NCT04408638 sponsored by Roche and published in the Lancet in 2024, showed that the CD20 by CD3 bispecific glofitamab with gemcitabine and oxaliplatin improved survival over rituximab plus the same chemotherapy in relapsed or refractory diffuse large B-cell lymphoma in transplant-ineligible patients, but the FDA rejected it because most patients were enrolled in Asia and the US-relevant subgroup did not clearly benefit. It randomised 274 patients, met its primary overall survival endpoint with a large progression benefit, won EU approval in 2025, and received a complete response letter in July 2025 after an advisory committee voted eight to one that the data did not apply to US patients. OnCo links it to lymphoma, T-cell engagers, glofitamab and Michael Dickinson. Whether regional heterogeneity reflected biology, practice or chance is the open question.",
  ...
  t({ id: "epcore-nhl-1", name: "EPCORE NHL-1", nct: "NCT03625037", phase: "1/2", status: "positive", yearReported: 2022, sponsor: "Genmab / AbbVie", enrolled: 157,
    ...
    drugs: ["epcoritamab"], cancers: ["dlbcl"], terms: ["orr", "crs"], links: [ct("NCT03625037")], people: ["catherine-thieblemont"] }),
  t({ id: "epcore-dlbcl-1", name: "EPCORE DLBCL-1", nct: "NCT04628494", phase: "3", status: "mixed", yearReported: 2026, sponsor: "Genmab / AbbVie", enrolled: 552,
    ...
    drugs: ["epcoritamab"], cancers: ["dlbcl"], links: [ct("NCT04628494")], people: ["catherine-thieblemont"] }),
...
const pairings: PairingInput[] = [
  pair({ id: "bispecific-plus-adc-lymphoma", links: [{ label: "ClinicalTrials.gov NCT05171647: SUNMO", url: "https://clinicaltrials.gov/study/NCT05171647" }], name: "CD20 bispecific + CD79b ADC (mosunetuzumab + polatuzumab)", a: "mosunetuzumab", b: "polatuzumab-vedotin", pairingType: "combination",
