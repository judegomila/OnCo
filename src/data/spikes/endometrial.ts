...
const trials: TrialInput[] = [
  t({ id: "ruby", technologies: ["checkpoint-inhibitor"], name: "RUBY / ENGOT-EN6 / GOG-3031", nct: "NCT03981796", phase: "3", status: "positive", yearReported: 2023, sponsor: "GSK", enrolled: 494,
  ...
  t({ id: "nrg-gy018-keynote-868", technologies: ["checkpoint-inhibitor"], name: "NRG-GY018 / KEYNOTE-868", nct: "NCT03914612", phase: "3", status: "positive", yearReported: 2023, sponsor: "NRG Oncology / Merck", enrolled: 816,
    ...
    drugs: ["pembrolizumab", "carboplatin", "paclitaxel"], targets: ["pd1"], cancers: ["endometrial", "endometrial-mmr-deficient", "advanced-recurrent-endometrial-cancer", "endometrial-nsmp"], companies: ["nrg-oncology"], terms: ["msi"], links: [ct("NCT03914612"), { label: "NEJM 2023", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2302312" }], people: ["ramez-eskander"] }),
  t({ id: "duo-e", technologies: ["checkpoint-inhibitor"], name: "DUO-E / GOG-3041 / ENGOT-EN10", nct: "NCT04269200", phase: "3", status: "positive", yearReported: 2023, sponsor: "AstraZeneca", enrolled: 718,
    ...
    drugs: ["durvalumab", "olaparib", "carboplatin", "paclitaxel"], targets: ["pdl1", "parp"], cancers: ["endometrial", "endometrial-mmr-deficient", "advanced-recurrent-endometrial-cancer"], terms: ["msi"], links: [ct("NCT04269200"), { label: "JCO 2023", url: "https://ascopubs.org/doi/10.1200/JCO.23.02132" }] }),
  t({ id: "keynote-775", technologies: ["antiangiogenic", "kinase-inhibitors"], name: "KEYNOTE-775 / Study 309", nct: "NCT03517449", phase: "3", status: "positive", yearReported: 2021, sponsor: "Eisai / Merck", enrolled: 827,
    ...
    drugs: ["lenvatinib", "pembrolizumab"], targets: ["vegf", "pd1"], cancers: ["endometrial", "advanced-recurrent-endometrial-cancer", "endometrial-nsmp"], links: [ct("NCT03517449"), { label: "NEJM 2022", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2108330" }] }),
  t({ id: "portec-3", name: "PORTEC-3", nct: "NCT00411138", phase: "3", status: "positive", yearReported: 2018, sponsor: "Dutch Gynaecological Oncology Group", enrolled: 660,
    ...
    technologies: ["imrt-igrt", "cytotoxic-chemotherapy", "brachytherapy"], cancers: ["endometrial", "endometrial-p53-abnormal", "endometrial-pole-ultramutated", "endometrial-nsmp"], terms: ["endometrial-molecular-classes"], targets: ["tp53"], links: [ct("NCT00411138"), { label: "Lancet Oncology 2019", url: "https://www.thelancet.com/journals/lanonc/article/PIIS1470-2045(19)30395-X/fulltext" }], people: ["carien-creutzberg"] }),
  t({ id: "destiny-pantumor02", name: "DESTINY-PanTumor02", nct: "NCT04482309", phase: "2", status: "positive", yearReported: 2023, sponsor: "AstraZeneca / Daiichi Sankyo", enrolled: 267,
    ...
    drugs: ["trastuzumab-deruxtecan"], targets: ["her2"], cancers: ["endometrial", "cervical", "endometrial-p53-abnormal", "uterine-carcinosarcoma", "recurrent-metastatic-cervical-cancer"], technologies: ["adc", "topoisomerase-inhibitors"], terms: ["tumour-agnostic"], links: [ct("NCT04482309"), { label: "JCO 2024", url: "https://ascopubs.org/doi/10.1200/JCO.23.02005" }], people: ["funda-meric-bernstam"] }),
  t({ id: "xport-ec-042", technologies: ["kinase-inhibitors"], name: "XPORT-EC-042 / ENGOT-EN20 / GOG-3083", nct: "NCT05611931", phase: "3", status: "negative", yearReported: 2026, sponsor: "Karyopharm",
    ...
    drugs: ["selinexor"], targets: ["tp53"], cancers: ["endometrial", "advanced-recurrent-endometrial-cancer", "endometrial-nsmp"], companies: ["karyopharm"], tags: ["failure", "lesson:subgroup"], links: [ct("NCT05611931"), { label: "Karyopharm topline", url: "https://investors.karyopharm.com/2026-07-30-Karyopharm-Announces-Topline-Results-from-Phase-3-XPORT-EC-042-Trial-in-Endometrial-Cancer" }] }),
...
const drugs: DrugInput[] = [
  ...
  d({ id: "selinexor", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Selinexor" }], name: "Selinexor", brand: "Xpovio", code: "KPT-330", modality: "Small-molecule XPO1 (nuclear export) inhibitor", status: "approved", wikipedia: W("Selinexor"),
    ...
    approvals: [{ region: "US", year: 2019, indication: "Relapsed/refractory multiple myeloma (≥4 lines) with dexamethasone" }, { region: "US", year: 2020, indication: "Relapsed/refractory DLBCL; myeloma with bortezomib after ≥1 line" }, { region: "EU", year: 2021, indication: "EU brand Nexpovio", note: "Conditional marketing authorisation" }],
    ...
    targets: ["tp53"], technologies: ["kinase-inhibitors"], companies: ["karyopharm", "antengene"], cancers: ["endometrial", "multiple-myeloma", "dlbcl", "myeloma-relapsed-refractory"], trials: ["xport-ec-042", "nct04442022", "nct06158841", "nct02227251", "nct02343042", "nct04414475", "nct04782687", "nct04562389"] }),
  d({ id: "megestrol-progestins", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Progestins" }], name: "Progestins (megestrol acetate, medroxyprogesterone, levonorgestrel IUD)", aka: ["Levonorgestrel", "Levonorgestrel intrauterine device", "Megestrol acetate", "Medroxyprogesterone", "Oral progestins"], brand: "Megace; Mirena (IUD)", modality: "Hormonal therapy (progestin)", status: "approved", wikipedia: W("Megestrol_acetate"),
...
const terms: TermInput[] = [
  tm({ id: "endometrial-molecular-classes", aka: ["ProMisE", "ProMisE classifier", "molecular classification of endometrial cancer", "TCGA endometrial subtypes", "WHO 2020 endometrial molecular classification", "endometrial molecular class", "molecular class"], wikipedia: W("Endometrial_cancer"), name: "Endometrial cancer molecular classes (POLEmut, MMRd, p53abn, NSMP)", category: "Cancer biology",
...
const ideas: IdeaInput[] = [
  ...
  idea({ id: "idea-her2-adc-serous-endometrial", keyPapers: ["paper-yarden-sliwkowski-erbb-network-nrmcb-2001"], links: [{ label: "ClinicalTrials.gov NCT04482309: DESTINY-PanTumor02", url: "https://clinicaltrials.gov/study/NCT04482309" }], name: "HER2 ADCs as standard for HER2-positive serous endometrial cancer", maturity: "early-clinical",
...
const spike: Spike = {
  ...
  patch: {
    ...
    companies: ["gsk", "merck", "astrazeneca", "eisai", "karyopharm", "genmab", "daiichi-sankyo", "nrg-oncology"],
