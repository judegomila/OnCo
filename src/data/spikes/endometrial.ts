...
const trials: TrialInput[] = [
  t({ id: "ruby", name: "RUBY / ENGOT-EN6 / GOG-3031", nct: "NCT03981796", phase: "3", status: "positive", yearReported: 2023, sponsor: "GSK", enrolled: 494,
    ...
    drugs: ["dostarlimab", "carboplatin", "paclitaxel"], targets: ["pd1"], cancers: ["endometrial"], terms: ["msi"], links: [ct("NCT03981796"), { label: "NEJM 2023", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2216334" }, { label: "OS, Annals of Oncology 2024", url: "https://www.annalsofoncology.org/article/S0923-7534(24)00721-X/fulltext" }] }),
  t({ id: "nrg-gy018-keynote-868", name: "NRG-GY018 / KEYNOTE-868", nct: "NCT03914612", phase: "3", status: "positive", yearReported: 2023, sponsor: "NRG Oncology / Merck", enrolled: 816,
    ...
    tldr: "The pembrolizumab twin of RUBY: immunotherapy plus chemotherapy cut the risk of progression by 70% in dMMR tumours and 46% in the rest.",
    ...
    drugs: ["pembrolizumab", "carboplatin", "paclitaxel"], targets: ["pd1"], cancers: ["endometrial"], institutions: ["nrg-oncology"], terms: ["msi"], links: [ct("NCT03914612"), { label: "NEJM 2023", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2302312" }] }),
  ...
  t({ id: "portec-3", name: "PORTEC-3", nct: "NCT00411138", phase: "3", status: "positive", yearReported: 2018, sponsor: "Dutch Gynaecological Oncology Group", enrolled: 660,
    ...
    technologies: ["imrt-igrt", "cytotoxic-chemotherapy", "brachytherapy"], cancers: ["endometrial"], terms: ["endometrial-molecular-classes"], targets: ["tp53"], links: [ct("NCT00411138"), { label: "Lancet Oncology 2019", url: "https://www.thelancet.com/journals/lanonc/article/PIIS1470-2045(19)30395-X/fulltext" }] }),
  t({ id: "destiny-pantumor02", name: "DESTINY-PanTumor02", nct: "NCT04482309", phase: "2", status: "positive", yearReported: 2023, sponsor: "AstraZeneca / Daiichi Sankyo", enrolled: 267,
    ...
    drugs: ["trastuzumab-deruxtecan"], targets: ["her2"], cancers: ["endometrial", "cervical"], technologies: ["adc"], terms: ["tumour-agnostic"], links: [ct("NCT04482309"), { label: "JCO 2024", url: "https://ascopubs.org/doi/10.1200/JCO.23.02005" }] }),
...
const drugs: DrugInput[] = [
  d({ id: "lenvatinib", name: "Lenvatinib", brand: "Lenvima", modality: "Small-molecule multikinase inhibitor (VEGFR, FGFR, RET, KIT, PDGFR)", status: "approved", wikipedia: W("Lenvatinib"),
    ...
    targets: ["vegf", "fgfr2", "ret", "kit"], technologies: ["kinase-inhibitors", "antiangiogenic"], companies: ["eisai", "merck"], cancers: ["endometrial", "rcc", "hcc", "thyroid"], trials: ["keynote-775"], pathways: ["vegf-angiogenesis"] }),
  d({ id: "selinexor", name: "Selinexor", brand: "Xpovio", code: "KPT-330", modality: "Small-molecule XPO1 (nuclear export) inhibitor", status: "approved", wikipedia: W("Selinexor"),
    tldr: "A first-in-class pill that traps tumour-suppressor proteins inside the nucleus; approved in myeloma, it failed its endometrial cancer test in 2026.",
  ...
  d({ id: "megestrol-progestins", name: "Progestins (megestrol acetate, medroxyprogesterone, levonorgestrel IUD)", brand: "Megace; Mirena (IUD)", modality: "Hormonal therapy (progestin)", status: "approved", wikipedia: W("Megestrol_acetate"),
...
const spike: Spike = {
  ...
  patch: {
    ...
    burden: "~420,000 cases and ~97,000 deaths per year worldwide; the most common gynaecologic cancer in the US and Europe, with incidence and mortality rising ~1-2% per year.",
