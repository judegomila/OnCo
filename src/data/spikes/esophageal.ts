...
const trials: TrialInput[] = [
  t({ id: "cross", name: "CROSS", nct: "NTR487", phase: "3", status: "positive", yearReported: 2012, sponsor: "Dutch Cancer Society (Erasmus MC)", enrolled: 366,
    ...
    links: [{ label: "NEJM 2012", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa1112088" }, { label: "10-year outcomes, JCO 2021", url: "https://ascopubs.org/doi/10.1200/JCO.20.03614" }] }),
  t({ id: "sano", name: "SANO", nct: "NCT05953181", phase: "3", status: "positive", yearReported: 2023, sponsor: "Erasmus MC", enrolled: 274,
    ...
    links: [ct("NCT05953181"), { label: "Lancet Oncology 2025", url: "https://www.sciencedirect.com/science/article/abs/pii/S1470204525000270" }] }),
  t({ id: "checkmate-577", name: "CheckMate 577", nct: "NCT02743494", phase: "3", status: "mixed", yearReported: 2021, sponsor: "BMS", enrolled: 794,
    ...
    summary: "DFS 22.4 vs 11.0 months (HR 0.69; NEJM 2021), the basis of the 2021 FDA approval. Final OS (ASCO 2025): 51.7 vs 35.3 months, HR 0.85 (95% CI 0.70-1.04), not statistically significant; DMFS and PFS2 favoured nivolumab. Remains standard adjuvant therapy in NCCN and ESMO.",
    ...
    links: [ct("NCT02743494"), { label: "Final OS, ASCO 2025", url: "https://ascopubs.org/doi/10.1200/JCO.2025.43.16_suppl.4000" }] }),
  t({ id: "keynote-590", name: "KEYNOTE-590", nct: "NCT03189719", phase: "3", status: "positive", yearReported: 2020, sponsor: "Merck", enrolled: 749,
    ...
    summary: "OS 12.4 vs 9.8 months overall (HR 0.73); 13.9 vs 8.8 months in PD-L1 CPS ≥10 (HR 0.62). Five-year follow-up (ESMO Open 2025): OS HR 0.72. FDA approval March 2021 for all patients; EMA restricted to CPS ≥10. Benefit in PD-L1-negative disease is uncertain.",
    ...
    drugs: ["pembrolizumab"], cancers: ["esophageal"], targets: ["pd1"], terms: ["cps"], links: [ct("NCT03189719")] }),
  t({ id: "checkmate-648", name: "CheckMate 648", nct: "NCT03143153", phase: "3", status: "positive", yearReported: 2021, sponsor: "BMS", enrolled: 970,
    ...
    summary: "PD-L1 ≥1%: OS 15.4 vs 9.1 months with nivolumab + chemotherapy (HR 0.54) and 13.7 vs 9.1 months with nivolumab + ipilimumab (HR 0.64) (NEJM 2022). All randomised: HR 0.74 and 0.78. Five-year follow-up (2026) confirms durable benefit. FDA approval May 2022 for both regimens.",
  ...
  t({ id: "escort-1st", name: "ESCORT-1st", nct: "NCT03691090", phase: "3", status: "positive", yearReported: 2021, sponsor: "Jiangsu Hengrui", enrolled: 596,
    ...
    drugs: ["camrelizumab"], cancers: ["esophageal"], targets: ["pd1"], links: [ct("NCT03691090"), { label: "JAMA 2021", url: "https://jamanetwork.com/journals/jama/fullarticle/2784143" }] }),
...
const drugs: DrugInput[] = [
  d({ id: "tislelizumab", name: "Tislelizumab", brand: "Tevimbra", code: "BGB-A317", modality: "Monoclonal antibody (anti-PD-1)", status: "approved", wikipedia: W("Tislelizumab"),
    ...
    targets: ["pd1"], technologies: ["checkpoint-inhibitor"], companies: ["beone"], cancers: ["esophageal", "gastric", "nsclc", "hcc"], trials: ["rationale-306", "herizon-gea-01"], terms: ["irae", "fc-effector"],
  ...
  d({ id: "camrelizumab", name: "Camrelizumab", brand: "AiRuiKa", code: "SHR-1210", modality: "Monoclonal antibody (anti-PD-1)", status: "approved", wikipedia: W("Camrelizumab"),
    tldr: "One of China's most widely used PD-1 blockers, approved there for oesophageal, liver, lung, and other cancers; not approved in the US.",
...
const technologies: TechnologyInput[] = [
  { id: "endoscopic-resection", kind: "technology", name: "Endoscopic resection (EMR / ESD)", sections: ["surgery", "early-detection"], status: "standard-of-care", asOf, since: 1990, wikipedia: W("Endoscopic_submucosal_dissection"),
    tldr: "Removing very early cancers of the oesophagus or stomach from the inside with an endoscope, so the organ is kept intact.",
    ...
    cancers: ["esophageal", "gastric"], terms: ["barretts-esophagus"], technologies: ["thermal-ablation"] },
];
