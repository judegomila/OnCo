...
const trials: TrialInput[] = [
  t({ id: "cross", name: "CROSS", nct: "NTR487", phase: "3", status: "positive", yearReported: 2012, sponsor: "Dutch Cancer Society (Erasmus MC)", enrolled: 366,
    ...
    technologies: ["imrt-igrt", "platinum", "cytotoxic-chemotherapy", "radiosensitisers"], drugs: ["carboplatin", "paclitaxel"], cancers: ["esophageal", "oesophageal-squamous-cell-carcinoma", "oesophageal-adenocarcinoma", "gastric"], terms: ["neoadjuvant-adjuvant", "pcr", "chemoradiation"],
  ...
  t({ id: "sano", name: "SANO", nct: "NCT05953181", phase: "3", status: "positive", yearReported: 2023, sponsor: "Erasmus MC", enrolled: 309, enrolledBasis: "analysed",
    enrolledNote: "ClinicalTrials.gov lists 776 participants (actual); the Lancet Oncology 2025 paper reports 1,115 individuals screened and 309 included in the analysis (198 active surveillance, 111 standard surgery).",
  ...
  t({ id: "checkmate-577", technologies: ["checkpoint-inhibitor"], name: "CheckMate 577", nct: "NCT02743494", phase: "3", status: "mixed", yearReported: 2021, sponsor: "BMS", enrolled: 794,
    ...
    drugs: ["nivolumab"], cancers: ["esophageal", "gastric", "oesophageal-squamous-cell-carcinoma", "oesophageal-adenocarcinoma"], targets: ["pd1"], terms: ["neoadjuvant-adjuvant"], trials: ["cross"],
  ...
  t({ id: "keynote-590", technologies: ["checkpoint-inhibitor"], name: "KEYNOTE-590", nct: "NCT03189719", phase: "3", status: "positive", yearReported: 2020, sponsor: "Merck", enrolled: 749,
    ...
    drugs: ["pembrolizumab"], cancers: ["esophageal", "oesophageal-squamous-cell-carcinoma", "oesophageal-adenocarcinoma"], targets: ["pd1"], terms: ["cps"], links: [ct("NCT03189719")], people: ["ken-kato"] }),
  t({ id: "checkmate-648", technologies: ["checkpoint-inhibitor"], name: "CheckMate 648", nct: "NCT03143153", phase: "3", status: "positive", yearReported: 2021, sponsor: "BMS", enrolled: 970,
    ...
    drugs: ["nivolumab", "ipilimumab"], cancers: ["esophageal", "oesophageal-squamous-cell-carcinoma"], targets: ["pd1", "ctla4"], links: [ct("NCT03143153"), { label: "5-year follow-up", url: "https://pubmed.ncbi.nlm.nih.gov/42575473/" }], people: ["jaffer-ajani"] }),
  t({ id: "rationale-306", technologies: ["checkpoint-inhibitor"], name: "RATIONALE-306", nct: "NCT03783442", phase: "3", status: "positive", yearReported: 2022, sponsor: "BeOne (BeiGene)", enrolled: 649,
  ...
  t({ id: "escort-1st", technologies: ["checkpoint-inhibitor"], name: "ESCORT-1st", nct: "NCT03691090", phase: "3", status: "positive", yearReported: 2021, sponsor: "Jiangsu Hengrui", enrolled: 596,
...
const drugs: DrugInput[] = [
  d({ id: "tislelizumab", name: "Tislelizumab", brand: "Tevimbra", code: "BGB-A317", modality: "Monoclonal antibody (anti-PD-1)", status: "approved", wikipedia: W("Tislelizumab"),
    ...
    regulatoryEvents: [{ date: "2026-08-25", type: "approval", region: "US", note: "FDA approves zanidatamab-hrii and tislelizumab-jsgr for HER2-positive gastric, gastroesophageal junction, or esophageal adenocarcinoma", source: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-zanidatamab-hrii-and-tislelizumab-jsgr-her2-positive-gastric-gastroesophageal-junction" }, { date: "2024-03", type: "approval", region: "US", note: "Second-line ESCC (RATIONALE-302)" }, { date: "2024-12", type: "approval", region: "US", note: "First-line gastric/GEJ (RATIONALE-305)" }, { date: "2025-03-04", type: "approval", region: "US", note: "First-line ESCC PD-L1 ≥1% (RATIONALE-306)" }],
    targets: ["pd1"], technologies: ["checkpoint-inhibitor"], companies: ["beone"], cancers: ["esophageal", "gastric", "nsclc", "hcc", "recurrent-metastatic-nasopharyngeal-carcinoma"], trials: ["rationale-306", "herizon-gea-01", "rationale-302", "nct07502300", "nct04379635", "nct07170995", "nct05840016", "nct06030258", "nct05651022", "nct05431270", "nct05609370", "nct05635708", "nct05661955", "nct07244705", "nct06427941", "nct05632939", "nct07700667", "nct07554521", "nct07331155", "nct06745908", "nct04699188", "nct07315750", "nct04170283", "nct03967977", "nct07554456", "nct06499350", "nct07390383", "nct06825494", "nct07019675", "nct07669415", "nct03736889"], terms: ["irae", "fc-effector"],
  ...
  d({ id: "camrelizumab", companies: ["hengrui"], name: "Camrelizumab", brand: "AiRuiKa", code: "SHR-1210", modality: "Monoclonal antibody (anti-PD-1)", status: "approved", wikipedia: W("Camrelizumab"),
...
const ideas: IdeaInput[] = [
  ...
  { id: "idea-non-endoscopic-barretts-screening", links: [{ label: "BEST3: Cytosponge-trefoil factor 3 versus usual care to identify Barrett's oesophagus (Lancet 2020)", url: "https://doi.org/10.1016/S0140-6736(20)31099-0" }], kind: "idea", name: "Non-endoscopic screening for Barrett's oesophagus and early adenocarcinoma", maturity: "being-tested-at-scale", asOf,
