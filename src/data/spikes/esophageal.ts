...
const trials: TrialInput[] = [
  t({ id: "cross", name: "CROSS", nct: "NTR487", phase: "3", status: "positive", yearReported: 2012, sponsor: "Dutch Cancer Society (Erasmus MC)", enrolled: 366,
    ...
    links: [{ label: "NEJM 2012", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa1112088" }, { label: "10-year outcomes, JCO 2021", url: "https://ascopubs.org/doi/10.1200/JCO.20.03614" }], people: ["jan-van-lanschot"] }),
  ...
  t({ id: "escort-1st", name: "ESCORT-1st", nct: "NCT03691090", phase: "3", status: "positive", yearReported: 2021, sponsor: "Jiangsu Hengrui", enrolled: 596,
    ...
    drugs: ["camrelizumab"], cancers: ["esophageal"], targets: ["pd1"], links: [ct("NCT03691090"), { label: "JAMA 2021", url: "https://jamanetwork.com/journals/jama/fullarticle/2784143" }], people: ["huang-jing-cams"] }),
