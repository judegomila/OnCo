...
const terms: TermInput[] = [
  ...
  term({ id: "prophylactic-cholecystectomy", wikipediaChecked: "2026-09-25", name: "Prophylactic (preventive) cholecystectomy", aka: ["Preventive cholecystectomy", "Chilean GES cholecystectomy programme"], category: "Epidemiology & prevention",
...
const trialPapers: PaperInput[] = [
  ...
  p({ id: "paper-swog-s0809-adjuvant-chemoradiation-jco-2015", name: "SWOG S0809: A Phase II Intergroup Trial of Adjuvant Capecitabine and Gemcitabine Followed by Radiotherapy and Concurrent Capecitabine in Extrahepatic Cholangiocarcinoma and Gallbladder Carcinoma",
    ...
    cancers: [GB, "extrahepatic-cholangiocarcinoma"], drugs: ["gemcitabine", "capecitabine"], trials: ["swog-s0809"], terms: ["chemoradiation", "radiotherapy"], companies: ["swog"], journals: ["jco"], bottlenecks: ["b-surgery-radiation-innovation"] }),
