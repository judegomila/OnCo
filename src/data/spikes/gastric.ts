...
const ESMO_GASTRIC = "https://www.esmo.org/guidelines/guidelines-by-topic/esmo-clinical-practice-guidelines-gastrointestinal-cancers/";
...
const trials: TrialInput[] = [
  t({ id: "toga", name: "ToGA", nct: "NCT01041404", phase: "3", status: "positive", yearReported: 2010, sponsor: "Roche", enrolled: 594,
    ...
    drugs: ["trastuzumab"], cancers: ["gastric"], targets: ["her2"], links: [ct("NCT01041404")], people: ["shitara-kohei", "bang-yung-jue"] }),
  t({ id: "checkmate-649", name: "CheckMate 649", nct: "NCT02872116", phase: "3", status: "positive", yearReported: 2020, sponsor: "BMS", enrolled: 1581,
    ...
    drugs: ["nivolumab", "capox", "folfox"], cancers: ["gastric", "esophageal"], targets: ["pd1", "pdl1"], terms: ["cps"], links: [ct("NCT02872116"), { label: "5-year follow-up, Annals of Oncology 2026", url: "https://www.annalsofoncology.org/article/S0923-7534(26)00059-1/fulltext" }], people: ["kang-won-ki", "jaffer-ajani", "yelena-janjigian"] }),
  t({ id: "keynote-859", name: "KEYNOTE-859", nct: "NCT03675737", phase: "3", status: "positive", yearReported: 2023, sponsor: "Merck", enrolled: 1579,
    ...
    drugs: ["pembrolizumab"], cancers: ["gastric"], targets: ["pd1"], terms: ["cps"], links: [ct("NCT03675737")], people: ["rha-sun-young"] }),
  ...
  t({ id: "destiny-gastric04", name: "DESTINY-Gastric04", nct: "NCT04704934", phase: "3", status: "positive", yearReported: 2025, sponsor: "Daiichi Sankyo / AstraZeneca", enrolled: 494,
    ...
    drugs: ["trastuzumab-deruxtecan", "ramucirumab"], cancers: ["gastric"], targets: ["her2"], terms: ["ild"], links: [ct("NCT04704934")], people: ["shitara-kohei"] }),
...
const drugs: DrugInput[] = [
  ...
  d({ id: "bemarituzumab", name: "Bemarituzumab", code: "FPA144", modality: "Monoclonal antibody (anti-FGFR2b)", status: "phase-3",
...
const ideas: IdeaInput[] = [
  { id: "idea-biomarker-quadruplet-gastric", links: [{ label: "ClinicalTrials.gov NCT03504397: SPOTLIGHT & GLOW", url: "https://clinicaltrials.gov/study/NCT03504397" }, { label: "ClinicalTrials.gov NCT02872116: CheckMate 649", url: "https://clinicaltrials.gov/study/NCT02872116" }], kind: "idea", name: "Biomarker-directed first-line quadruplets in gastric cancer", maturity: "early-clinical", asOf,
  ...
  { id: "idea-peritoneal-directed-gastric", links: [{ label: "PHOENIX-GC: intraperitoneal plus intravenous paclitaxel with S-1 versus standard chemotherapy in gastric cancer with peritoneal metastasis (Journal of Clinical Oncology 2018)", url: "https://doi.org/10.1200/JCO.2018.77.8613" }], kind: "idea", name: "Peritoneal-directed therapy for gastric cancer", maturity: "early-clinical", asOf,
