...
const entities: EntityInput[] = [
  ...
  },
  {
    ...
    tldr: "Engineered immune cells delivered directly into the brain or spinal fluid. Some children with an incurable brainstem tumour have had striking, if temporary, responses.",
  ...
  },
  {
    ...
    tldr: "A single change in a histone protein that defines the most lethal childhood brain tumour, and now the target of the first approved drug for it.",
