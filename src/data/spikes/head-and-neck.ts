...
const drugs: DrugInput[] = [
  ...
  d({ id: "ficerafusp-alfa", name: "Ficerafusp alfa", code: "BCA101", modality: "Bifunctional antibody (EGFR × TGF-β trap)", status: "phase-3",
    ...
    summary: "Ficerafusp alfa is developed by Bicara Therapeutics. Phase 1/1b with pembrolizumab in HPV-negative first-line HNSCC showed durable responses at two years (JCO 2025). FORTIFI-HN01 phase 2/3 fixed the dose at 1500 mg; interim analysis expected mid-2027.",
