...
const trials: TrialInput[] = [
  t({ id: "keynote-048", name: "KEYNOTE-048", nct: "NCT02358031", phase: "3", status: "positive", yearReported: 2019, sponsor: "Merck", enrolled: 882,
    ...
    links: [ct("NCT02358031"), { label: "Lancet 2019", url: "https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(19)32591-7/fulltext" }] }),
  t({ id: "keynote-689", name: "KEYNOTE-689", nct: "NCT03765918", phase: "3", status: "positive", yearReported: 2025, sponsor: "Merck", enrolled: 714,
    ...
    links: [ct("NCT03765918"), { label: "FDA approval, Merck", url: "https://www.merck.com/news/fda-approves-keytruda-pembrolizumab-for-pd-l1-resectable-locally-advanced-head-neck-squamous-cell-carcinoma-as-neoadjuvant-treatment-continued-as-adjuvant-treatment-combined-with-radiother/" }] }),
  t({ id: "extreme", name: "EXTREME", nct: "NCT00122460", phase: "3", status: "positive", yearReported: 2008, sponsor: "Merck KGaA", enrolled: 442,
    ...
    summary: "OS 10.1 vs 7.4 months (HR 0.80), NEJM 2008. The first survival gain in this setting in decades and the control arm for KEYNOTE-048.",
    ...
    links: [ct("NCT00122460"), { label: "NEJM 2008", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa0802656" }] }),
  t({ id: "checkmate-141", name: "CheckMate 141", nct: "NCT02105636", phase: "3", status: "positive", yearReported: 2016, sponsor: "BMS", enrolled: 361,
    ...
    summary: "OS 7.5 vs 5.1 months (HR 0.70); 2-year OS 16.9% vs 6.0%. FDA approval November 2016. Quality of life was preserved with nivolumab and deteriorated with chemotherapy.",
  ...
  t({ id: "rtog-0129", name: "RTOG 0129 (HPV analysis)", nct: "NCT00047008", phase: "3", status: "completed", yearReported: 2010, sponsor: "RTOG / NCI", enrolled: 743,
    ...
    links: [ct("NCT00047008"), { label: "NEJM 2010", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa0912217" }] }),
  t({ id: "nrg-hn002-hn005", name: "NRG-HN002 & NRG-HN005 (HPV+ de-escalation)", nct: "NCT03952585", phase: "2/3", status: "mixed", yearReported: 2025, sponsor: "NRG Oncology / NCI",
    ...
    links: [ct("NCT03952585"), { label: "NRG Oncology HN005 summary", url: "https://www.nrgoncology.org/Home/News/Post/treatment-de-intensification-for-early-stage-hpv-positive-oropharyngeal-cancer-nrg-hn005/" }] }),
  t({ id: "javelin-hn-100", name: "JAVELIN Head and Neck 100", nct: "NCT02952586", phase: "3", status: "negative", yearReported: 2020, sponsor: "Merck KGaA / Pfizer", enrolled: 697,
    ...
    summary: "Stopped for futility; PFS HR 1.21. KEYNOTE-412 (pembrolizumab with chemoradiation) also missed its primary endpoint in 2022. Radiation-induced lymphopenia and steroid use are suspected to blunt concurrent immunotherapy, which is why KEYNOTE-689 placed immunotherapy before surgery.",
  ...
  t({ id: "trilynx", name: "TrilynX", nct: "NCT04459715", phase: "3", status: "negative", yearReported: 2024, sponsor: "Merck KGaA (Debiopharm licence)", enrolled: 730,
    ...
    tldr: "A promising phase 2 drug that sensitises tumours to radiation made things worse in phase 3, a reminder that early wins in this disease often do not replicate.",
    summary: "Terminated 24 June 2024 for futility at interim analysis; median EFS 19.4 months with xevinapant versus 33.1 with placebo (JCO 2025), attributed partly to toxicity and treatment interruptions. Followed a phase 2 with a striking OS benefit. Development of xevinapant was discontinued.",
  ...
  t({ id: "jupiter-02", name: "JUPITER-02", nct: "NCT03581786", phase: "3", status: "positive", yearReported: 2021, sponsor: "Junshi / Coherus", enrolled: 289,
    ...
    summary: "PFS HR 0.52; OS benefit confirmed (HR 0.63) with six-year follow-up showing sustained separation. FDA approval 27 October 2023, the first for NPC in the US; EU approval followed. Parallel trials with camrelizumab (CAPTAIN-1st) and tislelizumab (RATIONALE-309) replicated the effect.",
    ...
    links: [ct("NCT03581786"), { label: "6-year update, OncLive", url: "https://www.onclive.com/view/toripalimab-plus-chemo-maintains-survival-benefit-after-6-years-in-recurrent-metastatic-npc" }] }),
  ...
  t({ id: "fortifi-hn01", name: "FORTIFI-HN01", nct: "NCT06788990", phase: "2/3", status: "recruiting", sponsor: "Bicara Therapeutics",
    ...
    summary: "Phase 1/1b two-year data (JCO 2025) reported durable responses in HPV-negative disease. Phase 3 dose fixed at 1500 mg; Bicara expects substantial enrolment by end-2026 and an interim analysis in mid-2027. Excludes HPV-positive oropharyngeal cancer, unlike LiGeR-HN1.",
...
const drugs: DrugInput[] = [
  ...
  d({ id: "petosemtamab", name: "Petosemtamab", code: "MCLA-158", modality: "Bispecific antibody (EGFR × LGR5)", status: "phase-3",
    ...
    summary: "Merus Biclonics antibody; Breakthrough Therapy designation. Phase 2 with pembrolizumab in first-line PD-L1-positive HNSCC: ORR ~63%; monotherapy ORR ~37% in second line. Phase 3 LiGeR-HN1 and LiGeR-HN2 enrolling; also in colorectal cancer. Merus was acquired by Genmab (2025).",
  ...
  d({ id: "ficerafusp-alfa", name: "Ficerafusp alfa", code: "BCA101", modality: "Bifunctional antibody (EGFR × TGF-β trap)", status: "phase-3",
    tldr: "An EGFR antibody fused to a TGF-beta sponge, designed to remove the immune-suppressing signal that keeps HPV-negative throat cancers cold.",
    summary: "Bicara Therapeutics. Phase 1/1b with pembrolizumab in HPV-negative first-line HNSCC showed durable responses at two years (JCO 2025). FORTIFI-HN01 phase 2/3 fixed the dose at 1500 mg; interim analysis expected mid-2027.",
  ...
  d({ id: "cetuximab-sarotalocan", name: "Cetuximab sarotalocan", brand: "Akalux", code: "ASP-1929, RM-1929", modality: "Photoimmunotherapy conjugate (anti-EGFR antibody–IR700 dye)", status: "approved",
    tldr: "An EGFR antibody carrying a light-activated dye: after infusion, a red laser is shone on the tumour and the cells burst. Approved in Japan since 2020.",
    summary: "Rakuten Medical. Approved in Japan (September 2020) for unresectable locally advanced or recurrent head and neck cancer with conditional approval; two global phase 3 trials in locally recurrent HNSCC continue without US approval to date. Also being studied in cutaneous squamous cell carcinoma.",
...
const technologies: TechnologyInput[] = [
  tech({ id: "tors", name: "Transoral robotic surgery (TORS)", sections: ["surgery"], status: "established", since: 2009, wikipedia: W("Transoral_robotic_surgery"),
    tldr: "Removing throat tumours through the mouth with a robot instead of splitting the jaw, allowing many patients to avoid or reduce radiation.",
    ...
    principle: "Da Vinci or Flex robot instruments and 3D endoscope through a mouth retractor, resecting tumour with margins; neck dissection separately.",
    ...
    cancers: ["head-and-neck"], technologies: ["robotic-surgery"], companies: ["intuitive-surgical"] }),
...
const pairings: PairingInput[] = [
  pair({ id: "io-before-surgery-hnscc", name: "Immunotherapy before surgery rather than with chemoradiation (HNSCC)", a: "checkpoint-inhibitor", b: "imrt-igrt", pairingType: "sequence",
    ...
    summary: "KEYNOTE-689 (neoadjuvant + adjuvant pembrolizumab) doubled event-free survival; JAVELIN H&N 100 and KEYNOTE-412 (concurrent with chemoradiation) failed. Radiation-induced lymphopenia, steroids, and the loss of the antigen-rich primary are proposed explanations.",
  ...
  pair({ id: "egfr-bispecific-plus-pd1-hnscc", name: "EGFR-directed bispecific + PD-1 blockade", a: "petosemtamab", b: "pembrolizumab", pairingType: "combination",
    ...
    summary: "Petosemtamab + pembrolizumab ORR ~63% (phase 2) and ficerafusp alfa + pembrolizumab durable responses in HPV-negative disease; both in registrational trials.",
  ...
  pair({ id: "hpv-deescalation-caution", name: "Caution: de-escalating radiation on HPV status alone", a: "hpv-p16", b: "imrt-igrt", pairingType: "caution",
    ...
    summary: "NRG-HN005 (60 Gy arms) and cetuximab-substitution trials (RTOG 1016, De-ESCALaTE) all underperformed standard cisplatin chemoradiation. Response-adapted or ctHPV-DNA-guided selection is the current approach.",
...
const ideas: IdeaInput[] = [
  idea({ id: "idea-cthpv-adapted-deescalation", name: "ctHPV-DNA-adapted de-escalation of chemoradiation", maturity: "early-clinical",
    ...
    summary: "HN005 showed static selection fails. Early clearance of ctHPV-DNA during induction or the first weeks of radiation identifies exceptional responders. Several phase 2 trials (including neoadjuvant chemotherapy with response-adapted radiation) are testing dynamic selection.",
  ...
  idea({ id: "idea-photoimmunotherapy-plus-pd1", name: "Photoimmunotherapy as an in situ vaccine with PD-1 blockade", maturity: "early-clinical",
    ...
    summary: "Cetuximab sarotalocan causes immunogenic cell death and, in animal models, abscopal responses with checkpoint blockade. A phase 2 with pembrolizumab in recurrent HNSCC has been run in the US.",
