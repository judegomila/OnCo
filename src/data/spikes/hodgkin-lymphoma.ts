...
const trials: TrialInput[] = [
  ...
  t({ id: "hd21", name: "GHSG HD21", nct: "NCT02661503", phase: "3", status: "positive", yearReported: 2024, sponsor: "German Hodgkin Study Group", enrolled: 1500,
    ...
    drugs: ["brentuximab-vedotin", "doxorubicin"], cancers: ["hodgkin-lymphoma", "advanced-stage-classical-hodgkin-lymphoma"], technologies: ["pet-adapted-therapy"], institutions: ["gbg"], links: [ct("NCT02661503")], people: ["peter-borchmann"] }),
  ...
  t({ id: "ahod2131", name: "AHOD2131 (COG / NCTN)", nct: "NCT05675410", phase: "3", status: "recruiting", sponsor: "Children's Oncology Group / NCI",
    ...
    drugs: ["brentuximab-vedotin", "nivolumab"], cancers: ["hodgkin-lymphoma", "early-stage-classical-hodgkin-lymphoma"], technologies: ["pet-adapted-therapy"], institutions: ["childrens-oncology-group"], links: [ct("NCT05675410")], people: ["kara-kelly"] }),
