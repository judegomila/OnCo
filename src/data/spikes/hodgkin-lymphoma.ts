...
const trials: TrialInput[] = [
  t({ id: "echelon-1", name: "ECHELON-1", nct: "NCT01712490", phase: "3", status: "positive", yearReported: 2017, sponsor: "Seagen / Takeda", enrolled: 1334,
    ...
    drugs: ["brentuximab-vedotin", "doxorubicin"], cancers: ["hodgkin-lymphoma", "advanced-stage-classical-hodgkin-lymphoma"], targets: ["cd30"], technologies: ["adc"], links: [ct("NCT01712490")], people: ["joseph-connors"] }),
  t({ id: "swog-s1826", name: "SWOG S1826", nct: "NCT03907488", phase: "3", status: "positive", yearReported: 2023, sponsor: "SWOG / NCI (with COG)", enrolled: 994,
    ...
    drugs: ["nivolumab", "brentuximab-vedotin", "doxorubicin"], cancers: ["hodgkin-lymphoma", "advanced-stage-classical-hodgkin-lymphoma"], targets: ["pd1"], technologies: ["checkpoint-inhibitor"], companies: ["swog", "childrens-oncology-group"], links: [ct("NCT03907488"), { label: "FDA approval (Mar 2026)", url: "https://www.targetedonc.com/view/fda-approves-nivolumab-plus-avd-for-classical-hodgkin-lymphoma" }], people: ["kara-kelly", "alex-herrera"], related: ["src-targeted-oncology"] }),
  t({ id: "hd21", name: "GHSG HD21", nct: "NCT02661503", phase: "3", status: "positive", yearReported: 2024, sponsor: "German Hodgkin Study Group", enrolled: 1500,
    ...
    outcomes: [{ endpoint: "Progression-free survival at 4 years", primary: true, unit: "%", arms: [{ name: "BrECADD", n: 742, value: 94.3 }, { name: "eBEACOPP", n: 740, value: 90.9 }], hr: 0.66, ci: [0.45, 0.97], source: "https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(24)01315-1/fulltext" }, { endpoint: "Treatment-related morbidity", unit: "%", arms: [{ name: "BrECADD", value: 42 }, { name: "eBEACOPP", value: 59 }], source: "https://doi.org/10.1016/S0140-6736(24)01315-1" }],
    drugs: ["brentuximab-vedotin", "doxorubicin"], cancers: ["hodgkin-lymphoma", "advanced-stage-classical-hodgkin-lymphoma"], technologies: ["pet-adapted-therapy"], companies: ["gbg"], links: [ct("NCT02661503")], people: ["peter-borchmann"] }),
  t({ id: "rathl", drugs: ["bleomycin"], name: "RATHL", nct: "NCT00678327", phase: "3", status: "positive", yearReported: 2016, sponsor: "UK NCRI / Cancer Research UK", enrolled: 1214,
    ...
    cancers: ["hodgkin-lymphoma", "advanced-stage-classical-hodgkin-lymphoma"], technologies: ["pet-adapted-therapy", "fdg-pet"], terms: ["deauville-score"], institutions: ["cruk"], links: [ct("NCT00678327")], people: ["peter-johnson"] }),
  t({ id: "keynote-204", technologies: ["checkpoint-inhibitor"], name: "KEYNOTE-204", nct: "NCT02684292", phase: "3", status: "positive", yearReported: 2020, sponsor: "Merck", enrolled: 304,
    ...
    drugs: ["pembrolizumab", "brentuximab-vedotin"], cancers: ["hodgkin-lymphoma", "relapsed-refractory-hodgkin-lymphoma"], links: [ct("NCT02684292")] }),
  t({ id: "checkmate-205", technologies: ["checkpoint-inhibitor"], name: "CheckMate 205", nct: "NCT02181738", phase: "2", status: "positive", yearReported: 2016, sponsor: "BMS", enrolled: 243,
    ...
    result: "ORR 69%.",
    outcomes: [{ endpoint: "Objective response rate", primary: true, unit: "%", arms: [{ name: "Nivolumab", n: 243, value: 69 }], source: "https://doi.org/10.1200/JCO.2017.76.0793" }],
    drugs: ["nivolumab"], cancers: ["hodgkin-lymphoma", "relapsed-refractory-hodgkin-lymphoma"], links: [ct("NCT02181738")] }),
  t({ id: "ahod2131", name: "AHOD2131 (COG / NCTN)", nct: "NCT05675410", phase: "3", status: "recruiting", sponsor: "Children's Oncology Group / NCI",
    ...
    drugs: ["brentuximab-vedotin", "nivolumab"], cancers: ["hodgkin-lymphoma", "early-stage-classical-hodgkin-lymphoma"], technologies: ["pet-adapted-therapy"], companies: ["childrens-oncology-group"], links: [ct("NCT05675410")], people: ["kara-kelly"] }),
  t({ id: "aethera", name: "AETHERA", nct: "NCT01100502", phase: "3", status: "positive", yearReported: 2015, sponsor: "Seagen", enrolled: 329,
    ...
    drugs: ["brentuximab-vedotin"], cancers: ["hodgkin-lymphoma", "relapsed-refractory-hodgkin-lymphoma"], technologies: ["autologous-stem-cell-transplant"], links: [ct("NCT01100502")] }),
];
...
const spike: Spike = {
  ...
  patch: {
    ...
    companies: ["bms", "merck", "pfizer", "takeda", "swog", "childrens-oncology-group", "gbg"],
    institutions: ["cruk", "mskcc", "dana-farber"],
