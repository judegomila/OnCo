...
import prostateEvidence from "./prostate-evidence";
import prostateUk from "./prostate-uk";
import breastUk from "./breast-uk";
import skinUk from "./skin-uk";
import prostateMolecular from "./prostate-molecular";
...
import tnbcEvidence from "./tnbc-evidence";
import tnbcCore from "./tnbc-core";
import tnbcLiving from "./tnbc-living";
...
import pancreaticMolecular from "./pancreatic-molecular";
import colorectalTreatment from "./colorectal-treatment";
...
import lungCore, { nsclcCoreSpike, sclcTaxonomySpike } from "./lung-core";
import lungLiving, { nsclcLivingSpike, sclcLivingSpike } from "./lung-living";
import lungEvidence from "./lung-evidence";
import lungMolecular from "./lung-molecular";
import lungTreatment from "./lung-treatment";
import prostateCore, { prostateLowRiskSpike, prostateIntermediateRiskSpike, prostateHighRiskSpike, prostateBcrSpike, prostateMhspcSpike, prostateNmcrpcSpike, prostateMcrpcSpike, prostateNepcSpike } from "./prostate-core";
import prostateLiving from "./prostate-living";
import prostateTreatment from "./prostate-treatment";
import breastCore, { breastCoreHrPositiveSpike, breastCoreHer2PositiveSpike, breastCoreTnbcSpike, breastCoreDcisSpike, breastCoreLcisSpike, breastCoreNstSpike } from "./breast-core";
import prostateGlossary, { prostateGlossaryLowRiskSpike, prostateGlossaryIntermediateRiskSpike, prostateGlossaryHighRiskSpike, prostateGlossaryBcrSpike, prostateGlossaryMhspcSpike, prostateGlossaryNmcrpcSpike, prostateGlossaryMcrpcSpike, prostateGlossaryNepcSpike } from "./prostate-glossary";
import breastTreatment from "./breast-treatment";
import breastLiving from "./breast-living";
import skinLiving, { bccLivingSpike, csccLivingSpike } from "./skin-living";
import skinCore, { skinCoreBccSpike, skinCoreCsccSpike, skinCoreMerkelSpike } from "./skin-core";
import skinTreatment, { bccTreatmentSpike, csccTreatmentSpike, merkelTreatmentSpike, laBccTreatmentSpike, advCsccTreatmentSpike } from "./skin-treatment";
const spikes: Spike[] = [nsclc, prostate, pancreatic, pancreaticCore, pancreaticUk, glioblastoma, breastHr, breastHer2, hcc, cholangiocarcinoma, neuroendocrine, melanoma, headAndNeck, thyroid, colorectal, gastric, esophageal, sclc, mesothelioma, urothelial, rcc, ovarian, endometrial, cervical, aml, allLeukemia, cll, dlbcl, multipleMyeloma, hodgkin, sarcoma, neuroblastoma, tnbcCore, tnbcEvidence, tnbcUk, tnbcLiving, tnbcMolecular, tnbcTreatment, pancreaticLiving, pancreaticEvidence, pancreaticTreatment, pancreaticMolecular, colorectalLiving, colorectalUk, colorectalMolecular, colorectalEvidence, colorectalTreatment, colorectalCore, gallbladderCore, gallbladderLiving, gallbladderMolecular, gallbladderUk, gallbladderTreatment, gallbladderGeography, gallbladderEvidence, lungCore, nsclcCoreSpike, sclcTaxonomySpike, lungLiving, nsclcLivingSpike, sclcLivingSpike, lungEvidence, lungMolecular, lungTreatment, lungUk, prostateCore, prostateLowRiskSpike, prostateIntermediateRiskSpike, prostateHighRiskSpike, prostateBcrSpike, prostateMhspcSpike, prostateNmcrpcSpike, prostateMcrpcSpike, prostateNepcSpike, prostateLiving, prostateEvidence, prostateTreatment, prostateUk, prostateGlossary, prostateGlossaryLowRiskSpike, prostateGlossaryIntermediateRiskSpike, prostateGlossaryHighRiskSpike, prostateGlossaryBcrSpike, prostateGlossaryMhspcSpike, prostateGlossaryNmcrpcSpike, prostateGlossaryMcrpcSpike, prostateGlossaryNepcSpike, prostateMolecular, breastCore, breastCoreHrPositiveSpike, breastCoreHer2PositiveSpike, breastCoreTnbcSpike, breastCoreDcisSpike, breastCoreLcisSpike, breastCoreNstSpike, breastTreatment, breastLiving, breastUk, skinLiving, bccLivingSpike, csccLivingSpike, skinCore, skinCoreBccSpike, skinCoreCsccSpike, skinCoreMerkelSpike, skinTreatment, bccTreatmentSpike, csccTreatmentSpike, merkelTreatmentSpike, laBccTreatmentSpike, advCsccTreatmentSpike, skinUk];
