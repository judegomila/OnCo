...
const trials: TrialInput[] = [
  t({ id: "keynote-006", keyPapers: ["paper-keynote-006-pembrolizumab-ipilimumab-melanoma-nejm-2015"], name: "KEYNOTE-006", nct: "NCT01866319", phase: "3", status: "positive", yearReported: 2015, sponsor: "Merck", enrolled: 834,
    ...
    drugs: ["pembrolizumab", "ipilimumab"], targets: ["pd1", "ctla4"], cancers: ["melanoma", "advanced-melanoma"], technologies: ["checkpoint-inhibitor"],
  ...
  t({ id: "relativity-047", technologies: ["checkpoint-inhibitor"], name: "RELATIVITY-047", nct: "NCT03470922", phase: "2/3", status: "positive", yearReported: 2022, sponsor: "BMS", enrolled: 714,
    ...
    drugs: ["relatlimab-nivolumab", "nivolumab"], targets: ["lag3", "pd1"], cancers: ["melanoma", "advanced-melanoma"], trials: ["checkmate-067"],
  ...
  t({ id: "nadina", technologies: ["checkpoint-inhibitor"], name: "NADINA", nct: "NCT04949113", phase: "3", status: "positive", yearReported: 2024, sponsor: "Netherlands Cancer Institute / Melanoma Institute Australia", enrolled: 423,
    ...
    drugs: ["nivolumab", "ipilimumab"], targets: ["pd1", "ctla4"], cancers: ["melanoma", "stage-iii-melanoma"], terms: ["neoadjuvant-adjuvant", "efs", "major-pathological-response"], institutions: ["nki"],
    links: [ct("NCT04949113"), { label: "NEJM 2024", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2402604" }], people: ["georgina-long", "christian-blank"] }),
  t({ id: "swog-s1801", technologies: ["checkpoint-inhibitor"], name: "SWOG S1801", nct: "NCT03698019", phase: "2", status: "positive", yearReported: 2022, sponsor: "SWOG / NCI", enrolled: 313,
    ...
    drugs: ["pembrolizumab"], targets: ["pd1"], cancers: ["melanoma", "stage-iii-melanoma"], terms: ["neoadjuvant-adjuvant"], institutions: ["swog"],
    links: [ct("NCT03698019"), { label: "NEJM 2023", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2211437" }], people: ["sapna-patel"] }),
  t({ id: "keynote-716", technologies: ["checkpoint-inhibitor"], name: "KEYNOTE-716", nct: "NCT03553836", phase: "3", status: "positive", yearReported: 2021, sponsor: "Merck", enrolled: 976,
    ...
    drugs: ["pembrolizumab"], cancers: ["melanoma", "stage-ii-melanoma"], terms: ["efs"],
  ...
  t({ id: "combi-ad", technologies: ["kinase-inhibitors"], name: "COMBI-AD", nct: "NCT01682083", phase: "3", status: "positive", yearReported: 2017, sponsor: "Novartis", enrolled: 870,
    ...
    drugs: ["dabrafenib-trametinib"], targets: ["braf"], cancers: ["melanoma", "braf-v600-melanoma", "stage-iii-melanoma"], pathways: ["ras-mapk"],
  ...
  t({ id: "columbus", technologies: ["kinase-inhibitors"], name: "COLUMBUS", nct: "NCT01909453", phase: "3", status: "positive", yearReported: 2018, sponsor: "Array / Pfizer", enrolled: 577,
    ...
    drugs: ["encorafenib", "binimetinib", "vemurafenib"], targets: ["braf"], cancers: ["melanoma", "braf-v600-melanoma", "advanced-melanoma"], pathways: ["ras-mapk"],
  ...
  t({ id: "dreamseq", technologies: ["checkpoint-inhibitor"], name: "DREAMseq (ECOG-ACRIN EA6134)", nct: "NCT02224781", phase: "3", status: "positive", yearReported: 2021, sponsor: "ECOG-ACRIN / NCI", enrolled: 267,
    ...
    drugs: ["nivolumab", "ipilimumab", "dabrafenib-trametinib"], targets: ["braf", "pd1", "ctla4"], cancers: ["melanoma", "braf-v600-melanoma", "advanced-melanoma"], institutions: ["ecog-acrin"],
  ...
  t({ id: "c-144-01", name: "C-144-01", nct: "NCT02360579", phase: "2", status: "positive", yearReported: 2021, sponsor: "Iovance", enrolled: 153,
    ...
    drugs: ["lifileucel"], cancers: ["melanoma", "advanced-melanoma"], technologies: ["til-therapy"], companies: ["iovance"],
    links: [ct("NCT02360579")], people: ["amod-sarnaik"] }),
  t({ id: "imcgp100-202", name: "IMCgp100-202", nct: "NCT03070392", phase: "2", status: "positive", yearReported: 2021, sponsor: "Immunocore", enrolled: 378,
  ...
  t({ id: "mslt-ii", name: "MSLT-II", nct: "NCT00297895", phase: "3", status: "positive", yearReported: 2017, sponsor: "John Wayne Cancer Institute / NCI", enrolled: 1939,
    ...
    technologies: ["sentinel-node", "ultrasound"], cancers: ["melanoma", "stage-iii-melanoma"],
  ...
  t({ id: "fianlimab-phase3-melanoma", technologies: ["checkpoint-inhibitor"], name: "Fianlimab + cemiplimab phase 3 (first-line melanoma)", nct: "NCT05352672", phase: "3", status: "negative", yearReported: 2026, sponsor: "Regeneron",
    ...
    drugs: ["fianlimab", "cemiplimab", "pembrolizumab"], targets: ["lag3", "pd1"], cancers: ["melanoma", "advanced-melanoma"], trials: ["relativity-047"], companies: ["regeneron"], tags: ["failure", "lesson:class-effect-not-guaranteed"],
  ...
  t({ id: "relativity-098", technologies: ["checkpoint-inhibitor"], name: "RELATIVITY-098", nct: "NCT05002569", phase: "3", status: "negative", yearReported: 2025, sponsor: "BMS",
...
const drugs: DrugInput[] = [
  d({ id: "vemurafenib", name: "Vemurafenib", brand: "Zelboraf", modality: "Small-molecule kinase inhibitor (BRAF V600)", status: "approved", wikipedia: W("Vemurafenib"),
    ...
    targets: ["braf"], technologies: ["kinase-inhibitors"], companies: ["roche-genentech"], cancers: ["melanoma", "braf-v600-melanoma", "advanced-melanoma"], pathways: ["ras-mapk"], trials: ["columbus", "nct04302025"],
  ...
  d({ id: "binimetinib", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Binimetinib" }], name: "Binimetinib", brand: "Mektovi", modality: "Small-molecule kinase inhibitor (MEK1/2)", status: "approved", wikipedia: W("Binimetinib"),
    ...
    targets: ["braf"], technologies: ["kinase-inhibitors"], companies: ["pfizer"], cancers: ["melanoma", "nsclc", "braf-v600e-nsclc", "braf-v600-melanoma", "advanced-melanoma"], pathways: ["ras-mapk"], drugs: ["encorafenib"], trials: ["columbus", "nct05270044", "nct04657991", "nct03947385", "nct05195632"], terms: ["ocular-toxicity"] }),
  d({ id: "cobimetinib", trials: ["nct04302025", "nct07449754", "nct04931342"], links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Cobimetinib" }], name: "Cobimetinib", brand: "Cotellic", modality: "Small-molecule kinase inhibitor (MEK1/2)", status: "approved", wikipedia: W("Cobimetinib"),
  ...
  d({ id: "fianlimab", name: "Fianlimab", code: "REGN3767", modality: "Monoclonal antibody (anti-LAG-3)", status: "phase-3",
    ...
    targets: ["lag3"], technologies: ["checkpoint-inhibitor"], companies: ["regeneron"], cancers: ["melanoma"], trials: ["fianlimab-phase3-melanoma", "nct06246916", "nct05800015", "nct05608291", "nct05785767", "nct06161441", "nct03916627", "nct06190951", "nct06769698"], drugs: ["cemiplimab"], tags: ["failed-so-far"],
...
const terms: TermInput[] = [
  term({ id: "breslow-thickness", name: "Breslow thickness", category: "Pathology", wikipedia: W("Breslow%27s_depth"),
    ...
    summary: "Breslow thickness is the depth in millimetres to which a melanoma has grown into the skin, measured from the granular layer to the deepest tumour cell, and it is the single strongest predictor of whether the cancer will spread. It drives the T stage within TNM staging, from T1 for lesions of 1 mm or less to T4 for those over 4 mm, and it determines when a sentinel lymph node biopsy is offered, generally from around 0.8 mm or when ulceration is present. Together with ulceration, which upstages within each thickness band, it sets eligibility for adjuvant therapy. Readers meet it on the melanoma page, in the wide local excision entry, and in the dermoscopy, total-body photography and AI skin analysis technology.", cancers: ["melanoma"], terms: ["tnm-staging"], links: [{ label: "Wikipedia", url: W("Breslow%27s_depth") }] }),
...
const pairings: PairingInput[] = [
  pair({ id: "io-first-then-braf-mek", links: [{ label: "ClinicalTrials.gov NCT02224781: DREAMseq (ECOG-ACRIN EA6134)", url: "https://clinicaltrials.gov/study/NCT02224781" }], name: "Immunotherapy first, then BRAF/MEK (BRAF-mutant melanoma)", a: "checkpoint-inhibitor", b: "dabrafenib-trametinib", pairingType: "sequence",
  ...
  pair({ id: "neoadjuvant-io-response-adapted", links: [{ label: "ClinicalTrials.gov NCT04949113: NADINA", url: "https://clinicaltrials.gov/study/NCT04949113" }, { label: "ClinicalTrials.gov NCT03698019: SWOG S1801", url: "https://clinicaltrials.gov/study/NCT03698019" }], name: "Neoadjuvant immunotherapy → response-adapted adjuvant", a: "checkpoint-inhibitor", b: "sentinel-node", pairingType: "sequence",
    tldr: "Treat before surgery, look at the removed tumour, and only continue treatment if the response was incomplete.",
    summary: "This sequence gives immune checkpoint inhibitors before surgery in melanoma, examines the removed tumour and lymph nodes, and continues adjuvant therapy only when the pathological response was incomplete. The intact tumour and nodes supply antigen and T-cell priming, and pathological response is a reliable early read-out that allows treatment to be de-escalated. The phase 3 NADINA trial used two neoadjuvant cycles of nivolumab and ipilimumab, then surgery, then adjuvant therapy only for partial or non-responders, and most patients were spared a year of adjuvant treatment. The phase 2 SWOG S1801 trial showed that pembrolizumab works better when part of the course is given before surgery. The design feeds the idea of pre-surgery platform trials judged on pathological response.",
  ...
  pair({ id: "lag3-adjuvant-caution", links: [{ label: "ClinicalTrials.gov NCT03470922: RELATIVITY-047", url: "https://clinicaltrials.gov/study/NCT03470922" }, { label: "ClinicalTrials.gov NCT05002569: RELATIVITY-098", url: "https://clinicaltrials.gov/study/NCT05002569" }], name: "Caution: LAG-3 blockade outside active disease", a: "relatlimab-nivolumab", b: "fianlimab", pairingType: "caution",
    ...
    summary: "This caution notes that LAG-3 blockade in melanoma has succeeded in only one setting: relatlimab with nivolumab in unresectable, measurable disease, as shown in RELATIVITY-047. The same pairing failed as adjuvant therapy in RELATIVITY-098, and the alternative LAG-3 antibody fianlimab with cemiplimab failed in a first-line phase 3 reported in 2026. LAG-3 is expressed on exhausted T cells inside tumours, so without tumour present, or with different antibody properties and comparators, the effect may vanish. Two negative phase 3 trials against one positive one mean the benefit cannot be assumed to transfer to the adjuvant setting or to a different PD-1 partner.",
...
const ideas: IdeaInput[] = [
  idea({ id: "idea-ctdna-guided-adjuvant-melanoma", links: [{ label: "ClinicalTrials.gov NCT03553836: KEYNOTE-716", url: "https://clinicaltrials.gov/study/NCT03553836" }, { label: "ClinicalTrials.gov NCT04660344: IMvigor011", url: "https://clinicaltrials.gov/study/NCT04660344" }], name: "ctDNA-guided adjuvant therapy in stage II-III melanoma", maturity: "early-clinical",
