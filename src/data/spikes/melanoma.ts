...
const trials: TrialInput[] = [
  ...
  t({ id: "swog-s1801", technologies: ["checkpoint-inhibitor"], name: "SWOG S1801", nct: "NCT03698019", phase: "2", status: "positive", yearReported: 2022, sponsor: "SWOG / NCI", enrolled: 313,
    ...
    drugs: ["pembrolizumab"], targets: ["pd1"], cancers: ["melanoma", "stage-iii-melanoma"], terms: ["neoadjuvant-adjuvant"], companies: ["swog"],
  ...
  t({ id: "dreamseq", technologies: ["checkpoint-inhibitor"], name: "DREAMseq (ECOG-ACRIN EA6134)", nct: "NCT02224781", phase: "3", status: "positive", yearReported: 2021, sponsor: "ECOG-ACRIN / NCI", enrolled: 267,
    ...
    drugs: ["nivolumab", "ipilimumab", "dabrafenib-trametinib"], targets: ["braf", "pd1", "ctla4"], cancers: ["melanoma", "braf-v600-melanoma", "advanced-melanoma"], companies: ["ecog-acrin"],
...
const drugs: DrugInput[] = [
  ...
  d({ id: "binimetinib", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Binimetinib" }], name: "Binimetinib", brand: "Mektovi", modality: "Small-molecule kinase inhibitor (MEK1/2)", status: "approved", wikipedia: W("Binimetinib"),
    ...
    targets: ["braf"], technologies: ["kinase-inhibitors"], companies: ["pfizer"], cancers: ["melanoma", "nsclc", "braf-v600e-nsclc", "braf-v600-melanoma", "advanced-melanoma"], pathways: ["ras-mapk"], drugs: ["encorafenib"], trials: ["columbus", "nct05270044", "nct04657991", "nct03947385", "nct05195632", "nct06159478"], terms: ["ocular-toxicity"] }),
...
const spike: Spike = {
  ...
  patch: {
    ...
    companies: ["bms", "merck", "regeneron", "immunocore", "iovance", "replimune", "moderna", "roche-genentech", "pfizer", "novartis", "immatics", "swog", "ecog-acrin"],
    institutions: ["nki", "moffitt", "ucla-jonsson"],
