...
export const nciPaediatricCancers: CancerInput[] = [
  ...
  c({
    ...
    tldr: "Ependymomas grow from the cells lining the fluid spaces of the brain and spinal cord. Removing the whole tumour, followed by precisely targeted radiotherapy, cures many children; the tumour has been sorted into molecular groups that behave very differently, and the field's work is to match the intensity of treatment to each group and to find the first effective drugs.",
