...
const technologies: TechnologyInput[] = [
  tech({ id: "tandem-transplant", links: [{ label: "ClinicalTrials.gov NCT00567567: COG ANBL0532", url: "https://clinicaltrials.gov/study/NCT00567567" }], name: "Tandem autologous transplant", sections: ["chemotherapy", "cell-therapy"], status: "standard-of-care", since: 2016,
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["autologous-stem-cell-transplant"], trials: ["anbl0532"] }),
...
const terms: TermInput[] = [
  ...
  term({ id: "mycn-amplification", name: "MYCN amplification", category: "Biomarkers", wikipedia: W("N-Myc"),
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], drugs: ["eflornithine", "lorlatinib"], links: [{ label: "Wikipedia", url: W("N-Myc") }] }),
];
...
const drugs: DrugInput[] = [
  d({ id: "dinutuximab", companies: ["united-therapeutics"], links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Dinutuximab/%20dinutuximab%20beta" }], name: "Dinutuximab (ch14.18) / dinutuximab beta", brand: "Unituxin / Qarziba (EU)", modality: "Monoclonal antibody (anti-GD2, chimeric)", status: "approved", wikipedia: W("Dinutuximab"),
    ...
    targets: ["gd2"], technologies: ["monoclonal-antibody"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], trials: ["anbl0032", "hr-nbl1"], terms: ["adcc"] }),
  d({ id: "naxitamab", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Naxitamab" }], name: "Naxitamab", brand: "Danyelza", modality: "Monoclonal antibody (anti-GD2, humanised)", status: "approved", wikipedia: W("Naxitamab"),
    ...
    targets: ["gd2"], technologies: ["monoclonal-antibody"], companies: ["y-mabs"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], trials: ["naxitamab-201"] }),
  d({ id: "eflornithine", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Eflornithine" }], name: "Eflornithine (DFMO)", brand: "Iwilfin", modality: "Small-molecule ornithine decarboxylase inhibitor", status: "approved", wikipedia: W("Eflornithine"),
    ...
    companies: ["us-worldmeds"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], terms: ["mycn-amplification"], trials: ["nmtrc003", "nct07287917"] }),
  d({ id: "i131-mibg", terms: ["radioiodine-term"], related: ["lutathera"], aka: ["Iobenguane I-131 (therapeutic)", "131I-MIBG", "Ultratrace iobenguane", "iobenguane-i-131"], brand: "Azedra", companies: ["lantheus"], name: "131I-MIBG (iobenguane I-131) therapy", modality: "Radioligand therapy (beta, norepinephrine transporter)", status: "established", wikipedia: W("Iobenguane"), tags: ["nci-list"],
    tldr: "High-dose radioactive MIBG delivers radiation from inside neuroblastoma cells that take up noradrenaline; used for relapsed disease and tested in upfront therapy. A branded high-specific-activity form, Azedra, was approved for phaeochromocytoma and paraganglioma in 2018 and discontinued in 2024.",
    summary: "Response rate ~30-40% in relapsed/refractory MIBG-avid neuroblastoma (NANT, COG studies), with myelosuppression requiring stem-cell support at ≥12 mCi/kg. COG ANBL1531 randomised 131I-MIBG added to induction (primary results pending 2026).\n\nHigh-specific-activity iobenguane I-131 (Azedra, Progenics then Lantheus) was approved by the FDA in July 2018 for adults and children aged 12 and over with iobenguane scan-positive, unresectable, locally advanced or metastatic phaeochromocytoma or paraganglioma requiring systemic therapy, on a single-arm phase 2 study in which a quarter of patients halved their antihypertensive medication for at least six months and most had tumour control; it was the first approved therapy for these tumours. Lantheus discontinued manufacture in 2024, so patients rely on compounded low-specific-activity 131I-MIBG or lutetium-177 dotatate. Myelosuppression, secondary MDS and leukaemia, hypothyroidism and renal toxicity are the main risks; the diagnostic-dose iobenguane (AdreView) is an imaging agent covered under MIBG theranostics.",
    approvals: [{ region: "US", year: 2018, indication: "Iobenguane scan-positive unresectable, locally advanced or metastatic phaeochromocytoma or paraganglioma in patients 12 and older (Azedra, high-specific-activity form; discontinued 2024)" }],
    notes: ["Azedra (the approved high-specific-activity product) and compounded 131I-MIBG are one INN, iobenguane I-131, so both are recorded here; the duplicate record iobenguane-i-131 redirects to this page."],
    ...
    technologies: ["mibg-theranostics", "radioligand-therapy"], cancers: ["neuroblastoma", "neuroblastoma-high-risk", "metastatic-ppgl", "neuroendocrine"], trials: ["anbl1531"], links: [{ label: "Wikipedia", url: W("Iobenguane") }, { label: "US label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=all&query=iobenguane" }, { label: "NCI drug page", url: "https://www.cancer.gov/about-cancer/treatment/drugs/iobenguanei131" }] }),
];

// ======================= TRIALS =======================
const trials: TrialInput[] = [
  t({ id: "anbl0032", technologies: ["monoclonal-antibody"], name: "COG ANBL0032", nct: "NCT00026312", phase: "3", status: "positive", yearReported: 2010, sponsor: "Children's Oncology Group", enrolled: 226, enrolledBasis: "randomised",
    enrolledNote: "ClinicalTrials.gov lists 1,449 participants (actual) enrolled over the life of the study; the NEJM 2010 analysis randomised 226 eligible patients.",
  ...
  t({ id: "anbl0532", name: "COG ANBL0532", nct: "NCT00567567", phase: "3", status: "positive", yearReported: 2016, sponsor: "Children's Oncology Group", enrolled: 665,
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["tandem-transplant", "autologous-stem-cell-transplant"], companies: ["childrens-oncology-group"], links: [ct("NCT00567567")], people: ["julie-park"] }),
  t({ id: "hr-nbl1", name: "SIOPEN HR-NBL1", nct: "NCT01704716", phase: "3", status: "mixed", yearReported: 2017, sponsor: "SIOPEN / Children's Cancer and Leukaemia Group", enrolled: 3300,
    ...
    drugs: ["dinutuximab", "busulfan"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["autologous-stem-cell-transplant"], links: [ct("NCT01704716")], people: ["ruth-ladenstein"] }),
  t({ id: "anbl1531", name: "COG ANBL1531", nct: "NCT03126916", phase: "3", status: "active", sponsor: "Children's Oncology Group",
    ...
    drugs: ["i131-mibg", "lorlatinib"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["mibg-theranostics"], targets: ["alk"], companies: ["childrens-oncology-group"], links: [ct("NCT03126916")], people: ["yael-mosse"] }),
  t({ id: "gd2-cart01", name: "GD2-CART01 (Bambino Gesù phase 1/2)", nct: "NCT03373097", phase: "1/2", status: "positive", yearReported: 2023, sponsor: "Ospedale Pediatrico Bambino Gesù", enrolled: 27, enrolledBasis: "treated",
    enrolledNote: "ClinicalTrials.gov lists an estimated 42 participants for the phase 1/2 study, which is still active; the NEJM 2023 paper reports the 27 patients treated.",
    ...
    outcomes: [{ endpoint: "Objective response rate", primary: true, unit: "%", arms: [{ name: "GD2-CART01", n: 27, value: 63 }], source: "https://www.nejm.org/doi/full/10.1056/NEJMoa2210859" }, { endpoint: "Overall survival at 3 years", unit: "%", arms: [{ name: "GD2-CART01", value: 60 }], source: "https://doi.org/10.1056/NEJMoa2210859" }],
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], targets: ["gd2"], technologies: ["car-t", "armored-car"], terms: ["crs"], links: [ct("NCT03373097"), { label: "Nature Medicine 2025 long-term", url: "https://www.nature.com/articles/s41591-025-03513-0" }], people: ["crystal-mackall"] }),
  t({ id: "naxitamab-201", technologies: ["monoclonal-antibody"], name: "Naxitamab Study 201", nct: "NCT03363373", phase: "2", status: "positive", yearReported: 2020, sponsor: "Y-mAbs", enrolled: 74,
    ...
    drugs: ["naxitamab"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], links: [ct("NCT03363373")], people: ["nai-kong-cheung"] }),
  t({ id: "nmtrc003", name: "NMTRC003/003B (DFMO maintenance)", nct: "NCT02395666", phase: "2", status: "positive", yearReported: 2023, sponsor: "Beat Childhood Cancer Consortium", enrolled: 105,
    ...
    drugs: ["eflornithine"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], tags: ["lesson:external-control"], links: [ct("NCT02395666")] }),
];

// ======================= PAIRINGS / IDEAS =======================
const pairings: PairingInput[] = [
  pair({ id: "anti-gd2-plus-chemo-relapse", links: [{ label: "ANBL1221: irinotecan-temozolomide with temsirolimus or dinutuximab in children with refractory or relapsed neuroblastoma (Lancet Oncology 2017)", url: "https://doi.org/10.1016/S1470-2045(17)30355-8" }], name: "Anti-GD2 antibody + irinotecan-temozolomide (chemoimmunotherapy)", a: "dinutuximab", b: "temozolomide", pairingType: "combination",
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], targets: ["gd2"], drugs: ["dinutuximab", "naxitamab", "temozolomide"] }),
  pair({ id: "il2-anti-gd2-caution", links: [{ label: "ClinicalTrials.gov NCT01704716: SIOPEN HR-NBL1", url: "https://clinicaltrials.gov/study/NCT01704716" }], name: "Caution: IL-2 added to anti-GD2 therapy", a: "dinutuximab", b: "cytokine-therapy", pairingType: "caution",
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], drugs: ["dinutuximab"], trials: ["hr-nbl1"] }),
];
...
const ideas: IdeaInput[] = [
  ...
  idea({ id: "idea-mfbg-pet-replaces-mibg", links: [{ label: "Pandit-Taskar et al., Biodistribution and dosimetry of 18F-meta-fluorobenzylguanidine: a first-in-human PET study (Journal of Nuclear Medicine 2017)", url: "https://doi.org/10.2967/jnumed.117.193169" }], name: "18F-MFBG PET replacing 123I-MIBG scintigraphy", maturity: "early-clinical",
...
const spike: Spike = {
  ...
  patch: {
    ...
    standardOfCare: [
      ...
      { setting: "High risk: induction", approach: "5-6 cycles (COG: topotecan-cyclophosphamide × 2 then cisplatin-etoposide, cyclophosphamide-doxorubicin-vincristine; SIOPEN: rapid COJEC); stem-cell harvest; ANBL1531 adds 131I-MIBG (randomised) or lorlatinib (ALK); ANBL17P1 adds dinutuximab to induction.", refs: ["anbl1531", "i131-mibg", "lorlatinib", "dinutuximab", "doxorubicin", "anbl17p1"], guideline: { nccn: "COG ANBL1531 backbone", version: "COG 2026" } },
    ...
    companies: ["y-mabs", "us-worldmeds", "childrens-oncology-group"],
    institutions: ["mskcc", "dana-farber", "stanford", "city-of-hope"],
