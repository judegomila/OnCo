...
const trials: TrialInput[] = [
  t({ id: "anbl0032", technologies: ["monoclonal-antibody"], name: "COG ANBL0032", nct: "NCT00026312", phase: "3", status: "positive", yearReported: 2010, sponsor: "Children's Oncology Group", enrolled: 226, enrolledBasis: "randomised",
    ...
    drugs: ["dinutuximab", "isotretinoin"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], targets: ["gd2"], institutions: ["childrens-oncology-group"], links: [ct("NCT00026312")], people: ["alice-yu", "julie-park"] }),
  t({ id: "anbl0532", name: "COG ANBL0532", nct: "NCT00567567", phase: "3", status: "positive", yearReported: 2016, sponsor: "Children's Oncology Group", enrolled: 665,
    ...
    cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["tandem-transplant", "autologous-stem-cell-transplant"], institutions: ["childrens-oncology-group"], links: [ct("NCT00567567")], people: ["julie-park"] }),
  ...
  t({ id: "anbl1531", name: "COG ANBL1531", nct: "NCT03126916", phase: "3", status: "active", sponsor: "Children's Oncology Group",
    ...
    drugs: ["i131-mibg", "lorlatinib"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["mibg-theranostics"], targets: ["alk"], institutions: ["childrens-oncology-group"], links: [ct("NCT03126916")], people: ["yael-mosse"] }),
