...
const drugs: DrugInput[] = [
  ...
  d({ id: "i131-mibg", companies: ["lantheus"], name: "131I-MIBG (iobenguane I-131) therapy", modality: "Radioligand therapy (beta, norepinephrine transporter)", status: "established", wikipedia: W("Iobenguane"),
...
const trials: TrialInput[] = [
  ...
  t({ id: "anbl1531", name: "COG ANBL1531", nct: "NCT03126916", phase: "3", status: "active", sponsor: "Children's Oncology Group",
    ...
    drugs: ["i131-mibg", "lorlatinib", "iobenguane-i-131"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["mibg-theranostics"], targets: ["alk"], institutions: ["childrens-oncology-group"], links: [ct("NCT03126916")], people: ["yael-mosse"] }),
