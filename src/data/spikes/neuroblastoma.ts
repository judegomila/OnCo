...
const trials: TrialInput[] = [
  t({ id: "anbl0032", name: "COG ANBL0032", nct: "NCT00026312", phase: "3", status: "positive", yearReported: 2010, sponsor: "Children's Oncology Group", enrolled: 226, enrolledBasis: "randomised",
    ...
    drugs: ["dinutuximab"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], targets: ["gd2"], institutions: ["childrens-oncology-group"], links: [ct("NCT00026312")], people: ["alice-yu", "julie-park"] }),
  ...
  t({ id: "hr-nbl1", name: "SIOPEN HR-NBL1", nct: "NCT01704716", phase: "3", status: "mixed", yearReported: 2017, sponsor: "SIOPEN / Children's Cancer and Leukaemia Group", enrolled: 3300,
    ...
    drugs: ["dinutuximab"], cancers: ["neuroblastoma", "neuroblastoma-high-risk"], technologies: ["autologous-stem-cell-transplant"], links: [ct("NCT01704716")], people: ["ruth-ladenstein"] }),
