...
const targets: TargetInput[] = [
  tg({ id: "gd2", name: "GD2 (disialoganglioside)", symbol: "GD2 (B4GALNT1 product)", targetClass: "surface-antigen", wikipedia: W("GD2"),
    tldr: "A sugar-fat molecule on the surface of neuroblastoma cells (and some other childhood and adult tumours) with almost none on normal tissue except nerves, which is why anti-GD2 drugs cause pain.",
...
const terms: TermInput[] = [
  term({ id: "inrg-staging", name: "INRG staging and risk groups", category: "Clinical", wikipedia: W("Neuroblastoma#Staging"),
    tldr: "The international system that sorts neuroblastoma into very-low, low, intermediate and high risk using age, spread, MYCN status and tumour biology.",
...
const drugs: DrugInput[] = [
  ...
  d({ id: "naxitamab", name: "Naxitamab", brand: "Danyelza", modality: "Monoclonal antibody (anti-GD2, humanised)", status: "approved", wikipedia: W("Naxitamab"),
    tldr: "A humanised anti-GD2 antibody from Memorial Sloan Kettering, given as an outpatient with GM-CSF for relapsed neuroblastoma in bone or marrow.",
  ...
  d({ id: "eflornithine", name: "Eflornithine (DFMO)", brand: "Iwilfin", modality: "Small-molecule ornithine decarboxylase inhibitor", status: "approved", wikipedia: W("Eflornithine"),
    tldr: "An old sleeping-sickness drug repurposed as the first oral maintenance therapy for high-risk neuroblastoma, approved in December 2023 to reduce relapse after immunotherapy.",
...
const trials: TrialInput[] = [
  t({ id: "anbl0032", name: "COG ANBL0032", nct: "NCT00026312", phase: "3", status: "positive", yearReported: 2010, sponsor: "Children's Oncology Group", enrolled: 226,
    ...
    summary: "2-year EFS 66% vs 46%; 2-year OS 86% vs 75% (NEJM 2010); long-term 5-year OS 73% vs 57% (Yu 2021). Randomisation stopped early for efficacy; approval 2015.",
  ...
  t({ id: "anbl0532", name: "COG ANBL0532", nct: "NCT00567567", phase: "3", status: "positive", yearReported: 2016, sponsor: "Children's Oncology Group", enrolled: 652,
    ...
    tldr: "Two transplants in a row beat one in high-risk neuroblastoma.",
    summary: "3-year EFS 61.6% vs 48.4% (JAMA 2019); with subsequent anti-GD2 immunotherapy, 3-year EFS 73.7% vs 56.0%. OS not significantly different at 3 years. Tandem transplant became the North American standard.",
  ...
  t({ id: "anbl1531", name: "COG ANBL1531", nct: "NCT03126916", phase: "3", status: "active", sponsor: "Children's Oncology Group",
    ...
    tldr: "The current North American high-risk trial: adding targeted radiation during induction, and an ALK pill for children whose tumours carry ALK mutations.",
  ...
  t({ id: "gd2-cart01", name: "GD2-CART01 (Bambino Gesù phase 1/2)", nct: "NCT03373097", phase: "1/2", status: "positive", yearReported: 2023, sponsor: "Ospedale Pediatrico Bambino Gesù", enrolled: 27,
    ...
    tldr: "The first CAR-T to produce durable complete remissions in a childhood solid tumour: two-thirds responded and a third achieved complete remission.",
  ...
  t({ id: "naxitamab-201", name: "Naxitamab Study 201", nct: "NCT03363373", phase: "2", status: "positive", yearReported: 2020, sponsor: "Y-mAbs", enrolled: 74,
    ...
    tldr: "The pivotal single-arm study behind naxitamab's approval.",
  ...
  t({ id: "nmtrc003", name: "NMTRC003/003B (DFMO maintenance)", nct: "NCT02395666", phase: "2", status: "positive", yearReported: 2023, sponsor: "Beat Childhood Cancer Consortium", enrolled: 105,
    ...
    tldr: "The single-arm study, compared against historical patients, that got eflornithine approved as maintenance; the design remains debated.",
    summary: "EFS HR 0.48 and OS HR 0.32 versus a propensity-matched external control from ANBL0032. FDA approved December 2023 acknowledging the externally controlled design in a rare paediatric setting. A randomised trial has not been done.",
...
const ideas: IdeaInput[] = [
  ...
  idea({ id: "idea-mfbg-pet-replaces-mibg", name: "18F-MFBG PET replacing 123I-MIBG scintigraphy", maturity: "early-clinical",
    ...
    rationale: "Same norepinephrine-transporter biology with PET resolution and 18F logistics.",
