...
const technologies: TechnologyInput[] = [
  ...
  tech({ id: "prrt", trials: ["netter-1"], dependsOn: ["radioligand-therapy", "sstr-pet"], name: "Peptide receptor radionuclide therapy (PRRT)", sections: ["radiopharma"], status: "approved", since: 2018, wikipedia: W("Peptide_receptor_radionuclide_therapy"),
...
const terms: TermInput[] = [
  term({ id: "net-grade-ki67", name: "Neuroendocrine tumour grade (Ki-67) and WHO classification", category: "Pathology", wikipedia: W("Neuroendocrine_tumor"),
    ...
    cancers: ["neuroendocrine", "sclc", "grade-3-net", "extrapulmonary-nec"], technologies: ["histopathology-ihc"], links: [{ label: "Wikipedia", url: W("Neuroendocrine_tumor") }] }),
  ...
  term({ id: "carcinoid-syndrome", name: "Carcinoid syndrome and carcinoid heart disease", category: "Clinical", wikipedia: W("Carcinoid_syndrome"),
    ...
    cancers: ["neuroendocrine", "small-intestinal-net"], drugs: ["octreotide-lanreotide"], links: [{ label: "Wikipedia", url: W("Carcinoid_syndrome") }] }),
  term({ id: "men1-hereditary-net", name: "MEN1 and hereditary neuroendocrine syndromes", category: "Genomics", wikipedia: W("Multiple_endocrine_neoplasia_type_1"),
    ...
    cancers: ["neuroendocrine", "pancreatic-net"], targets: ["menin", "hif2a"], drugs: ["belzutifan"], technologies: ["germline-testing"], links: [{ label: "Wikipedia", url: W("Multiple_endocrine_neoplasia_type_1") }] }),
];
...
const drugs: DrugInput[] = [
  d({ id: "octreotide-lanreotide", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Somatostatin%20analogues" }], name: "Somatostatin analogues (octreotide, lanreotide)", aka: ["Octreotide", "Lanreotide", "Octreotide LAR", "Somatostatin analogue"], brand: "Sandostatin LAR, Somatuline Depot", modality: "Peptide hormone analogue (SSTR2 agonist)", status: "approved", wikipedia: W("Octreotide"),
    ...
    targets: ["sstr2"], companies: ["novartis", "ipsen"], cancers: ["neuroendocrine", "small-intestinal-net", "pancreatic-net", "lung-net", "thymoma"], trials: ["promid", "clarinet", "netter-1"], terms: ["carcinoid-syndrome", "prrt-term"] }),
  ...
  d({ id: "sunitinib", trials: ["nct05043090", "nct05024214", "nct03091192", "nct03673501"], links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Sunitinib" }], name: "Sunitinib", brand: "Sutent", modality: "Small-molecule multi-kinase inhibitor (VEGFR, PDGFR, KIT)", status: "approved", wikipedia: W("Sunitinib"),
    ...
    targets: ["vegf", "kit"], technologies: ["kinase-inhibitors", "antiangiogenic"], companies: ["pfizer"], cancers: ["neuroendocrine", "rcc", "sarcoma", "clear-cell-rcc", "chromophobe-rcc", "thymic-carcinoma", "metastatic-ppgl"] }),
  d({ id: "itm-11", links: [{ label: "ClinicalTrials.gov NCT03049189 (COMPETE)", url: "https://clinicaltrials.gov/study/NCT03049189" }], name: "177Lu-edotreotide", code: "ITM-11, n.c.a. 177Lu-DOTATOC", modality: "Radioligand therapy (beta)", status: "phase-3",
    ...
    targets: ["sstr2"], technologies: ["prrt", "radioligand-therapy"], companies: ["itm"], cancers: ["neuroendocrine", "grade-3-net"], trials: ["compete", "nct04919226"] }),
...
const trials: TrialInput[] = [
  t({ id: "promid", name: "PROMID", nct: "NCT00171873", phase: "3", status: "positive", yearReported: 2009, sponsor: "Novartis / German NET study group", enrolled: 85,
    ...
    drugs: ["octreotide-lanreotide"], cancers: ["neuroendocrine", "small-intestinal-net"], links: [ct("NCT00171873")] }),
  t({ id: "clarinet", name: "CLARINET", nct: "NCT00353496", phase: "3", status: "positive", yearReported: 2014, sponsor: "Ipsen", enrolled: 204,
    ...
    drugs: ["octreotide-lanreotide"], cancers: ["neuroendocrine", "small-intestinal-net", "pancreatic-net"], links: [ct("NCT00353496")], companies: ["ipsen"], people: ["martyn-caplin"] }),
  t({ id: "radiant-3-4", technologies: ["kinase-inhibitors", "pi3k-akt-mtor-inhibitors"], name: "RADIANT-3 and RADIANT-4", nct: "NCT00510068", phase: "3", status: "positive", yearReported: 2011, sponsor: "Novartis", enrolled: 712,
    ...
    outcomes: [{ endpoint: "Progression-free survival (RADIANT-3)", primary: true, unit: "months", arms: [{ name: "Everolimus", n: 207, value: 11.0 }, { name: "Placebo", n: 203, value: 4.6 }], hr: 0.35, ci: [0.27, 0.45], source: "https://doi.org/10.1056/NEJMoa1009290" }, { endpoint: "Progression-free survival (RADIANT-4)", primary: true, unit: "months", arms: [{ name: "Everolimus", n: 205, value: 11.0 }, { name: "Placebo", n: 97, value: 3.9 }], hr: 0.48, ci: [0.35, 0.67], source: "https://doi.org/10.1016/S0140-6736(15)00817-X" }],
    drugs: ["everolimus"], cancers: ["neuroendocrine", "pancreatic-net", "small-intestinal-net", "lung-net"], links: [ct("NCT00510068")], people: ["james-yao"] }),
  t({ id: "cabinet", technologies: ["antiangiogenic", "kinase-inhibitors"], name: "CABINET (Alliance A021602)", nct: "NCT03375320", phase: "3", status: "positive", yearReported: 2024, sponsor: "Alliance / NCI / Exelixis", enrolled: 298,
  ...
  t({ id: "compete", name: "COMPETE", nct: "NCT03049189", phase: "3", status: "positive", yearReported: 2025, sponsor: "ITM Isotope Technologies Munich", enrolled: 324,
    ...
    drugs: ["itm-11", "everolimus"], cancers: ["neuroendocrine", "pancreatic-net", "small-intestinal-net"], targets: ["sstr2"], technologies: ["prrt"], links: [ct("NCT03049189"), { label: "CancerNetwork: COMPETE", url: "https://www.cancernetwork.com/view/itm-11-demonstrates-superior-pfs-vs-everolimus-in-sstr-gep-nets" }], people: ["jonathan-strosberg"], related: ["src-cancer-network"] }),
  ...
  t({ id: "sanet", drugs: ["surufatinib"], name: "SANET-ep and SANET-p", nct: "NCT02588170", phase: "3", status: "positive", yearReported: 2020, sponsor: "Hutchmed", enrolled: 369,
...
const ideas: IdeaInput[] = [
  idea({ id: "idea-net-dosimetry-prrt", trials: ["compete", "nct03972488", "nct04919226", "netter-1"], links: [{ label: "ClinicalTrials.gov NCT03049189: COMPETE", url: "https://clinicaltrials.gov/study/NCT03049189" }], name: "Dosimetry-personalised PRRT instead of four fixed cycles", maturity: "early-clinical",
  ...
  idea({ id: "idea-net-antagonist-ligands", trials: ["alphamedix-02", "compete", "nct04919226"], links: [{ label: "Reidy-Lagunes et al., Phase 1 trial of the SSTR antagonist radioligand 177Lu-satoreotide tetraxetan in neuroendocrine tumours (Clinical Cancer Research 2019)", url: "https://doi.org/10.1158/1078-0432.CCR-19-1026" }], name: "SSTR antagonist radioligands to increase tumour dose", maturity: "early-clinical",
