...
const technologies: TechnologyInput[] = [
  tech({ id: "sstr-pet", name: "Somatostatin receptor PET (68Ga/64Cu-DOTATATE)", sections: ["imaging", "radiopharma"], status: "standard-of-care", since: 2016, wikipedia: W("DOTA-TATE"),
    ...
    cancers: ["neuroendocrine", "sclc"], targets: ["sstr2"], technologies: ["pet", "pet-ct"], drugs: ["lutathera"], terms: ["theranostics"] }),
  tech({ id: "prrt", name: "Peptide receptor radionuclide therapy (PRRT)", sections: ["radiopharma"], status: "approved", since: 2018, wikipedia: W("Peptide_receptor_radionuclide_therapy"),
    ...
    principle: "SSTR2-binding peptide chelated to a therapeutic radionuclide; internalised; beta (177Lu) or alpha (212Pb, 225Ac) emission; usually four cycles.",
    ...
    cancers: ["neuroendocrine"], targets: ["sstr2"], technologies: ["radioligand-therapy", "targeted-alpha-therapy", "sstr-pet"], drugs: ["lutathera", "itm-11", "alphamedix", "ryz101"], companies: ["novartis", "itm", "orano-med", "radiomedix", "rayzebio"] }),
];
...
const terms: TermInput[] = [
  term({ id: "net-grade-ki67", name: "Neuroendocrine tumour grade (Ki-67) and WHO classification", category: "Pathology", wikipedia: W("Neuroendocrine_tumor"),
    ...
    cancers: ["neuroendocrine", "sclc"], technologies: ["histopathology-ihc"] }),
  term({ id: "chromogranin-a", name: "Chromogranin A", category: "Biomarkers", wikipedia: W("Chromogranin_A"),
    tldr: "A protein released by neuroendocrine cells, measured in blood to follow tumour burden; unreliable because acid-reducing drugs and kidney disease also raise it.",
  ...
  term({ id: "carcinoid-syndrome", name: "Carcinoid syndrome and carcinoid heart disease", category: "Clinical", wikipedia: W("Carcinoid_syndrome"),
    ...
    cancers: ["neuroendocrine"], drugs: ["octreotide-lanreotide"] }),
  term({ id: "men1-hereditary-net", name: "MEN1 and hereditary neuroendocrine syndromes", category: "Genomics", wikipedia: W("Multiple_endocrine_neoplasia_type_1"),
    ...
    cancers: ["neuroendocrine"], targets: ["menin", "hif2a"], drugs: ["belzutifan"], technologies: ["germline-testing"] }),
];
...
const drugs: DrugInput[] = [
  ...
  d({ id: "sunitinib", name: "Sunitinib", brand: "Sutent", modality: "Small-molecule multi-kinase inhibitor (VEGFR, PDGFR, KIT)", status: "approved", wikipedia: W("Sunitinib"),
    tldr: "An anti-angiogenic pill approved for pancreatic neuroendocrine tumours, kidney cancer and GIST.",
  ...
  d({ id: "capecitabine-temozolomide", name: "Capecitabine + temozolomide (CAPTEM)", modality: "Oral cytotoxic regimen", status: "established",
    tldr: "An all-oral chemotherapy pair that shrinks pancreatic neuroendocrine tumours in about a third of patients.",
...
const trials: TrialInput[] = [
  ...
  t({ id: "clarinet", name: "CLARINET", nct: "NCT00353496", phase: "3", status: "positive", yearReported: 2014, sponsor: "Ipsen", enrolled: 204,
    ...
    drugs: ["octreotide-lanreotide"], cancers: ["neuroendocrine"], links: [ct("NCT00353496")], companies: ["ipsen"] }),
  t({ id: "radiant-3-4", name: "RADIANT-3 and RADIANT-4", nct: "NCT00510068", phase: "3", status: "positive", yearReported: 2011, sponsor: "Novartis", enrolled: 712,
    ...
    drugs: ["everolimus"], cancers: ["neuroendocrine"], links: [ct("NCT00510068")] }),
  ...
  t({ id: "compete", name: "COMPETE", nct: "NCT03049189", phase: "3", status: "positive", yearReported: 2025, sponsor: "ITM Isotope Technologies Munich", enrolled: 309,
    ...
    drugs: ["itm-11", "everolimus"], cancers: ["neuroendocrine"], targets: ["sstr2"], technologies: ["prrt"], links: [ct("NCT03049189"), { label: "CancerNetwork: COMPETE", url: "https://www.cancernetwork.com/view/itm-11-demonstrates-superior-pfs-vs-everolimus-in-sstr-gep-nets" }] }),
  ...
  t({ id: "sanet", name: "SANET-ep and SANET-p", nct: "NCT02588170", phase: "3", status: "positive", yearReported: 2020, sponsor: "Hutchmed", enrolled: 369,
    ...
    tldr: "A Chinese anti-angiogenic pill slowed both gut and pancreatic neuroendocrine tumours, but its US application was refused.",
...
const pairings: PairingInput[] = [
  pair({ id: "sstr-pet-to-prrt", name: "SSTR PET → PRRT", a: "sstr-pet", b: "prrt", pairingType: "diagnostic-therapeutic",
    tldr: "The original theranostic pair: the scan with the diagnostic isotope decides who gets the same molecule with the therapeutic isotope.",
