...
const backlinkSupplements: Spike["supplements"] = [
  ...
  { id: "early-detection-roadmap", related: [ROADMAP] } satisfies { id: string } & Partial<RoadmapInput>,
...
const spike: Spike = {
  ...
  patch: {
    ...
    history: [
      ...
      { year: 2015, title: "Whole genomes and the classical versus basal-like split", note: "Waddell's 100 genomes tie unstable genomes to BRCA-type defects and platinum response; Moffitt separates tumour from stroma and finds two tumour and two stromal subtypes.", refs: ["paper-waddell-whole-genomes-pancreatic-nature-2015", "paper-moffitt-virtual-microdissection-subtypes-nat-genet-2015"] },
      ...
      { year: 2022, title: "PRODIGE 24 at five years: median survival 53.5 months; CAPS5 finds most cancers at stage I", note: "Adjuvant modified FOLFIRINOX, five-year survival 43.2 versus 31.4 percent. 1,461 high-risk people: 7 of 9 surveillance-detected cancers stage I, median survival 9.8 years.", refs: ["paper-prodige-24-five-year-outcomes-jama-oncol-2022", "paper-dbouk-caps5-stage-survival-jco-2022", "prodige-24"] },
      { year: 2025, title: "PREOPANC-2 leaves the resectable question open; vaccine T cells last years; PANOVA-3 published", note: "Neoadjuvant FOLFIRINOX 21.9 versus 21.3 months against gemcitabine chemoradiotherapy. Sethna: responders' recurrence-free survival not reached at 3.2 years. Tumour treating fields 16.2 versus 14.2 months.", refs: ["paper-preopanc-2-neoadjuvant-folfirinox-vs-chemoradiotherapy-lancet-oncol-2025", "paper-sethna-rna-neoantigen-vaccine-long-lived-t-cells-nature-2025", "paper-panova-3-ttfields-locally-advanced-pancreatic-jco-2025", PANC_IDEAS.neoadjuvant] },
    ],
