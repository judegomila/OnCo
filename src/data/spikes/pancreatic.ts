...
const entities: EntityInput[] = [
  ...
  },
  {
    ...
    technologies: ["cytotoxic-chemotherapy", "topoisomerase-inhibitors", "platinum"], companies: ["ipsen"], cancers: ["pancreatic", "metastatic-pdac"], trials: ["napoli-3", "nct07691593"],
  ...
  // ======================= TRIALS =======================
  {
    ...
    links: [ct("NCT06625320"), { label: "FDA approval notice (26 Aug 2026)", url: "https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-daraxonrasib-metastatic-pancreatic-adenocarcinoma" }, { label: "Revolution Medicines announcement", url: "https://ir.revmed.com/news-releases/news-release-details/daraxonrasib-demonstrates-unprecedented-overall-survival-benefit" }, { label: "JCO abstract LBA5", url: "https://ascopubs.org/doi/10.1200/JCO.2026.44.17_suppl.LBA5" }],
  },
  {
    id: "napoli-3", technologies: ["cytotoxic-chemotherapy", "platinum", "topoisomerase-inhibitors"], kind: "trial", name: "NAPOLI 3", nct: "NCT04083235", phase: "3", status: "positive", yearReported: 2023, sponsor: "Ipsen", asOf,
  ...
  {
    id: "prodige-24", technologies: ["cytotoxic-chemotherapy", "platinum", "topoisomerase-inhibitors"], kind: "trial", name: "PRODIGE 24 / CCTG PA6", nct: "NCT01526135", phase: "3", status: "positive", yearReported: 2018, sponsor: "UNICANCER / CCTG", asOf,
  ...
  {
    id: "preopanc", kind: "trial", name: "PREOPANC-1", nct: "NTR3709", phase: "3", status: "mixed", yearReported: 2022, sponsor: "Dutch Pancreatic Cancer Group", asOf,
    ...
    tldr: "The Dutch trial testing whether treating before surgery beats operating first. Chemoradiation first fell short at the primary analysis but won at five years, with one in five patients alive against one in fifteen.",
    summary: "PREOPANC-1 randomised 246 patients between 2013 and 2017. The primary analysis (JCO 2020) gave median OS 16.0 vs 14.3 months (HR 0.78, p 0.096), short of significance, with a higher R0 resection rate (71% vs 40%) and better disease-free survival; the long-term analysis (JCO 2022, median follow-up 59 months) gave HR 0.73 (p 0.025) and 5-year OS 20.5% vs 6.5%, consistent in resectable and borderline patients. Its successor PREOPANC-2 (Lancet Oncology 2025) found neoadjuvant FOLFIRINOX no better than this regimen (21.9 vs 21.3 months), and PREOPANC-3 and ALLIANCE A021806 now test perioperative against adjuvant mFOLFIRINOX, while NORPACT-1 argued against neoadjuvant treatment for clearly resectable tumours; borderline-resectable disease is generally treated neoadjuvantly.",
    result: "5-year OS 20.5% vs 6.5% (HR 0.73, p 0.025); primary analysis median OS 16.0 vs 14.3 months (HR 0.78, p 0.096).",
    drugs: ["gemcitabine"], cancers: ["pancreatic", "resectable-pdac", "borderline-resectable-pdac"], technologies: ["imrt-igrt", "chemoradiation"], links: [{ label: "PREOPANC-1 primary analysis, JCO 2020 (NTR3709)", url: "https://doi.org/10.1200/JCO.19.02274" }, { label: "PREOPANC-1 long-term results, JCO 2022", url: "https://doi.org/10.1200/JCO.21.02233" }], people: ["marc-besselink"],
  },
  {
  ...
  // ======================= TECHNOLOGIES =======================
  {
    ...
    links: [{ label: "PRECEDE consortium", url: "https://precedestudy.org/" }],
  },
  {
  ...
  // ======================= COMPANIES =======================
  {
    id: "ipsen", wikipedia: "https://en.wikipedia.org/wiki/Ipsen", trials: ["nct04224493", "nct07213830", "nct07213817", "nct06833008", "nct06305247", "nct04243499"], links: [{ label: "Official website", url: "https://www.ipsen.com" }], kind: "company", name: "Ipsen", hq: "Paris", country: "FR", companyType: "pharma", website: "https://www.ipsen.com", ticker: "IPN.PA", asOf,
  ...
  {
    id: "idea-mced-new-onset-diabetes", links: [{ label: "PATHFINDER: the first prospective test of a multi-cancer blood test in people without symptoms (The Lancet 2023)", url: "https://doi.org/10.1016/S0140-6736(23)01700-2" }, { label: "NHS-Galleri: design of the largest randomised trial of a multi-cancer blood test (Cancers 2022)", url: "https://doi.org/10.3390/cancers14194818" }], kind: "idea", name: "Blood-based pancreatic cancer detection in new-onset diabetes", maturity: "early-clinical", asOf,
...
const spike: Spike = {
  ...
  patch: {
    ...
    // Five short rows, one per setting, in the NCCN register. The sourced detail for each setting is in
    // ./pancreatic-treatment.ts (pancreaticStandardOfCare, fourteen rows citing each trial and NICE recommendation);
    // these stay because the decision aid quotes two of them word for word (src/data/decision-tools/pancreatic-first-treatment.ts,
    // QUOTED_PANCREATIC_ROWS) and the sequencing and relevance helpers key on their setting labels (pancreatic QA, 24 Sept 2026).
    standardOfCare: [
      { setting: "High-risk surveillance", approach: "Annual MRI/MRCP or EUS for germline carriers and familial kindreds (CAPS/PRECEDE); germline testing for every diagnosed patient and first-degree relatives.", refs: ["pancreatic-surveillance", "germline-testing", "mri", "precede"] },
      { setting: "Resectable / borderline", approach: "Neoadjuvant mFOLFIRINOX (borderline; increasingly resectable), surgery, then adjuvant mFOLFIRINOX to complete ~6 months (PRODIGE 24); gemcitabine/capecitabine if unfit. Chemoradiation selectively (PREOPANC).", refs: ["folfirinox", "prodige-24", "preopanc", "robotic-surgery"], guideline: { version: "NCCN Guidelines: Pancreatic Adenocarcinoma", url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1455" } },
      { setting: "Locally advanced unresectable", approach: "FOLFIRINOX or gem/nab-paclitaxel; TTFields with gem/nab-paclitaxel (Optune Pax, 2026); SBRT or MR-guided ablative radiotherapy; IRE in selected centres; reassess for conversion surgery.", refs: ["panova-3", "optune", "gemcitabine-nab-paclitaxel", "sbrt"], guideline: { version: "NCCN Guidelines: Pancreatic Adenocarcinoma", url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1455" } },
      { setting: "Metastatic, first line", approach: "mFOLFIRINOX or NALIRIFOX (fit) or gemcitabine/nab-paclitaxel; olaparib maintenance if gBRCA after ≥16 weeks platinum; zenocutuzumab if NRG1 fusion; pembrolizumab if MSI-H; trials of RAS inhibitors + chemotherapy.", refs: ["nalirifox", "napoli-3", "polo", "zoldonrasib"], guideline: { version: "NCCN Guidelines: Pancreatic Adenocarcinoma", url: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1455" } },
      { setting: "Metastatic, second line", approach: "Daraxonrasib after one prior line (FDA approval 26 August 2026; RASolute 302: OS 13.2 vs 6.7 months, HR 0.40); otherwise switch backbone (gem/nab-pac after FOLFIRINOX, or liposomal irinotecan/5-FU after gemcitabine). No European or UK decision on daraxonrasib by 24 September 2026.", refs: ["rasolute-302", "daraxonrasib"] },
    ],
    stateOfArt: [
    ...
    history: [
      ...
      { year: 2025, title: "PANOVA-3 positive; daraxonrasib phase 1/2 OS ~14.5 months", note: "Tumour treating fields with gemcitabine and nab-paclitaxel: 16.2 against 14.2 months in 571 patients with locally advanced disease.", refs: ["panova-3", "daraxonrasib", "paper-panova-3-ttfields-locally-advanced-pancreatic-jco-2025"] },
      { year: 2026, title: "RASolute 302: daraxonrasib OS 13.2 vs 6.7 months (HR 0.40)", note: "ASCO plenary and NEJM; FDA approval of daraxonrasib on 26 August 2026; Optune Pax approved; zoldonrasib combinations reported; AMPLIFY-7P vaccine misses.", refs: ["rasolute-302", "optune", "zoldonrasib", "amplify-7p"] },
    ],
