...
const entities: EntityInput[] = [
  ...
  {
    id: "elironrasib", kind: "drug", name: "Elironrasib", code: "RMC-6291", modality: "Small-molecule RAS(ON) G12C-selective inhibitor", asOf, status: "phase-2",
    tldr: "A next-generation KRAS G12C drug that hits the active form of the protein, from the same company as daraxonrasib.",
    summary: "Tri-complex G12C(ON) inhibitor designed to outperform first-generation OFF-state inhibitors (sotorasib, adagrasib); being tested alone and with daraxonrasib in NSCLC, colorectal, and the ~1-2% of pancreatic cancers with G12C.",
  ...
  {
    id: "amplify-7p", kind: "trial", name: "AMPLIFY-7P", nct: "NCT05726864", phase: "2", status: "negative", yearReported: 2026, sponsor: "Elicio Therapeutics", asOf,
  ...
  // ======================= IDEAS =======================
  {
    ...
    summary: "Surgery remains the only cure. Only ~20% present resectable; another ~30% are borderline or locally advanced. Response rates with daraxonrasib and zoldonrasib combinations exceed those of FOLFIRINOX, and ctDNA clearance is frequent.",
  ...
  },
  {
    ...
    summary: "About 1% of new-onset diabetes after age 50 is caused by an occult pancreatic cancer (~6-8x relative risk in the first 3 years). The END-PAC risk model and the NCI New Onset Diabetes (NOD) cohort define a testable population; MCED, CA19-9 variants, and AI-read CT are candidate tests.",
  ...
  // ======================= PAIRINGS =======================
  {
    ...
    summary: "ESMO GI 2026: 50% ORR and 97% DCR in second-line RAS G12D metastatic PDAC, with a manageable safety profile. Rationale is vertical suppression of adaptive RAS reactivation.",
...
const spike: Spike = {
  ...
  patch: {
    ...
    subtypes: ["Classical (GATA6-high, better prognosis, more chemosensitive)", "Basal-like / squamous (GATA6-low, poor prognosis)", "KRAS-wild-type (~10%; NRG1, NTRK, ALK, BRAF fusions; MSI-H)", "Germline-driven (BRCA2, PALB2, ATM, CDKN2A, STK11)", "Pancreatic neuroendocrine tumours (a different disease; see neuroendocrine)"],
