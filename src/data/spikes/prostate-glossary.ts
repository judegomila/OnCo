...
export const prostateGlossaryTerms: TermInput[] = [
  ...
  { id: "bipolar-androgen-therapy", kind: "term", asOf, tags, name: "Bipolar androgen therapy (BAT)", category: "Treatment jargon",
    ...
    terms: ["castration-resistance", "adt", "psa50", "androgen-deprivation-therapy", "quality-of-life", "intermittent-androgen-deprivation"],
  ...
  { id: "intermittent-androgen-deprivation", kind: "term", asOf, tags, name: "Intermittent androgen deprivation (IAD)", category: "Treatment jargon",
    ...
    terms: ["adt", "androgen-deprivation-therapy", "psa", "quality-of-life", "hazard-ratio", "bipolar-androgen-therapy", "hot-flushes-on-hormone-therapy", "treatment-induced-bone-loss"],
    drugs: ["leuprolide", "bicalutamide"],
    targets: ["androgen-receptor"],
    related: ["paper-hussain-swog-9346-intermittent-androgen-deprivation-nejm-2013", "androgen-deprivation-therapy", "bipolar-androgen-therapy", "idea-prostate-other-cause-mortality-as-a-reported-service-outcome", "idea-bio1-alternating-schedules"],
...
const supplements: SpikeSupplement[] = [
  ...
  { id: "androgen-deprivation-therapy", terms: ["intermittent-androgen-deprivation", "other-cause-mortality"], related: ["intermittent-androgen-deprivation"] },
