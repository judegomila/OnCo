...
const trials: TrialInput[] = [
  t({ id: "checkmate-214", technologies: ["checkpoint-inhibitor"], name: "CheckMate 214", nct: "NCT02231749", phase: "3", status: "positive", yearReported: 2018, sponsor: "BMS", enrolled: 1096,
    ...
    drugs: ["nivolumab", "ipilimumab", "sunitinib"], cancers: ["rcc", "clear-cell-rcc"], terms: ["imdc-risk"], links: [ct("NCT02231749")], people: ["robert-motzer", "laurence-albiges"] }),
  t({ id: "keynote-426", technologies: ["checkpoint-inhibitor"], name: "KEYNOTE-426", nct: "NCT02853331", phase: "3", status: "positive", yearReported: 2019, sponsor: "Merck", enrolled: 861,
    ...
    drugs: ["pembrolizumab", "axitinib", "sunitinib"], cancers: ["rcc", "clear-cell-rcc"], links: [ct("NCT02853331")], people: ["thomas-powles", "brian-rini", "lee-jae-lyun"] }),
  t({ id: "checkmate-9er", technologies: ["checkpoint-inhibitor"], name: "CheckMate 9ER", nct: "NCT03141177", phase: "3", status: "positive", yearReported: 2020, sponsor: "BMS / Exelixis", enrolled: 701,
  ...
  t({ id: "clear", technologies: ["antiangiogenic", "kinase-inhibitors"], name: "CLEAR (KEYNOTE-581)", nct: "NCT02811861", phase: "3", status: "positive", yearReported: 2021, sponsor: "Eisai / Merck", enrolled: 1069,
  ...
  t({ id: "keynote-564", technologies: ["checkpoint-inhibitor"], name: "KEYNOTE-564", nct: "NCT03142334", phase: "3", status: "positive", yearReported: 2021, sponsor: "Merck", enrolled: 994,
    ...
    drugs: ["pembrolizumab"], cancers: ["rcc", "clear-cell-rcc"], terms: ["neoadjuvant-adjuvant", "nephrectomy"], links: [ct("NCT03142334")], people: ["toni-choueiri"] }),
  t({ id: "litespark-022", technologies: ["kinase-inhibitors"], name: "LITESPARK-022", nct: "NCT05239728", phase: "3", status: "positive", yearReported: 2026, sponsor: "Merck", enrolled: 1600,
  ...
  t({ id: "litespark-005", technologies: ["kinase-inhibitors"], name: "LITESPARK-005", nct: "NCT04195750", phase: "3", status: "positive", yearReported: 2023, sponsor: "Merck", enrolled: 755,
    ...
    outcomes: [{ endpoint: "Progression-free survival", primary: true, arms: [{ name: "Belzutifan", n: 374 }, { name: "Everolimus", n: 372 }], hr: 0.75, ci: [0.63, 0.90], source: "https://www.nejm.org/doi/full/10.1056/NEJMoa2313906" }, { endpoint: "Objective response rate", unit: "%", arms: [{ name: "Belzutifan", value: 22.7 }, { name: "Everolimus", value: 3.5 }], source: "https://doi.org/10.1056/NEJMoa2313906" }],
  ...
  t({ id: "litespark-012", technologies: ["kinase-inhibitors"], name: "LITESPARK-012", nct: "NCT04736706", phase: "3", status: "negative", yearReported: 2026, sponsor: "Merck",
  ...
  t({ id: "cosmic-313", technologies: ["antiangiogenic", "kinase-inhibitors"], name: "COSMIC-313", nct: "NCT03937219", phase: "3", status: "mixed", yearReported: 2022, sponsor: "Exelixis", enrolled: 855,
  ...
  t({ id: "contact-03", technologies: ["checkpoint-inhibitor"], name: "CONTACT-03", nct: "NCT04338269", phase: "3", status: "negative", yearReported: 2023, sponsor: "Roche / Exelixis", enrolled: 522,
  ...
  t({ id: "tinivo-2", technologies: ["antiangiogenic", "kinase-inhibitors"], name: "TiNivo-2", nct: "NCT04987203", phase: "3", status: "negative", yearReported: 2024, sponsor: "AVEO (LG Chem)", enrolled: 343,
...
const drugs: DrugInput[] = [
  ...
  d({ id: "axitinib", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Axitinib" }], name: "Axitinib", brand: "Inlyta", modality: "Small-molecule kinase inhibitor (VEGFR)", status: "approved", wikipedia: W("Axitinib"),
    ...
    targets: ["vegf"], technologies: ["kinase-inhibitors", "antiangiogenic"], companies: ["pfizer"], cancers: ["rcc", "clear-cell-rcc", "adenoid-cystic-carcinoma"], trials: ["keynote-426", "nct07227415", "nct05805501", "nct06962787"] }),
  d(supplement<DrugInput>({ id: "cabozantinib", kind: "drug", links: [{ label: "FDA label (DailyMed)", url: "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=Cabozantinib" }],
    approvals: [{ region: "US", year: 2017, indication: "First-line advanced RCC (CABOSUN)" }, { region: "US", year: 2021, indication: "First-line advanced RCC with nivolumab (CheckMate 9ER)" }, { region: "EU", year: 2014, indication: "Cometriq for medullary thyroid cancer; 21 Mar 2014. Cabometyx (RCC) Sep 2016" }],
    ...
    cancers: ["rcc", "medullary-thyroid-cancer", "clear-cell-rcc", "papillary-rcc"], trials: ["checkmate-9er", "cosmic-313", "contact-03"] })),
...
const ideas: IdeaInput[] = [
  { id: "idea-adjuvant-selection-rcc", keyPapers: ["paper-keynote-564-nejm-2021"], links: [{ label: "ClinicalTrials.gov NCT03142334: KEYNOTE-564", url: "https://clinicaltrials.gov/study/NCT03142334" }, { label: "ClinicalTrials.gov NCT05239728: LITESPARK-022", url: "https://clinicaltrials.gov/study/NCT05239728" }], kind: "idea", name: "Biomarker-selected adjuvant therapy in RCC (ctDNA, CAIX PET, gene signatures)", maturity: "early-clinical", asOf,
