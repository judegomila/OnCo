...
const trials: TrialInput[] = [
  ...
  t({ id: "dellphi-305", name: "DeLLphi-305", nct: "NCT06211036", phase: "3", status: "recruiting", sponsor: "Amgen", enrolled: 550,
    ...
    summary: "Builds on DeLLphi-303 (phase 1b), where tarlatamab plus a PD-L1 inhibitor as first-line maintenance gave median OS 25.3 months and PFS 5.6 months. Readout expected 2026-27. A parallel phase 3 (DeLLphi-312) adds tarlatamab to induction chemo-immunotherapy.",
...
const drugs: DrugInput[] = [
  ...
  d({ id: "lurbinectedin", name: "Lurbinectedin", brand: "Zepzelca", code: "PM01183", modality: "Cytotoxic (transcription inhibitor)", status: "approved", wikipedia: W("Lurbinectedin"),
