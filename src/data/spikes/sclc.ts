...
const trials: TrialInput[] = [
  ...
  t({ id: "dellphi-305", name: "DeLLphi-305", nct: "NCT06211036", phase: "3", status: "recruiting", sponsor: "Amgen", enrolled: 550,
    ...
    summary: "DeLLphi-305, trial NCT06211036 sponsored by Amgen, tests whether adding the DLL3 T-cell engager tarlatamab to durvalumab as first-line maintenance in extensive-stage small-cell lung cancer, after platinum, etoposide and durvalumab induction, can push median survival past two years, as its phase 1b predecessor hinted. It plans to enrol 550 patients, builds on DeLLphi-303, in which tarlatamab plus a PD-L1 inhibitor as maintenance gave encouraging survival, and its readout is expected in 2026 to 2027, while the parallel DeLLphi-312 adds tarlatamab to induction. OnCo links it to small-cell lung cancer, DLL3 as a target, tarlatamab, durvalumab and the pairing of induction followed by maintenance intensification. It is recruiting with no results, and whether a T-cell engager belongs in first-line maintenance rather than at relapse is the question it will answer.",
