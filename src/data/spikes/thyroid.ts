...
const terms: TermInput[] = [
  ...
  term({ id: "tsh-suppression", wikipedia: W("Thyroid-stimulating_hormone"), name: "TSH suppression", category: "Clinical",
  ...
  term({ id: "tert-promoter", wikipedia: W("Telomerase_reverse_transcriptase"), aka: ["TERT promoter mutations"], name: "TERT promoter mutation", category: "Genomics",
