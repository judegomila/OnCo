...
const trials: TrialInput[] = [
  t({ id: "select-lenvatinib", name: "SELECT", nct: "NCT01321554", phase: "3", status: "positive", yearReported: 2015, sponsor: "Eisai", enrolled: 392,
    ...
    summary: "Median PFS 18.3 vs 3.6 months (HR 0.21); ORR 64.8% vs 1.5%. NEJM 2015; FDA approval February 2015. Hypertension in ~68% and a dose-reduction rate above 60% drive management; OS crossover-confounded.",
    ...
    links: [ct("NCT01321554"), { label: "NEJM 2015", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa1406470" }] }),
  t({ id: "decision-sorafenib", name: "DECISION", nct: "NCT00984282", phase: "3", status: "positive", yearReported: 2013, sponsor: "Bayer", enrolled: 417,
    ...
    summary: "PFS 10.8 vs 5.8 months (HR 0.59), Lancet 2014; FDA approval November 2013. Hand-foot skin reaction and fatigue common. Largely displaced by lenvatinib but still used.",
    ...
    links: [ct("NCT00984282"), { label: "Lancet 2014", url: "https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(14)60421-9/fulltext" }] }),
  t({ id: "libretto-531", name: "LIBRETTO-531", nct: "NCT04211337", phase: "3", status: "positive", yearReported: 2023, sponsor: "Eli Lilly", enrolled: 291,
    ...
    summary: "PFS HR 0.28 (12-month PFS 86.8% vs 65.7%); treatment failure-free survival HR 0.25; grade ≥3 adverse events 52.8% vs 76.4%. NEJM 2023. First randomised proof that RET-selective therapy should be first line.",
    ...
    links: [ct("NCT04211337"), { label: "NEJM 2023", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2309719" }] }),
  t({ id: "arrow-thyroid", name: "ARROW (thyroid cohorts)", nct: "NCT03037385", phase: "1/2", status: "positive", yearReported: 2021, sponsor: "Blueprint Medicines",
    ...
    tldr: "The single-arm study behind the second RET inhibitor's thyroid approvals.",
  ...
  t({ id: "estimabl2", name: "ESTIMABL2", nct: "NCT01837745", phase: "3", status: "positive", yearReported: 2022, sponsor: "Gustave Roussy / French Endocrine Tumour Group", enrolled: 776,
    ...
    summary: "Non-inferiority met at 3 years (event-free 95.6% vs 95.9%, NEJM 2022) and at 5 years (Lancet Diabetes & Endocrinology 2024). Together with IoN and HiLo, it removed radioiodine from routine low-risk care in ATA and ESMO guidance.",
    ...
    links: [ct("NCT01837745"), { label: "NEJM 2022", url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2111953" }, { label: "5-year follow-up", url: "https://www.thelancet.com/journals/landia/article/PIIS2213-8587(24)00276-6/fulltext" }] }),
  t({ id: "ion-trial", name: "IoN", nct: "NCT01398085", phase: "3", status: "positive", yearReported: 2025, sponsor: "Cancer Research UK / UCL", enrolled: 504,
    ...
    summary: "Lancet 2025: recurrence-free rates 98% without and 96% with radioiodine at 5 years; non-inferiority met, extending the ESTIMABL2 finding to pT2 tumours. Guideline bodies now recommend against routine ablation in this group.",
  ...
  t({ id: "hilo", name: "HiLo", nct: "NCT00415233", phase: "3", status: "positive", yearReported: 2012, sponsor: "Cancer Research UK", enrolled: 438,
    ...
    summary: "Ablation success 85% in both dose groups (NEJM 2012); recombinant TSH avoided hypothyroid symptoms. Low-dose ablation became standard for intermediate-risk disease, and the trial paved the way to omitting ablation altogether in low-risk disease.",
  ...
  t({ id: "roar-atc", name: "ROAR (anaplastic thyroid cancer cohort)", nct: "NCT02034110", phase: "2", status: "positive", yearReported: 2018, sponsor: "Novartis", enrolled: 36,
    ...
    summary: "ORR 56%; median OS 15 months with 12-month OS 52% versus historical medians under 6 months (updated analysis, Annals of Oncology 2022). FDA approval May 2018, the first targeted therapy for ATC; neoadjuvant use now enables surgery in previously unresectable tumours.",
    ...
    links: [ct("NCT02034110"), { label: "Updated analysis, Annals of Oncology 2022", url: "https://www.sciencedirect.com/science/article/pii/S0923753422000059" }] }),
  t({ id: "astra", name: "ASTRA", nct: "NCT01843062", phase: "3", status: "negative", yearReported: 2019, sponsor: "AstraZeneca", enrolled: 401,
    ...
    summary: "Complete remission at 18 months 40% vs 38.5%; no benefit. Redifferentiation remains reserved for selected radioiodine-refractory patients, where MEK or BRAF/MEK inhibitors can restore uptake in about half.",
...
const drugs: DrugInput[] = [
  ...
  d({ id: "vandetanib", name: "Vandetanib", brand: "Caprelsa", modality: "Small-molecule kinase inhibitor (RET, VEGFR, EGFR)", status: "approved", wikipedia: W("Vandetanib"),
    tldr: "The first drug approved for medullary thyroid cancer (2011), now largely replaced by RET-selective selpercatinib.",
...
const technologies: TechnologyInput[] = [
  tech({ id: "radioiodine-therapy", name: "Radioiodine therapy and whole-body iodine scanning", sections: ["radiopharma", "radiation"], status: "standard-of-care", since: 1946, wikipedia: W("Isotopes_of_iodine#Iodine-131"),
    ...
    principle: "Sodium-iodide symporter-mediated uptake after TSH stimulation; beta emission for therapy, gamma for imaging.",
    ...
    cancers: ["thyroid"], drugs: ["radioactive-iodine"], technologies: ["radioligand-therapy", "spect"], terms: ["theranostics", "rai-refractory"] }),
  tech({ id: "thyroid-fna-molecular", name: "Thyroid nodule FNA, Bethesda cytology & molecular classifiers", sections: ["diagnostics"], status: "standard-of-care",
    tldr: "A needle sample from a thyroid lump, graded on a six-level scale; when the result is uncertain, a gene test on the same sample can often rule cancer out and avoid surgery.",
    ...
    principle: "Cytology plus gene-expression or mutation/fusion panels calibrated on surgical outcomes.",
...
const terms: TermInput[] = [
  ...
  term({ id: "low-risk-dtc", name: "Low-risk differentiated thyroid cancer (ATA risk)", category: "Clinical",
    ...
    summary: "ATA low risk: intrathyroidal papillary or follicular cancer, no vascular invasion, ≤5 microscopic nodal metastases, no aggressive histology. ESTIMABL2 and IoN showed radioiodine ablation adds nothing; lobectomy rather than total thyroidectomy is acceptable for tumours ≤4 cm.", cancers: ["thyroid"], trials: ["estimabl2", "ion-trial"], technologies: ["radioiodine-therapy", "active-surveillance-thyroid"] }),
  term({ id: "bethesda-category", name: "Bethesda category (thyroid cytology)", category: "Diagnostics",
    tldr: "A six-step scale, from 'not enough cells' to 'cancer', that pathologists use to report a thyroid needle biopsy.",
    summary: "I non-diagnostic, II benign, III atypia of undetermined significance, IV follicular neoplasm, V suspicious, VI malignant. Categories III-IV are where molecular classifiers change management. The 2023 revision harmonised risk-of-malignancy estimates.", cancers: ["thyroid"], technologies: ["thyroid-fna-molecular"] }),
...
const pairings: PairingInput[] = [
  pair({ id: "braf-mek-neoadjuvant-atc", name: "BRAF/MEK inhibition → surgery in anaplastic thyroid cancer", a: "dabrafenib-trametinib", b: "surgery", pairingType: "sequence",
    ...
    summary: "MD Anderson series: neoadjuvant dabrafenib-trametinib (often with pembrolizumab) rendered unresectable ATC operable with 12-month survival above 90% in responders. Rapid BRAF testing at diagnosis is now standard.",
  ...
  pair({ id: "redifferentiation-rai", name: "MAPK inhibitor redifferentiation → radioiodine", a: "kinase-inhibitors", b: "radioiodine-therapy", pairingType: "sequence",
    ...
    summary: "Selumetinib (Ho et al., NEJM 2013), dabrafenib, and trametinib restore radioiodine uptake in roughly half of RAI-refractory patients, especially RAS-mutant; durable responses follow in some. The adjuvant version (ASTRA) failed, so the approach is for refractory disease only.",
...
const ideas: IdeaInput[] = [
  idea({ id: "idea-thyroid-overdiagnosis-reversal", name: "Ultrasound restraint and surveillance to reverse thyroid cancer overdiagnosis", maturity: "being-tested-at-scale",
    ...
    summary: "Incidence tripled in many countries since the 1990s with flat mortality; South Korea's screening-driven epidemic reversed when screening was discouraged. Active surveillance for microcarcinoma and TI-RADS-based biopsy thresholds are the tools.",
  ...
  idea({ id: "idea-atc-triplet-io", name: "BRAF/MEK plus PD-1 blockade as standard for BRAF-mutant anaplastic thyroid cancer", maturity: "early-clinical",
    ...
    summary: "ATC has high PD-L1 expression and TMB; MD Anderson reports of dabrafenib-trametinib-pembrolizumab show median OS beyond 2 years in BRAF-mutant patients versus ~15 months with the doublet.",
