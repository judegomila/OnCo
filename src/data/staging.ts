...
export const stagingSystems: StagingSystem[] = [
  ...
  { id: "skin-carcinoma-tnm9", cancerIds: ["skin-cancer", "basal-cell-carcinoma", "cutaneous-scc", "bowens-disease", "advanced-cutaneous-scc", "locally-advanced-bcc"], name: "Carcinoma of the skin: UICC TNM 9 (the system UK reports use)", terms: ["tnm-skin-carcinoma", "skin-cancer-high-risk-features", "perineural-invasion"], source: { label: "Royal College of Pathologists appendix A, version 3, 6 November 2025: UICC TNM 9 pathological staging of primary cutaneous carcinoma", url: "https://www.rcpath.org/resourceLibrary/basal-cell-tnm9.html" }, note: "UK skin carcinoma reports stage against UICC, not the American AJCC: the Royal College of Pathologists assessed both and chose UICC because AJCC 8 covers only the head and neck while UICC covers the whole body surface, and because UICC TNM is the version favoured by NCRAS. The table combines the UICC head-and-neck and carcinoma-of-the-skin chapters and covers basal cell, squamous cell and adnexal carcinoma; it excludes Merkel cell carcinoma and carcinomas of the eyelid, vulva, penis, non-hair-bearing lip and non-hair-bearing perianal skin. Most people with a keratinocyte cancer are never given a stage at all, because it would not change what is done; the words that decide care in Britain are low risk and high risk.",
    groups: [
      { stage: "Stage 0", definition: "Tis N0 M0: carcinoma in situ, which in the skin usually means Bowen's disease.", settingMatch: ["in situ", "bowen", "stage 0"] },
      { stage: "Stage I", definition: "T1 N0 M0: tumour 20 mm or less in maximum dimension, usually the clinical measurement.", settingMatch: ["low risk", "localised", "early", "primary"] },
      { stage: "Stage II", definition: "T2 N0 M0: tumour over 20 mm and up to 40 mm.", settingMatch: ["high risk", "localised", "primary"] },
      { stage: "Stage III", definition: "T3 N0 M0, or T1 to T3 with N1. T3 is over 40 mm, or minor bone erosion, or perineural invasion, or deep invasion (beyond the subcutaneous fat, or more than 6 mm from the granular layer of adjacent normal epidermis). N1 is a single ipsilateral node 30 mm or less.", settingMatch: ["high risk", "very high risk", "node", "adjuvant", "radiotherapy"] },
      { stage: "Stage IV", definition: "T1 to T3 with N2 or N3, or any T4, or any M1. T4a is gross cortical or marrow invasion; T4b is axial skeleton invasion including the vertebral foramen and epidural space. Nodal categories differ between the head and neck, where extranodal extension subdivides them, and the trunk and limbs, where a contralateral node counts as distant metastasis.", settingMatch: ["locally advanced", "metastatic", "unresectable", "advanced"] },
    ] },
  { id: "cscc-bwh", cancerIds: ["cutaneous-scc", "advanced-cutaneous-scc"], name: "Cutaneous squamous cell carcinoma: the Brigham and Women's Hospital alternative", terms: ["bwh-staging-cscc", "tnm-skin-carcinoma", "cscc-subtype-and-grade"], source: { label: "Jambusaria-Pahlajani et al., JAMA Dermatology 2013;149:402 to 410 (derivation); Karia et al., Journal of Clinical Oncology 2014;32:327 to 334 (validation)", url: "https://doi.org/10.1001/jamadermatol.2013.2456" }, note: "Not a UK reporting standard and not used in UK pathology reports, which stage against UICC. It is included because it is the evidence behind the general agreement that the anatomical stage alone does not identify the dangerous tumours, and because American sources quote it. It counts four risk factors rather than measuring the tumour: poor differentiation, perineural invasion, diameter 2 cm or more, and invasion beyond the subcutaneous fat, with bone invasion automatically T3. The ten-year outcomes below come from 1,818 primary tumours at one American referral centre and are higher than an unselected population would show; the ranking rather than the percentage is what transfers. The Royal College of Pathologists has published its objection to the risk bands derived from this system.",
    groups: [
      { stage: "T1", definition: "No risk factors. In the validation cohort, T1 and T2a together carried 10-year cumulative incidences of 1.4 percent local recurrence, 0.6 percent nodal metastasis and 0.2 percent death from the cancer.", settingMatch: ["low risk", "localised", "early", "primary"] },
      { stage: "T2a", definition: "One risk factor.", settingMatch: ["low risk", "localised", "primary"] },
      { stage: "T2b", definition: "Two or three risk factors. In the derivation cohort T2b was 19 percent of cases but 72 percent of nodal metastases and 83 percent of deaths from the cancer.", settingMatch: ["high risk", "very high risk", "adjuvant", "node"] },
      { stage: "T3", definition: "Four risk factors, or bone invasion. T2b and T3 together were 5 percent of the validation cohort and carried 60 percent of poor outcomes, with 10-year incidences of 24 percent local recurrence, 24 percent nodal metastasis and 16 percent death from the cancer.", settingMatch: ["very high risk", "locally advanced", "metastatic", "unresectable"] },
    ] },
  ...
  { id: "prostate-cpg", cancerIds: ["prostate", "prostate-low-risk", "prostate-intermediate-risk", "prostate-high-risk"], name: "Localised prostate cancer: the Cambridge Prognostic Groups (NICE)", terms: ["cambridge-prognostic-group", "gleason-grade-group", "psa"], source: { label: "NICE NG131 recommendation 1.2.15, table 1", url: "https://www.nice.org.uk/guidance/ng131/chapter/Recommendations" }, note: "The five-tier model NICE recommends for everyone with newly diagnosed localised or locally advanced prostate cancer, assigned by the urological cancer MDT. It replaced the three-tier D'Amico model in the 2021 amendment because that model could not separate Gleason 3+4 from 4+3. PSA is in micrograms per litre, which is the same number as nanograms per millilitre. NICE's treatment recommendations are written in these group numbers.",
    groups: [
      { stage: "CPG 1", definition: "Gleason score 6 (grade group 1) and PSA under 10 and stage T1 to T2. Active surveillance is offered first (NG131 1.3.8).", settingMatch: ["low risk", "active surveillance", "localised"] },
      { stage: "CPG 2", definition: "Gleason 3+4=7 (grade group 2) or PSA 10 to 20, with stage T1 to T2. Active surveillance, radical prostatectomy and radical radiotherapy are offered as a choice (NG131 1.3.9).", settingMatch: ["intermediate", "favourable intermediate", "localised"] },
      { stage: "CPG 3", definition: "Gleason 3+4=7 (grade group 2) and PSA 10 to 20 and stage T1 to T2, or Gleason 4+3=7 (grade group 3) at stage T1 to T2. Radical treatment is offered; active surveillance is considered only for people who decline it (NG131 1.3.10).", settingMatch: ["intermediate", "unfavourable intermediate", "localised"] },
      { stage: "CPG 4", definition: "Any one of: Gleason score 8 (grade group 4), PSA above 20, stage T3. Active surveillance is not offered (NG131 1.3.11).", settingMatch: ["high risk", "high-risk", "locally advanced"] },
      { stage: "CPG 5", definition: "Two or more of Gleason score 8 (grade group 4), PSA above 20 and stage T3; or Gleason 9 to 10 (grade group 5); or stage T4.", settingMatch: ["very high", "high risk", "high-risk", "locally advanced"] },
    ] },
