...
export const technologies: TechnologyInput[] = [
  // ======================= IMAGING =======================
  {
    ...
    tldr: "A fast 3D X-ray that shows the size and shape of tumours and whether they have spread.",
    ...
    principle: "Rotating X-ray source and detector; attenuation reconstructed into cross-sectional images. Iodinated contrast highlights vasculature.",
  ...
  },
  {
    ...
    tldr: "Sound waves make live pictures; cheap, safe, and used to guide needles into lumps.",
  ...
  },
  {
    ...
    principle: "Simultaneous or sequential PET and MRI acquisition with MR-compatible detectors.",
  ...
  },
  {
    ...
    tldr: "The standard PET scan. A radioactive sugar shows which tissues are burning glucose fast, which most cancers do.",
  ...
  },
  {
    ...
    tldr: "A PET scan that lights up the scaffolding around almost any solid tumour, including cancers the standard sugar scan misses.",
  ...
  },
  {
    ...
    principle: "Radiolabelled TROP2 binder; antibody tracers image at 3-6 days with 89Zr, nanobodies within 1-2 hours with 68Ga/18F.",
  ...
  },
  {
    ...
    tldr: "A PET scan using radiolabelled trastuzumab or smaller HER2 binders to map HER2 across all metastases at once.",
  ...
  },
  {
    ...
    tldr: "An older type of nuclear scan, still used for bone metastases and to check where a radioactive drug went after treatment.",
  ...
  },
  {
    ...
    tldr: "An MRI of the entire body without radiation, used to find spread in myeloma and to screen people with high inherited cancer risk.",
  ...
  // ======================= DIAGNOSTICS =======================
  {
    ...
    tldr: "Looking at cancer cells under a microscope and staining them for specific proteins. Still the foundation of every diagnosis.",
  ...
  },
  {
    ...
    principle: "Barcoded capture of RNA per cell or per spatial location; imaging-based in situ hybridisation for hundreds to thousands of genes.",
  ...
  },
  {
    ...
    principle: "cfDNA methylation, fragmentation, and protein biomarkers classified by machine learning.",
  ...
  },
  {
    ...
    principle: "NGS of blood or saliva DNA for pathogenic germline variants.",
  ...
  },
  {
    ...
    tldr: "Miniature 3D versions of a patient's tumour grown in the lab.",
  ...
  },
  {
    ...
    tldr: "A patient's tumour grown in a mouse, used to test drugs before they reach people.",
  ...
  },
  {
    ...
    principle: "Liquid chromatography tandem mass spectrometry with isobaric labelling.",
  ...
  // ======================= SURGERY =======================
  {
    ...
    principle: "Tele-manipulated instruments with wristed motion through laparoscopic ports.",
  ...
  },
  {
    ...
    principle: "Tumour-selective fluorophore accumulation imaged with near-infrared camera systems.",
  ...
  },
  {
    ...
    tldr: "Killing a tumour with heat or cold delivered through a needle, no incision required.",
  ...
  },
  {
    ...
    tldr: "Short high-voltage pulses punch permanent holes in tumour cells while sparing nearby vessels and ducts.",
  ...
  },
  {
    ...
    tldr: "Placing a radioactive source directly inside or next to the tumour.",
  ...
  },
  {
    ...
    tldr: "A radiation machine with an MRI inside it, so the plan is adjusted to where the tumour is that very day.",
  ...
  },
  {
    ...
    principle: "Chelator-conjugated antibody or fragment carrying 177Lu, 225Ac, 212Pb, or 131I.",
  ...
  },
  {
    ...
    tldr: "A boron drug accumulates in tumour cells, then a neutron beam makes only those cells explode from inside.",
  ...
  // ======================= CHEMOTHERAPY =======================
  {
    ...
    tldr: "Drugs that kill rapidly dividing cells. Still curative in testicular cancer, lymphoma, leukaemia, and many early-stage cancers, and the warhead inside ADCs.",
  ...
  },
  {
    ...
    tldr: "Cisplatin and carboplatin crosslink DNA. Curative in testicular cancer and central to lung, ovarian, bladder, head and neck, and TNBC treatment.",
  ...
  },
  {
    ...
    tldr: "Drugs that jam the enzyme that untangles DNA during copying. Weak as free drugs in many cancers, but devastating when delivered by an ADC.",
  ...
  },
  {
    ...
    principle: "Humanised or fully human IgG binding a surface or soluble antigen; Fc engineering tunes effector function and half-life.",
  ...
  },
  {
    ...
    tldr: "One antibody with two different grabbing arms, so it can block two targets at once or pull an immune cell onto a cancer cell.",
  ...
  },
  {
    ...
    principle: "Covalent binding to mutant cysteine in the switch-II pocket (G12C), or cyclophilin-A-mediated tri-complex formation blocking effector binding (RAS(ON) inhibitors).",
  ...
  },
  {
    ...
    tldr: "Short synthetic strands of genetic code that silence a specific cancer gene.",
  ...
  },
  {
    ...
    tldr: "Cutting off the tumour's blood supply, now mostly used to help immunotherapy work better.",
    summary: "Bevacizumab, ramucirumab, and VEGFR TKIs. Alone they extend PFS modestly; with PD-1 blockade they are standard in RCC, HCC (atezolizumab-bevacizumab), and endometrial cancer (lenvatinib-pembrolizumab). PD-1×VEGF bispecifics are the consolidation of this idea.",
  ...
  // ======================= ADC =======================
  {
    ...
    tldr: "A guided missile: an antibody homes to the tumour cell, is swallowed, and releases a chemotherapy so potent it could never be given on its own.",
  ...
  },
  {
    ...
    tldr: "An ADC whose antibody grabs two different proteins on the cancer cell, so it sticks better to tumour and less to healthy tissue.",
  ...
  },
  {
    ...
    tldr: "An ADC carrying two different poisons at once, so the tumour cannot escape by becoming resistant to one.",
  ...
  },
  {
    ...
    tldr: "An ADC whose payload wakes up the immune system inside the tumour rather than poisoning the cell.",
  ...
  },
  {
    ...
    tldr: "The chemistry that decides exactly where and how many payloads attach to the antibody, which determines how safe and effective an ADC is.",
  ...
  },
  {
    ...
    principle: "Tumour and normal sequencing → computational neoantigen prediction (up to 34 epitopes) → patient-specific mRNA in lipid nanoparticles → dendritic cell presentation and T-cell priming, usually with PD-1 blockade.",
  ...
  },
  {
    ...
    principle: "Pre-manufactured antigen (peptide, mRNA, viral vector, dendritic cell) plus adjuvant.",
  ...
  },
  {
    ...
    tldr: "Immune-signalling proteins given as drugs. High-dose interleukin-2 was the first immunotherapy to cure some melanomas, at great toxicity.",
  ...
  // ======================= CELL THERAPY =======================
  {
    ...
    principle: "Lentiviral or retroviral transduction of a chimeric antigen receptor (scFv + costimulatory domain + CD3ζ); lymphodepletion then infusion; in vivo expansion.",
  ...
  },
  {
    ...
    tldr: "Lowering testosterone or blocking its receptor, the foundation of prostate cancer treatment since 1941 (Nobel Prize 1966).",
  ...
  },
  {
    ...
    tldr: "A structured check of an older patient's fitness, memory, and support that predicts treatment tolerance better than age.",
  ...
  },
  {
    ...
    principle: "Structured extraction from EHR plus eligibility-criteria parsing and ranking.",
  ...
  },
  {
    ...
    tldr: "Heating tumours to 40-43 °C to make radiation and chemotherapy work better.",
