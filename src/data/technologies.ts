...
export const technologies: TechnologyInput[] = [
  ...
  {
    id: "mri", related: ["mri-field-strengths", "intraoperative-mri-ct"], kind: "technology", name: "MRI", sections: ["imaging"], status: "standard-of-care", asOf, since: 1977, wikipedia: W("Magnetic_resonance_imaging"),
  ...
  {
    id: "ultrasound", related: ["ultrasound-elastography-ceus"], companies: ["ge-healthcare", "philips", "siemens-healthineers", "canon-medical", "fujifilm", "mindray"], kind: "technology", name: "Ultrasound", sections: ["imaging"], status: "standard-of-care", asOf, wikipedia: W("Medical_ultrasound"),
  ...
  {
    id: "pet-ct", dependsOn: ["pet", "ct"], companies: ["siemens-healthineers", "ge-healthcare", "philips", "united-imaging", "canon-medical"], kind: "technology", name: "PET/CT", sections: ["imaging"], status: "standard-of-care", asOf, since: 2001, wikipedia: W("PET-CT"),
  ...
  {
    id: "irreversible-electroporation", companies: ["angiodynamics"], kind: "technology", name: "Irreversible electroporation (NanoKnife)", sections: ["surgery", "devices"], status: "established", asOf, wikipedia: W("Irreversible_electroporation"),
  ...
  // ======================= TARGETED THERAPY =======================
  {
    id: "kinase-inhibitors", related: ["gamma-secretase-inhibitors", "hedgehog-inhibitors", "her2-tyrosine-kinase-inhibitors", "pi3k-akt-mtor-inhibitors"], kind: "technology", name: "Small-molecule kinase inhibitors", sections: ["targeted-therapy"], status: "standard-of-care", asOf, since: 2001, wikipedia: W("Tyrosine_kinase_inhibitor"),
  ...
  {
    id: "cytokine-therapy", related: ["immunocytokines"], kind: "technology", name: "Cytokines & engineered cytokines", sections: ["immunotherapy"], status: "approved", asOf, wikipedia: W("Cytokine"),
  ...
  {
    id: "imaging-mass-cytometry", kind: "technology", name: "Imaging mass cytometry", sections: ["diagnostics"], status: "emerging", asOf, wikipedia: W("Mass_cytometry"),
  ...
  {
    id: "multiplex-immunofluorescence", kind: "technology", name: "Multiplex immunofluorescence", sections: ["diagnostics"], status: "established", asOf, wikipedia: W("Immunofluorescence"),
  ...
  {
    id: "radiomics", kind: "technology", name: "Radiomics", sections: ["imaging","ai-computation"], status: "emerging", asOf, wikipedia: W("Radiomics"),
  ...
  {
    id: "ctc-capture", kind: "technology", name: "Circulating tumour cell capture", sections: ["diagnostics","early-detection"], status: "approved", asOf, since: 2004, wikipedia: W("Circulating_tumor_cell"),
  ...
  {
    id: "oncology-pharmacogenomics", kind: "technology", name: "Pharmacogenomic testing before chemotherapy", sections: ["diagnostics","chemotherapy","supportive-care"], status: "established", asOf, wikipedia: W("Pharmacogenomics"),
  ...
  {
    id: "gamma-delta-t-cell-therapy", kind: "technology", name: "Gamma-delta T cell therapy", sections: ["cell-therapy"], status: "phase-1", asOf, wikipedia: W("Gamma_delta_T_cell"),
