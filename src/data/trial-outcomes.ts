...
const RAW: Record<string, TrialOutcomeIn> = {
  ...
  // ---------------- Early detection / MRD ----------------
  "nhs-galleri": {
    enrolled: 142250, enrolledBasis: "randomised",
    enrolledNote: "ClinicalTrials.gov NCT05611632 and ISRCTN91431511 list 142,318 participants (actual); the Nature Medicine test-performance paper reports 142,250 participants randomised 1:1.",
    outcomes: [
      { endpoint: "Stage III to IV incidence, 12 prespecified cancers (primary)", primary: true, arms: [{ name: "Galleri + usual NHS care" }, { name: "Usual NHS care" }], note: "Not met, per the Nature Medicine test-performance paper (22 September 2026), which states the primary endpoint was not met and reported elsewhere; no peer-reviewed primary-endpoint paper was on Europe PMC by 23 September 2026, so no figures are recorded here.", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Positive test results by screening round", unit: "%", arms: [{ name: "Round 1", n: 70325, value: 1.03 }, { name: "Round 2", n: 64498, value: 0.80 }, { name: "Round 3", n: 62323, value: 0.90 }], note: "722, 518 and 561 positive results among evaluable intervention-arm participants", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Cancer detection rate by screening round", unit: "%", arms: [{ name: "Round 1", n: 70325, value: 0.60 }, { name: "Round 2", n: 64498, value: 0.40 }, { name: "Round 3", n: 62323, value: 0.41 }], note: "937 participants had MCED-detected primary cancers across the three rounds", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Positive predictive value by screening round", unit: "%", arms: [{ name: "Round 1", n: 722, value: 58.0 }, { name: "Round 2", n: 518, value: 50.4 }, { name: "Round 3", n: 561, value: 45.8 }], note: "419/722, 261/518 and 257/561", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Negative predictive value by screening round", unit: "%", arms: [{ name: "Round 1", n: 69603, value: 98.98 }, { name: "Round 2", n: 63980, value: 98.90 }, { name: "Round 3", n: 61762, value: 98.86 }], note: "68,895/69,603, 63,278/63,980 and 61,058/61,762", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Specificity, range across rounds", unit: "%", arms: [{ name: "Lowest round", value: 99.50 }, { name: "Highest round", value: 99.60 }], note: "The abstract gives the range across rounds 1 to 3, not per-round values", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Episode sensitivity, all cancers, range across rounds", unit: "%", arms: [{ name: "Lowest round", value: 26.7 }, { name: "Highest round", value: 37.2 }], note: "Range across rounds 1 to 3 as given in the abstract", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Episode sensitivity, 12 prespecified cancer types, range across rounds", unit: "%", arms: [{ name: "Lowest round", value: 47.6 }, { name: "Highest round", value: 63.4 }], note: "Range across rounds 1 to 3 as given in the abstract", source: "https://doi.org/10.1038/s41591-026-04652-8" },
      { endpoint: "Cancer signal origin accuracy, range across rounds", unit: "%", arms: [{ name: "Lowest round", value: 91.1 }, { name: "Highest round", value: 93.6 }], source: "https://doi.org/10.1038/s41591-026-04652-8" },
