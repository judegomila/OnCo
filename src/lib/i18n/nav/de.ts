...
export const navDe: NavDict = {
  ...
  "/timeline/": ["Zeitleiste", "Jede datierte Tatsache auf einer Zeitleiste: die Form des ganzen Feldes, was diese Form zeigt, und eine Seite pro Jahr."],
  "/years/": ["Jahre", "Eine Seite pro Jahr: alles, was der Korpus darauf datiert, von Zulassungen bis zu Meilensteinen, jede Zeile verlinkt mit dem Datensatz, aus dem sie stammt."],
  ...
  "/coverage/rankings/": ["Rangliste der Kostenübernahme", "US-Versicherer und Tariftypen, jeweils nach einer veröffentlichten Kennzahl geordnet, NHS-Leistungen gegenüber privater Versicherung im Vereinigten Königreich und wie zehn Länder Krebsmedikamente bezahlen."],
  ...
  "/countries/de/": ["Deutschland im Detail", "Was Deutschland anders macht: Erstattung ab dem ersten Tag und die Nutzenbewertung danach, zertifizierte Krebszentren, verpflichtende klinische Krebsregistrierung, Institutionen, Unternehmen, Studien und Menschen."],
