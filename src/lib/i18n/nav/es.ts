...
export const navEs: NavDict = {
  ...
  "/timeline/": ["Línea de tiempo", "Todos los hechos fechados en una línea de tiempo: la forma de todo el campo, lo que esa forma muestra y una página por año."],
  "/years/": ["Años", "Una página por año: todo lo que el corpus fecha en él, de las aprobaciones a los hitos, con cada línea enlazada al registro del que procede."],
  ...
  "/coverage/rankings/": ["Ranking de coberturas", "Aseguradoras y tipos de plan de EE. UU. ordenados por una métrica publicada a la vez, la cobertura del NHS frente al seguro privado en el Reino Unido, y cómo pagan los fármacos contra el cáncer diez países."],
  ...
  "/countries/us/": ["Estados Unidos en profundidad", "Qué hace Estados Unidos: quién paga y cuánto le cuesta a una persona, la FDA, por qué la cobertura no es la aprobación, la red de ensayos del NCI y las desigualdades."],
  ...
  "/countries/de/": ["Alemania en profundidad", "Lo que Alemania hace de otro modo: reembolso desde el primer día y la evaluación del beneficio añadido después, centros oncológicos certificados, registro clínico obligatorio del cáncer, instituciones, empresas, ensayos y personas."],
  "/countries/il/": ["Israel en profundidad", "Qué hace Israel: el comité público que decide cada año qué medicamentos financia el Estado, los cuatro fondos de salud, la genética fundadora y las pruebas poblacionales, y la industria de ensayos y dispositivos."],
  "/countries/gb/": ["Reino Unido en profundidad", "Qué hace el Reino Unido: cuatro sistemas sanitarios bajo un mismo nombre, quién paga, el NICE y el SMC, los ensayos y la genómica, y lo que las cifras dicen que hace mal."],
