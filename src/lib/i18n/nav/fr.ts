...
export const navFr: NavDict = {
  ...
  "/timeline/": ["Chronologie", "Tous les faits datés sur une seule chronologie : la forme du champ entier, ce que cette forme montre, et une page par année."],
  "/years/": ["Années", "Une page par année : tout ce que le corpus y date, des autorisations aux jalons, chaque ligne reliée à la fiche dont elle provient."],
  ...
  "/law/": ["Lois en oncologie", "Les lois, règlements et décisions de justice qui déterminent comment les médicaments anticancéreux sont autorisés, payés et testés, et comment les données et les gènes sont protégés, par juridiction et par thème."],
  "/coverage/us/": ["Payer les soins aux États-Unis", "Medicare Part B ou D, autorisation préalable, prix catalogue et programmes d'aide pour chaque produit autorisé."],
  "/coverage/uk/": ["Couverture du NHS", "Décisions NICE, Cancer Drugs Fund et SMC pour chaque produit autorisé, et le fonctionnement des soins oncologiques du NHS."],
  ...
  "/checkpoints/": ["Familles de points de contrôle", "Un mot, deux biologies : points de contrôle immunitaires sur la synapse et portes du cycle cellulaire sur l'anneau, chaque membre avec son partenaire, son expression, ses médicaments et ses autorisations."],
  "/virotherapy/": ["Virus oncolytiques", "Pourquoi un virus tue une cellule cancéreuse et pas sa voisine, chaque produit autorisé avec ce que son essai a réellement montré, et les échecs."],
  ...
  "/countries/us/": ["Les États-Unis en détail", "Ce que font les États-Unis : qui paie et ce que cela coûte à une personne, la FDA, pourquoi la prise en charge ne découle pas de l'autorisation, le réseau d'essais du NCI, et les inégalités."],
  ...
  "/countries/de/": ["L'Allemagne en détail", "Ce que l'Allemagne fait autrement : remboursement dès le premier jour et évaluation du bénéfice ensuite, centres de cancérologie certifiés, enregistrement clinique obligatoire des cancers, institutions, entreprises, essais et personnes."],
  "/countries/il/": ["Israël en détail", "Ce que fait Israël : le comité public qui décide chaque année quels médicaments l'État finance, les quatre caisses de santé, la génétique fondatrice et le dépistage de population, et l'industrie des essais et des dispositifs."],
  "/countries/gb/": ["Le Royaume-Uni en détail", "Ce que fait le Royaume-Uni : quatre services de santé sous un même nom, qui paie, le NICE et le SMC, les essais et la génomique, et ce que les chiffres disent de ses faiblesses."],
