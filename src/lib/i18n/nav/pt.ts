...
export const navPt: NavDict = {
  ...
  "/timeline/": ["Linha do tempo", "Todos os factos datados numa linha do tempo: a forma de todo o campo, o que essa forma mostra, e uma página por ano."],
  "/years/": ["Anos", "Uma página por ano: tudo o que o corpus data nele, das aprovações aos marcos, com cada linha ligada ao registo de onde veio."],
  ...
  "/cancers/map/": ["Mapa dos cancros", "Todos os tipos de cancro num mapa por camadas: sistema de órgãos, cancro e subtipo; um cancro aparece sob mais de um nó quando pertence a ambos. As insígnias contam ensaios, produtos, aprovações ou ideias."],
  ...
  "/biomarkers/": ["Biomarcadores", "PD-L1 CPS, HER2 IHC 3+, MSI-alto: cada leitura sob o seu gene, com os limiares que as aprovações usam e os testes que a medem."],
  ...
  "/edge/": ["Edge", "Os sinais mais frescos em cancro: novos artigos, resultados de ensaios, aprovações e leis num único feed, atualizado em cada build, com RSS e JSON."],
  ...
  "/modalities/": ["Modalidades", "Um centro por cada forma de medicamento (ADC, radioligando, CAR-T, biespecífico, degradador e os restantes): como funciona, medicamentos aprovados, fase 3, componentes, empresas, ensaios, efeitos secundários, resistência, artigos, roteiros, ideias e fabrico, cada secção com os seus registos."],
  ...
  "/virotherapy/": ["Vírus oncolíticos", "Porque é que um vírus mata uma célula tumoral e não a vizinha, cada produto aprovado com o que o seu ensaio mostrou realmente, e os fracassos."],
  ...
  "/first-60-days/": ["Os primeiros 60 dias", "Semana a semana após o diagnóstico, para o seu tipo de cancro: os exames, a equipa, as decisões que se aproximam, as perguntas a fazer, os ensaios a mencionar e a ajuda gratuita."],
  ...
  "/coverage/rankings/": ["Ranking de coberturas", "Seguradoras e tipos de plano dos EUA ordenados por uma métrica publicada de cada vez, a cobertura do NHS face ao seguro privado no Reino Unido, e como dez países pagam os medicamentos oncológicos."],
  ...
  "/countries/de/": ["A Alemanha em profundidade", "O que a Alemanha faz de diferente: comparticipação desde o primeiro dia e a avaliação do benefício depois, centros oncológicos certificados, registo clínico obrigatório do cancro, instituições, empresas, ensaios e pessoas."],
  "/countries/il/": ["Israel em profundidade", "O que Israel está a fazer: o comité público que decide todos os anos que medicamentos o Estado paga, os quatro fundos de saúde, a genética fundadora e os testes populacionais, e a indústria de ensaios e dispositivos."],
