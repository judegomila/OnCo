...
export const navPt: NavDict = {
  ...
  "/coverage/us/": ["Pagar os cuidados (EUA)", "Medicare Parte B ou D, autorização prévia, preços de lista e programas de apoio para cada produto aprovado."],
  "/coverage/uk/": ["O que o NHS oferece", "Decisões do NICE, Cancer Drugs Fund e SMC para cada produto aprovado, e como funcionam os cuidados oncológicos do NHS."],
  ...
  "/papers/": ["O que o mundo publica", "Os temas que mais crescem na literatura, atualizados semanalmente a partir do Europe PMC."],
