...
export const EN = {
  ...
  "account.welcome.role.provider": "Medical provider",
  "account.welcome.hint.patient": "Plain language first, with what each result means for you",
  "account.welcome.hint.caregiver": "Logistics, side effects and when to call the team",
  "account.welcome.hint.researcher": "Mechanisms, targets, trials and the evidence in full",
  "account.welcome.hint.provider": "Clinical detail first: guidelines, regimens and dosing",
  ...
  "account.welcome.consent": "Your role, cancer choice and preferences (country, data view, language, theme) are stored on your OnCo account so they follow you between devices, with Supabase as the processor and a copy in this browser. You can delete them at any time with Delete my account data in your account menu.",
  "account.welcome.continue": "Continue",
  "account.welcome.continueHint": "Save your choices to your account and carry on",
  "account.welcome.pickFirst": "Pick one of the four to continue",
  "account.welcome.skip": "Skip for now",
  "account.welcome.skipHint": "Carry on without choosing; OnCo will ask again next time you sign in",
  "account.welcome.change": "Change who you are",
  "account.welcome.clear": "Clear my choices",
  "account.welcome.clearHint": "Forget your role and cancer choice on your account and in this browser",
  "account.welcome.roleChip": "You read OnCo as {role}. Click to change.",
  ...
  "account.cloud.synced": "Synced",
  "account.cloud.local": "Saved on this device only",
  "account.cloud.delete": "Delete my account data",
  "account.cloud.deleteHint": "Remove your role, cancer choice, preferences and watched pages from your OnCo account and from this browser",
  "account.cloud.deleteConfirm": "Delete your role, cancer choice, preferences and watched pages from your OnCo account and from this browser? Your sign-in itself stays with WorkOS until you ask us to remove it.",
  "account.cloud.deleted": "Your account data has been deleted.",
  "account.cloud.deleteFailed": "Your account data could not be deleted just now. Try again in a minute.",
} as const;
