...
export const EN = {
  ...
  "footer.licence": "Code MIT. Data copyright OnCo, free for non-commercial and educational use under CC BY-NC 4.0 with the attribution “Data from OnCo (onco.cc)”. Commercial use needs a licence.",
  ...
  "kind.drug.label": "Product", "kind.drug.plural": "drugs", "kind.drug.title": "Treatments & tests",
  ...
  "l.Open problems, and what is being done about each": "Open problems, and what is being done about each",
  "l.Open questions": "Open questions",
  "l.Treatments & tests": "Treatments & tests",
  "l.Trials": "Trials",
  "l.People": "People",
  "l.Key papers": "Key papers",
  "l.Key papers published here": "Key papers published here",
  "l.Latest papers": "Latest papers",
  "l.Papers": "Papers",
  "l.Where the cases are": "Where the cases are",
  "l.State of the art today": "State of the art today",
  ...
  "l.Target prevalence in this cancer": "Target prevalence in this cancer",
  "l.History": "History",
  "l.Pipeline": "Pipeline",
  "l.Expert centres": "Expert centres",
  "l.Questions to ask": "Questions to ask",
  "l.Everything relevant": "Everything relevant",
  "l.Recruiting now (live from ClinicalTrials.gov)": "Recruiting now (live from ClinicalTrials.gov)",
  "l.Landmark trials in OnCo": "Landmark trials in OnCo",
  "l.Where it starts and where it drains": "Where it starts and where it drains",
  ...
  "l.Payload": "Payload",
  "l.Linker": "Linker",
  "l.Test required or used to select patients": "Test required or used to select patients",
  ...
  "l.In one picture": "In one picture",
  "l.Category": "Category",
  "l.Setting": "Setting",
  "l.Phase": "Phase",
  "l.Sponsor": "Sponsor",
  ...
  "l.What would test it": "What would test it",
  "l.Maturity": "Maturity",
  "l.Who has to act": "Who has to act",
  ...
  "l.Read it": "Read it",
  "l.What it found": "What it found",
  "l.What it means": "What it means",
  "l.Be careful": "Be careful",
  "l.Publisher": "Publisher",
  "l.Scope": "Scope",
  "l.Access model": "Access model",
  "l.ISSN": "ISSN",
  "l.How big the problem is": "How big the problem is",
  "l.Root causes": "Root causes",
  "l.What is already being tried": "What is already being tried",
  "l.What breaking it looks like": "What breaking it looks like",
  "l.What relieves it today": "What relieves it today",
