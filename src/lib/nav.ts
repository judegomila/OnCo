...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/coverage/rankings/", label: "Which plans cover cancer care best", blurb: "US insurers and plan types ranked by one published metric at a time, UK NHS entitlement against private medical insurance, and how nine countries pay for cancer drugs." },
      { href: "/costs/", label: "Getting the cost of cancer care down", blurb: "Each cost driver paired with what is being done and the ideas that could do more: biosimilars, negotiation, dose optimisation, shorter courses, parity, prior authorisation." },
