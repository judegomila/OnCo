...
const HEAVY = ["gallbladder", "tnbc", "nsclc", "pancreatic", "colorectal", "lung-cancer", "prostate", "breast-cancer", "breast-hr-positive", "breast-her2-positive", "skin-cancer", "basal-cell-carcinoma", "cutaneous-scc"];
