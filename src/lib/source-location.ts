...
const KIND_FILE: Record<Kind, string> = {
  ...
  institution: "institutions.ts", pathway: "pathways.ts", term: "terms.ts", trial: "trials.ts", pairing: "pairings.ts", roadmap: "roadmaps.ts", idea: "ideas.ts", collection: "collections.ts", person: "people/index.ts", bottleneck: "bottlenecks.ts", paper: "key-papers/index.ts", journal: "journals.ts", biomarker: "biomarker-readouts.ts",
};
